...
const VALID_REPORT_TYPES = ["dsar", "support", "audit", "telemetry", "finance", "finance_analytics", "compliance_audit"];
...
function normalizeReportType(value) {
  ...
  throw new Error(
    `Invalid report type "${value}". Use dsar|support|audit|telemetry|finance|finance_analytics|compliance_audit|all.`,
  );
}
