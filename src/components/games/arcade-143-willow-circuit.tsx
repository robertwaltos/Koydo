...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-143",
  shortLabel: "Arcade 143",
  title: "Willow Circuit",
  mascot: "echo",
  startMessage: "Echo: Echo: read the language cue and pick the strongest meaning path in Willow Circuit.",
...
export default function Arcade143WillowCircuit() {
