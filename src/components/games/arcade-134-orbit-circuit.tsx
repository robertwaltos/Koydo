...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-134",
  shortLabel: "Arcade 134",
  title: "Orbit Circuit",
  mascot: "luna",
  startMessage: "Luna: keep cadence architecture intact and sequence every phrase with control in Orbit Circuit.",
...
export default function Arcade134OrbitCircuit() {
