...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-139",
  shortLabel: "Arcade 139",
  title: "Dawn Circuit",
  mascot: "pixel",
  startMessage: "Pixel: Pixel: isolate decoys fast and keep your logic chain consistent in Dawn Circuit.",
...
export default function Arcade139DawnCircuit() {
