...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-140",
  shortLabel: "Arcade 140",
  title: "Summit Circuit",
  mascot: "luna",
  startMessage: "Luna: Luna: keep rhythm and composition aligned while the tempo pressure climbs in Summit Circuit.",
...
export default function Arcade140SummitCircuit() {
