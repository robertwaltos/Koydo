...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-112",
  shortLabel: "Arcade 112",
  title: "Harbor Trail",
  mascot: "spark",
  startMessage: "Spark: keep harbor logistics stable by selecting the strongest routing intervention in Harbor Trail.",
  winMessage: "Spark: cargo flow stabilized. Excellent routing under pressure.",
  failMessage: "Spark: bottleneck cascade triggered. Rebuild with stronger lane choices.",
  objectiveNouns: [
    "dock lane",
    "cargo node",
    "route ring",
  ...
  learningSprinkles: [
    ...
    "Small delays can cause system-wide bottlenecks.",
    "Prioritization rules reduce congestion risk.",
...
export default function Arcade112HarborTrail() {
