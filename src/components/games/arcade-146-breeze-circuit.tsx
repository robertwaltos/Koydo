...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-146",
  shortLabel: "Arcade 146",
  title: "Breeze Circuit",
  mascot: "pixel",
  startMessage: "Pixel: keep telemetry lanes coherent and choose the cleanest routing move in Breeze Circuit.",
...
export default function Arcade146BreezeCircuit() {
