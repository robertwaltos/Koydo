...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-133",
  shortLabel: "Arcade 133",
  title: "Aurora Circuit",
  mascot: "echo",
  startMessage: "Echo: preserve meaning coherence and choose evidence-grounded interpretations in Aurora Circuit.",
...
export default function Arcade133AuroraCircuit() {
