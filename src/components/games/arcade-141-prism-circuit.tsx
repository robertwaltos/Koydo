...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-141",
  shortLabel: "Arcade 141",
  title: "Prism Circuit",
  mascot: "terra",
  startMessage: "Terra: Terra: stabilize the system and choose interventions that hold long-term integrity in Prism Circuit.",
...
export default function Arcade141PrismCircuit() {
