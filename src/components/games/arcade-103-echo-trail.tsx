...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-103",
  shortLabel: "Arcade 103",
  title: "Echo Trail",
  mascot: "echo",
  startMessage: "Echo: stay adaptive and pick evidence-backed actions as pressure scales in Echo Trail.",
...
export default function Arcade103EchoTrail() {
