...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-149",
  shortLabel: "Arcade 149",
  title: "Nimbus Circuit",
  mascot: "luna",
  startMessage: "Luna: keep cadence architecture intact and sequence every phrase with control in Nimbus Circuit.",
...
export default function Arcade149NimbusCircuit() {
