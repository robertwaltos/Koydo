...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-135",
  shortLabel: "Arcade 135",
  title: "Pixel Circuit",
  mascot: "terra",
  startMessage: "Terra: protect systems resilience and choose interventions that reduce cascade risk in Pixel Circuit.",
...
export default function Arcade135PixelCircuit() {
