...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-160",
  shortLabel: "Arcade 160",
  title: "Pixel Garden",
  mascot: "echo",
  startMessage: "Echo: Echo: read the language cue and pick the strongest meaning path in Pixel Garden.",
...
export default function Arcade160PixelGarden() {
