...
const CONFIG: RewardRealmCharacterGauntletConfig = {
  gameId: "arcade-109",
  shortLabel: "Arcade 109",
  title: "Orbit Trail",
  mascot: "echo",
  startMessage: "Echo: Echo: read the language cue and pick the strongest meaning path in Orbit Trail.",
...
export default function Arcade109OrbitTrail() {
