  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          title: "Foundations of US Government Overview",
          content: "In this lesson, we focus on constitution through the lens of civics and institutions. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "social-studies-us-101-l01-c2",
          title: "Core Concept",
          content: "constitution and branches of government work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "social-studies-us-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for branches of government, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "social-studies-us-101-l01-f1", front: "constitution", back: "A central target skill in this module. Name it before solving." },
        { id: "social-studies-us-101-l01-f2", front: "branches of government", back: "Use this as the method step after defining the goal." },
        { id: "social-studies-us-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "social-studies-us-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          "Identify one core idea about constitution from this lesson.",
          "Explain where branches of government appears in real life.",
          "Describe one question you still have about civics and institutions."
        ]
      },
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for constitution", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for branches of government", correctTargetId: "execute" },
    ...
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains constitution using evidence from the lesson." },
            { id: "b", text: "It ignores how constitution works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for branches of government." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to branches of government." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to civics and institutions." },
      ...
      interactiveActivities: [
        {
          id: "social-studies-us-101-l03-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Civics Basics",
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about constitution" },
              { id: "l2", label: "Inconsistent approach to branches of government" },
              { id: "l3", label: "Weak transfer of civics and institutions under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Rights and Responsibilities Focus",
          content: "This lesson deepens citizenship using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "social-studies-us-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to citizenship. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "social-studies-us-101-l04-f1", front: "citizenship", back: "State the target and pick a strategy before solving." },
        { id: "social-studies-us-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "social-studies-us-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "social-studies-us-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "citizenship Concept" },
              { id: "process", label: "communities Process" },
    ...
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "social-studies-us-101-skill-core",
          options: [
            { id: "a", text: "It explains citizenship using evidence from the lesson." },
            { id: "b", text: "It ignores how citizenship works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Social Studies US." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
        },
        {
          ...
          skillId: "social-studies-us-101-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for communities." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to communities." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          id: "social-studies-us-101-l06-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Civic Participation",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about citizenship" },
              { id: "l2", label: "Inconsistent approach to communities" },
              { id: "l3", label: "Weak transfer of civics and institutions under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "US Regions and Culture Setup",
          content: "Use communities to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "social-studies-us-101-l07-f1", front: "communities", back: "Use this as your organizing framework before execution." },
        { id: "social-studies-us-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "social-studies-us-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "social-studies-us-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
    ...
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "social-studies-us-101-skill-core",
          options: [
            { id: "a", text: "It explains branches of government using evidence from the lesson." },
            { id: "b", text: "It ignores how branches of government works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Social Studies US." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          id: "social-studies-us-101-l09-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Review: US Social Studies",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about branches of government" },
              { id: "l2", label: "Inconsistent approach to communities" },
              { id: "l3", label: "Weak transfer of civics and institutions under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "social-studies-us-101-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for citizenship." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to citizenship." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          id: "social-studies-us-101-l10-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Mastery: US Civics",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about constitution" },
              { id: "l2", label: "Inconsistent approach to citizenship" },
              { id: "l3", label: "Weak transfer of civics and institutions under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          ...
          "Apply a step-by-step correction using citizenship.",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in branches of government", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on communities", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "social-studies-us-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      id: "social-studies-us-101-l12",
      title: "US Civics Mastery Applied Retest",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "social-studies-us-101-l12-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: US Civics Mastery Applied Retest",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "social-studies-us-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines constitution, citizenship, and communities in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "social-studies-us-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "social-studies-us-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "social-studies-us-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "social-studies-us-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "social-studies-us-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting constitution, citizenship, and communities." },
        { id: "social-studies-us-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on constitution setup" },
              { id: "l2", label: "Losses due to rushed communities decisions" },
      ...
      learningAids: [
        { id: "social-studies-us-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "social-studies-us-101-l15",
      title: "US Civics Mastery Mastery Sprint",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: US Civics Mastery Mastery Sprint",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "social-studies-us-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
