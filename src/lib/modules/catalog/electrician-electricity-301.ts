  ...
  lessons: [
    {
      ...
      duration: 9,
      learningAids: [
        { id: "electrician-electricity-301-l01-a1", type: "image", title: "Concept Card", content: "Visual summary for Electricity." },
        { id: "electrician-electricity-301-l01-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Electricity." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l02-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l03-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l04-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "electrician-electricity-301-l05-a1", type: "image", title: "Concept Card", content: "Visual summary for Electricity." },
        { id: "electrician-electricity-301-l05-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Electricity." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l06-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "electrician-electricity-301-l07-a1", type: "image", title: "Concept Card", content: "Visual summary for Electricity." },
        { id: "electrician-electricity-301-l07-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Electricity." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l08-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l09-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "electrician-electricity-301-l10-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    }
  ],
};
