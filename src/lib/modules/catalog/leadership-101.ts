      ...
      "chunks": [
        {
          ...
          "content": "Management is the process of planning, organizing, staffing, and controlling resources to achieve organizational goals efficiently. Leadership, by contrast, is the ability to influence, inspire, and guide others toward a shared vision. While managers focus on systems, processes, and stability, leaders focus on people, change, and direction. John Kotter captured this distinction: management is about coping with complexity, while leadership is about coping with change."
        },
        {
          "id": "leadership-101-l01-c2",
          "title": "Why Organizations Need Both",
          "content": "Strong management without leadership produces bureaucratic organizations that stifle innovation. Strong leadership without management creates chaos — inspiring visions with no execution plan. The most effective organizations cultivate both: managers who can lead and leaders who can manage. Abraham Zaleznik argued that leaders and managers differ in motivation, personal history, and how they think and act, yet the best executives integrate both skill sets."
        },
        {
          "id": "leadership-101-l01-c3",
          "title": "Recognizing Leadership in Action",
          "content": "Leadership is not confined to titles or corner offices. It appears whenever someone takes initiative, rallies a team around a shared purpose, or challenges the status quo constructively. A frontline employee who proposes a better process and persuades colleagues to adopt it is exercising leadership. Understanding that leadership is a behavior — not a position — is the first step toward developing it in yourself and others."
        },
        {
          "id": "leadership-101-l01-c4",
          "title": "Covey's Principle-Centered Leadership",
          "content": "Stephen Covey's The 7 Habits of Highly Effective People distinguishes the 'Character Ethic' from the 'Personality Ethic.' The Personality Ethic treats leadership as a set of techniques — public image, quick-fix strategies, and social influence tactics. The Character Ethic, which Covey champions, grounds leadership in enduring principles: integrity, fairness, human dignity, and service. Covey's first three habits — Be Proactive, Begin with the End in Mind, and Put First Things First — move a person from dependence to independence. Habits 4-6 — Think Win-Win, Seek First to Understand, Then to Be Understood, and Synergize — move from independence to interdependence. Habit 7, Sharpen the Saw, sustains growth across all dimensions. For Covey, lasting leadership effectiveness is inseparable from personal character."
        }
      ],
      "flashcards": [
        {
        ...
        },
        {
          ...
          "back": "Leadership is an influence process exercised through actions, not a formal title — anyone can demonstrate leadership regardless of their role in the hierarchy"
        },
        {
          "id": "leadership-101-l01-f4",
          "front": "Character Ethic vs. Personality Ethic (Covey)",
          "back": "The Character Ethic grounds leadership in enduring principles — integrity, fairness, dignity, service. The Personality Ethic relies on techniques, image, and quick fixes. Covey argues only the Character Ethic produces lasting effectiveness."
        },
        {
          "id": "leadership-101-l01-f5",
          "front": "Covey's 7 Habits — dependence to interdependence",
          "back": "Habits 1-3 (Be Proactive, Begin with the End in Mind, Put First Things First) achieve independence. Habits 4-6 (Think Win-Win, Seek First to Understand, Synergize) achieve interdependence. Habit 7 (Sharpen the Saw) sustains renewal."
        },
        {
          "id": "leadership-101-l01-f6",
          "front": "Be Proactive (Covey's Habit 1)",
          "back": "Taking responsibility for your own behaviour rather than blaming circumstances. Proactive people focus on their Circle of Influence — things they can control — rather than reacting to their Circle of Concern."
        }
      ],
      "learningAids": [
        {
      ...
      "flashcards": [
        {
          ...
          "back": "The belief that leaders are born with innate, extraordinary qualities that destine them for influence — popularized by Thomas Carlyle in the 1840s"
        },
        {
          "id": "leadership-101-l02-f2",
          "front": "Trait theory of leadership",
          "back": "Approach seeking to identify specific characteristics (intelligence, confidence, integrity, sociability) that predict leadership effectiveness — traits correlate but do not guarantee success"
        },
        {
          "id": "leadership-101-l02-f3",
          "front": "Ohio State leadership dimensions",
          "back": "Initiating structure (task-oriented behavior defining roles and expectations) and consideration (relationship-oriented behavior showing trust and respect for followers)"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Paul Hersey and Ken Blanchard proposed that no single leadership style is best. Instead, effective leaders adapt their style to the readiness level of their followers. Readiness combines ability (skills, knowledge, experience) and willingness (confidence, motivation, commitment). The model identifies four leadership styles mapped to four readiness levels, creating a practical framework for leaders to diagnose situations and adjust their approach."
        },
        {
          "id": "leadership-101-l03-c2",
          "title": "Four Leadership Styles",
          "content": "The model prescribes four styles: (1) Telling (S1) — high task, low relationship direction for followers who are unable and unwilling. (2) Selling (S2) — high task, high relationship for followers who are unable but willing. (3) Participating (S3) — low task, high relationship for followers who are able but unwilling or insecure. (4) Delegating (S4) — low task, low relationship for followers who are both able and willing. Leaders must continuously reassess as followers develop."
        },
        {
          "id": "leadership-101-l03-c3",
          "title": "Applying Situational Leadership",
          "content": "A new hire with enthusiasm but no experience (R2) needs a selling style — clear direction combined with encouragement and explanation. A seasoned professional who has lost motivation (R3) needs a participating style — involvement in decisions to rebuild engagement. The power of situational leadership lies in its flexibility: it prevents leaders from relying on a single default style and encourages them to meet followers where they are."
        }
      ],
      "flashcards": [
        {
          "id": "leadership-101-l03-f1",
          "front": "Hersey-Blanchard Situational Leadership",
          "back": "A model proposing that effective leaders adapt their style (telling, selling, participating, delegating) to the readiness level of followers based on ability and willingness"
        },
        {
          "id": "leadership-101-l03-f2",
          "front": "Follower readiness (Hersey-Blanchard)",
          "back": "A combination of ability (skills, knowledge, experience) and willingness (confidence, motivation, commitment) that determines which leadership style is most appropriate"
        },
        {
          "id": "leadership-101-l03-f3",
          "front": "Selling style (S2)",
          "back": "High task direction combined with high relationship support — used when followers are willing and motivated but lack the ability or experience to perform independently"
        }
      ],
      "learningAids": [
        {
      ...
      "flashcards": [
        {
          ...
          "back": "A leadership model proposing that leaders enhance follower motivation by clarifying the path to goals, removing obstacles, and providing support matched to follower and environmental needs"
        },
        {
          "id": "leadership-101-l04-f2",
          "front": "Four path-goal leader behaviors",
          "back": "Directive (clear guidance), Supportive (concern for well-being), Participative (shared decision-making), Achievement-oriented (challenging goals with confidence)"
        },
        {
          "id": "leadership-101-l04-f3",
          "front": "Path-goal contingency factors",
          "back": "Follower characteristics (ability, locus of control, experience) and environmental characteristics (task structure, authority system, work group norms) that determine which leader behavior is most effective"
        }
      ],
      "learningAids": [
        {
    ...
    },
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "content": "Democratic leaders involve team members in decision-making, encouraging participation, discussion, and shared ownership. Lewin's research showed that democratic groups produced work of higher quality and exhibited greater satisfaction, creativity, and commitment. The trade-off is speed — consensus-building takes time. Democratic leadership is most effective with knowledgeable teams working on complex problems where diverse perspectives improve outcomes."
        },
        {
          "id": "leadership-101-l06-c3",
          "title": "Laissez-Faire Leadership",
          "content": "Laissez-faire leaders provide minimal direction, granting followers maximum autonomy. This works well with highly skilled, self-motivated experts — research scientists, senior creatives, or experienced consultants who need freedom to innovate. However, it often produces the worst outcomes in Lewin's studies: confusion, low productivity, and frustration when followers need guidance. Effective use of laissez-faire requires the leader to remain available as a resource while trusting the team's competence."
        },
        {
          "id": "leadership-101-l06-c4",
          "title": "Pink's Autonomy-Mastery-Purpose Framework",
          "content": "Daniel Pink's Drive synthesises decades of motivation research into a practical leadership framework. Pink argues that the traditional carrot-and-stick model (Motivation 2.0) is effective only for routine, algorithmic tasks. For creative, heuristic work — the dominant form in the knowledge economy — leaders must cultivate three intrinsic drivers: Autonomy (the desire to direct our own lives), Mastery (the urge to get better at something that matters), and Purpose (the yearning to contribute to something larger than ourselves). Deci and Ryan's Self-Determination Theory underpins this framework, identifying competence, autonomy, and relatedness as universal psychological needs. Pink distinguishes Type I behaviour (intrinsically motivated, durable, creative) from Type X behaviour (extrinsically driven, fragile, short-term). Effective leaders create environments where autonomy, mastery, and purpose flourish — producing commitment rather than mere compliance."
        }
      ],
      "flashcards": [
        {
          ...
          "back": "A style where the leader makes decisions unilaterally — effective in crises and with inexperienced teams, but suppresses creativity and satisfaction over time"
        },
        {
          "id": "leadership-101-l06-f2",
          "front": "Democratic leadership",
          "back": "A participative style involving team members in decisions — produces higher quality work and satisfaction but is slower due to consensus-building"
        },
        {
          "id": "leadership-101-l06-f3",
          "front": "Laissez-faire leadership",
          "back": "A hands-off style granting maximum autonomy — effective with highly skilled, self-motivated experts but often produces confusion and low productivity with less experienced teams"
        },
        {
          "id": "leadership-101-l06-f4",
          "front": "Autonomy, Mastery, Purpose (Daniel Pink)",
          "back": "Pink's three intrinsic motivators from Drive: Autonomy (directing your own life), Mastery (improving at something meaningful), Purpose (contributing to something larger). These fuel sustained engagement for knowledge work far better than carrots and sticks."
        },
        {
          "id": "leadership-101-l06-f5",
          "front": "Type I vs. Type X behaviour (Pink)",
          "back": "Type I is intrinsically motivated — driven by interest, mastery, and meaning; produces creative, durable performance. Type X is extrinsically motivated — driven by rewards/penalties; effective for routine tasks but fragile and short-term for complex work."
        },
        {
          "id": "leadership-101-l06-f6",
          "front": "Self-Determination Theory (Deci & Ryan)",
          "back": "A comprehensive motivation framework identifying three universal psychological needs — competence, autonomy, and relatedness — whose satisfaction produces intrinsic motivation, wellbeing, and psychological growth. The scientific foundation for Pink's Drive."
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Trait theory — the manager lacks the right personality traits"
            },
            {
              "id": "b",
              "text": "Great Man theory — the manager was not born to lead"
            },
            {
              "id": "c",
              "text": "Situational leadership — the manager should adapt style to follower readiness"
            },
            {
              "id": "d",
              "text": "Laissez-faire leadership — the manager should stop directing entirely"
            }
          ],
          "correctOptionId": "c",
