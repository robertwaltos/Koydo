...
export const cybersecurity_101_Module: LearningModule = {
  ...
  "lessons": [
    {
      ...
      "type": "video",
      "duration": 12,
      "lessonImagePrompt": "A sleek, futuristic digital shield glowing with three interconnected nodes labeled C, I, and A, set against a dark, high-tech cyber background, 3d render, cinematic lighting.",
      "conceptVideoPrompt": "A dynamic 3D animation showing a glowing data packet traveling through a futuristic neon-lit network tunnel. The packet is protected by a glowing shield (Confidentiality), checked by a scanning laser (Integrity), and routed through multiple redundant pathways (Availability).",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l01.png"
    },
    {
      ...
      "type": "interactive",
      "duration": 14,
      "lessonImagePrompt": "A high-tech biometric scanner showing a fingerprint, a glowing password asterisk field, and a smartphone displaying a 6-digit code, representing multi-factor authentication.",
      "conceptVideoPrompt": "A visual metaphor of a high-security vault. First, a user enters a PIN on a keypad (Something you know). Next, they swipe a smart card (Something you have). Finally, a retinal scan grants access (Something you are). The heavy vault door swings open.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l02.png"
    },
    {
      ...
      "type": "quiz",
      "duration": 8,
      "lessonImagePrompt": "A glowing holographic checkmark hovering over a futuristic digital exam paper, surrounded by floating cyber security icons like padlocks and shields.",
      "conceptVideoPrompt": "A fast-paced montage of cyber security symbols—a shield, a padlock, a fingerprint scanner—locking into place one by one, ending with a bright green 'Access Granted' text.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l03.png"
    },
    {
      ...
      "type": "video",
      "duration": 13,
      "lessonImagePrompt": "A glowing digital brick wall blocking red malicious data packets while allowing green safe packets to pass through, set in a dark cyberspace environment.",
      "conceptVideoPrompt": "An animation of a data stream. A glowing blue tunnel (VPN) forms around the data, protecting it from shadowy figures outside. The data then passes through a high-tech checkpoint (Firewall/IPS) that scans and vaporizes a red, malicious packet.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l04.png"
    },
    {
      ...
      "type": "interactive",
      "duration": 14,
      "lessonImagePrompt": "Two glowing keys, one gold and one silver, floating above a stream of encrypted binary code that transforms into readable text, cinematic lighting.",
      "conceptVideoPrompt": "A visual representation of a message being locked in a digital box with a public key, traveling across a network, and being unlocked by a private key. The box then transforms into a secure HTTPS padlock.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l05.png"
    },
    {
      ...
      "type": "quiz",
      "duration": 8,
      "lessonImagePrompt": "A futuristic glowing padlock intertwined with a network routing map, symbolizing the intersection of cryptography and network defense.",
      "conceptVideoPrompt": "A rotating 3D padlock made of glowing binary code, which suddenly snaps shut and emits a pulse of blue light across a digital network grid.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l06.png"
    },
    {
      ...
      "type": "video",
      "duration": 13,
      "lessonImagePrompt": "A shadowy figure wearing a digital mask, holding a fishing rod with a glowing email icon as bait, set against a dark, moody cyber background.",
      "conceptVideoPrompt": "An animation showing a seemingly normal email arriving in an inbox. As the user clicks a link, the email transforms into a digital Trojan horse, releasing tiny red virus particles into the computer system.",
      "objectives": [
    ...
    },
    {
      ...
      "type": "interactive",
      "duration": 14,
      "lessonImagePrompt": "A high-tech Security Operations Center (SOC) with multiple glowing holographic screens displaying global threat maps, log data, and alert graphs.",
      "conceptVideoPrompt": "A digital map of a network under attack. Red warning nodes light up. A digital shield deploys to isolate the infected nodes (Containment), a sweeping laser clears the red nodes (Eradication), and they turn green again (Recovery).",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l08.png"
    },
    {
      ...
      "type": "quiz",
      "duration": 8,
      "lessonImagePrompt": "A glowing digital magnifying glass examining a suspicious email, with a background of complex network logs and security alerts.",
      "conceptVideoPrompt": "A rapid sequence showing a phishing email being blocked, followed by a security analyst's dashboard lighting up with a resolved alert, ending with a green checkmark.",
      "objectives": [
    ...
    },
    {
      ...
      "type": "quiz",
      "duration": 12,
      "lessonImagePrompt": "A grand, futuristic cyber fortress with glowing blue shields, representing mastery of all cybersecurity domains, cinematic and epic.",
      "conceptVideoPrompt": "A sweeping camera move over a massive, glowing digital city representing a secure network. Shields, firewalls, and encrypted tunnels pulse with energy, showing a fully protected ecosystem.",
      "objectives": [
      ...
      "imageUrl": "/generated-images/refinery/cybersecurity-101-l10.png"
    }
  ]
};
