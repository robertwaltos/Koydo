...
export const Economics101Module: LearningModule = {
  ...
  description:
    "Understand how individuals and firms make decisions about scarce resources. Master supply and demand, market structures, pricing, and the invisible hand that shapes economies.",
  subject: "Business",
  ...
  lessons: [
    /* ──────────────────────────────────────────────
       L01  Scarcity, Choice, and Opportunity Cost  (video)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "The PPF is a graph showing all combinations of two goods a society can produce with its available resources. Points on the curve are efficient (all resources used). Points inside are inefficient (wasted resources). Points outside are unattainable (not enough resources). The PPF is bowed outward because of increasing opportunity costs — as you produce more of one good, you sacrifice increasingly more of the other."
        }
      ],
      flashcards: [
        { id: "economics-101-l01-f1", front: "Scarcity", back: "The fundamental economic problem: unlimited wants but limited resources to satisfy them" },
        { id: "economics-101-l01-f2", front: "Opportunity cost", back: "The value of the next best alternative forgone when making a choice" },
        { id: "economics-101-l01-f3", front: "Production Possibilities Frontier (PPF)", back: "A curve showing all efficient combinations of two goods an economy can produce with available resources" },
        { id: "economics-101-l01-f4", front: "Four factors of production", back: "Land, labor, capital, and entrepreneurship — the resources used to produce goods and services" }
      ]
    },

    /* ──────────────────────────────────────────────
       L02  Supply and Demand  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        {
          ...
          content:
            "The demand curve shows the relationship between a good's price and the quantity consumers want to buy (holding all else constant). It slopes downward: as price rises, quantity demanded falls (law of demand). Factors that shift the entire demand curve include income changes, consumer preferences, prices of related goods (substitutes and complements), expectations, and population size."
        },
        {
          id: "economics-101-l02-c2",
          title: "The Supply Curve",
          content:
            "The supply curve shows the relationship between a good's price and the quantity producers are willing to sell. It slopes upward: as price rises, quantity supplied increases (law of supply). Factors that shift supply include input costs, technology changes, number of sellers, government regulations, and expectations about future prices."
        },
        {
      ...
      interactiveActivities: [
        {
          ...
          buckets: ["Shifts Demand Right", "Shifts Demand Left", "Shifts Supply Right", "Shifts Supply Left"],
          items: [
            { text: "Consumer income increases (normal good)", bucket: "Shifts Demand Right" },
            { text: "Price of a complement rises", bucket: "Shifts Demand Left" },
            { text: "New technology reduces production costs", bucket: "Shifts Supply Right" },
            { text: "Government imposes a new tax on producers", bucket: "Shifts Supply Left" },
            { text: "Consumer preferences shift toward the good", bucket: "Shifts Demand Right" },
            { text: "Input costs (wages, materials) increase", bucket: "Shifts Supply Left" },
            { text: "Price of a substitute falls", bucket: "Shifts Demand Left" },
            { text: "New firms enter the market", bucket: "Shifts Supply Right" }
          ]
        }
      ],
      flashcards: [
        { id: "economics-101-l02-f1", front: "Law of demand", back: "As price increases, quantity demanded decreases (all else equal) — demand curves slope downward" },
        { id: "economics-101-l02-f2", front: "Law of supply", back: "As price increases, quantity supplied increases (all else equal) — supply curves slope upward" },
        { id: "economics-101-l02-f3", front: "Market equilibrium", back: "The price and quantity where supply equals demand — no tendency for change" },
        { id: "economics-101-l02-f4", front: "Surplus vs. shortage", back: "Surplus: Qs > Qd (price too high). Shortage: Qd > Qs (price too low)" }
      ]
    },
    ...
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate knowledge of scarcity, opportunity cost, supply, and demand"],
      questions: [
        {
          ...
          options: [
            { id: "a", text: "The maximum profit a firm can earn" },
            { id: "b", text: "All efficient combinations of two goods an economy can produce" },
            { id: "c", text: "The relationship between price and quantity demanded" },
            { id: "d", text: "How interest rates affect investment" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Demand for tea decreases" },
            { id: "b", text: "Supply of tea decreases" },
            { id: "c", text: "Demand for tea increases" },
            { id: "d", text: "No change — they are unrelated" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Quantity demanded exceeds quantity supplied" },
            { id: "b", text: "The market is at equilibrium" },
            { id: "c", text: "Quantity supplied exceeds quantity demanded" },
            { id: "d", text: "Both supply and demand shift right" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "The total cost of producing a good" },
            { id: "b", text: "The monetary price of a good" },
            { id: "c", text: "The value of the next best alternative forgone" },
            { id: "d", text: "The cost of raw materials" }
          ],
          correctOptionId: "c",
      ...
      chunks: [
        {
          ...
          content:
            "Elasticity measures how responsive quantity demanded is to a price change. Formula: % change in quantity demanded ÷ % change in price. If elasticity > 1, demand is elastic (sensitive to price — luxury goods, goods with many substitutes). If elasticity < 1, demand is inelastic (insensitive — necessities, addictive goods, goods with few substitutes). If elasticity = 1, it's unit elastic."
        },
        {
        ...
        },
        {
          ...
          content:
            "Elasticity determines whether raising prices increases or decreases total revenue. If demand is elastic, a price increase reduces revenue (the quantity drop outweighs the price gain). If demand is inelastic, a price increase raises revenue (quantity barely changes). This is why pharmaceutical companies can charge high prices (inelastic demand) but airlines constantly run sales (elastic demand for leisure travel)."
        }
      ],
      flashcards: [
        { id: "economics-101-l04-f1", front: "Price elasticity of demand", back: "% change in quantity demanded ÷ % change in price — measures sensitivity of demand to price changes" },
        { id: "economics-101-l04-f2", front: "Elastic demand (Ed > 1)", back: "Quantity demanded is very responsive to price changes — luxury goods, goods with many substitutes" },
        { id: "economics-101-l04-f3", front: "Inelastic demand (Ed < 1)", back: "Quantity demanded is not very responsive to price changes — necessities, addictive goods" },
        { id: "economics-101-l04-f4", front: "Total revenue test", back: "If demand is elastic, lower prices to increase revenue. If inelastic, raise prices to increase revenue." }
      ]
    },

    /* ──────────────────────────────────────────────
       L05  Market Structures  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        {
          ...
          content:
            "Markets range from highly competitive to monopolistic. Perfect competition: many sellers, identical products, no market power (agriculture, commodities). Monopolistic competition: many sellers, differentiated products, some market power (restaurants, clothing). Oligopoly: few dominant sellers, interdependent decisions, significant market power (airlines, telecom). Monopoly: one seller, unique product, maximum market power (utilities, patented drugs)."
        },
        {
      ...
      interactiveActivities: [
        {
          ...
          title: "Sort into Categories",
          type: "sorting_buckets",
          buckets: ["Perfect Competition", "Monopolistic Competition", "Oligopoly", "Monopoly"],
          items: [
            { text: "Wheat farming", bucket: "Perfect Competition" },
            { text: "Local restaurants", bucket: "Monopolistic Competition" },
            { text: "Commercial airlines", bucket: "Oligopoly" },
            { text: "Local water utility", bucket: "Monopoly" },
            { text: "Clothing brands", bucket: "Monopolistic Competition" },
            { text: "Smartphone operating systems", bucket: "Oligopoly" },
            { text: "Patented pharmaceutical drug", bucket: "Monopoly" },
            { text: "Corn commodities market", bucket: "Perfect Competition" }
          ]
        }
      ],
      flashcards: [
        { id: "economics-101-l05-f1", front: "Perfect competition", back: "Many sellers, identical products, free entry/exit, zero economic profit in long run" },
        { id: "economics-101-l05-f2", front: "Monopoly", back: "One seller, unique product, high barriers to entry, sets price above competitive level" },
        { id: "economics-101-l05-f3", front: "Oligopoly", back: "Few dominant firms, interdependent decisions, significant barriers to entry — game theory applies" },
        { id: "economics-101-l05-f4", front: "Deadweight loss", back: "The loss of economic efficiency when market output is below the competitive level — caused by monopoly power or taxes" }
      ]
    },

    /* ──────────────────────────────────────────────
       L06  Elasticity & Markets Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate knowledge of elasticity and market structures"],
      questions: [
        {
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Increase total revenue" },
            { id: "b", text: "Decrease total revenue" },
            { id: "c", text: "Have no effect on revenue" },
            { id: "d", text: "Double total revenue" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "The monopolist produces too much output" },
            { id: "b", text: "The monopolist charges below competitive prices" },
            { id: "c", text: "The monopolist restricts output and charges above competitive prices" },
            { id: "d", text: "There are too many competitors" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L07  Consumer & Producer Surplus  (video)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        {
          ...
          content:
            "Consumer surplus is the benefit consumers get from buying at a price lower than they'd be willing to pay. If you'd pay $5 for coffee but it costs $3, your consumer surplus is $2. On a graph, it's the area between the demand curve and the market price. Producer surplus is the benefit producers get from selling at a price higher than their minimum acceptable price. Total surplus (consumer + producer) is maximized at the competitive equilibrium."
        },
        {
          id: "economics-101-l07-c2",
          title: "Price Floors and Ceilings",
          content:
            "A price floor sets a minimum price above equilibrium (e.g., minimum wage, agricultural price supports). It creates a surplus of the good. A price ceiling sets a maximum price below equilibrium (e.g., rent control). It creates a shortage. Both reduce total surplus by moving the market away from equilibrium. The lost surplus is deadweight loss — a cost to society from the intervention."
        },
        {
          id: "economics-101-l07-c3",
          title: "Taxes and Surplus",
          content:
            "When the government imposes a tax on a good, the price buyers pay rises and the price sellers receive falls. The difference goes to the government as tax revenue. But the tax also reduces the quantity traded, creating deadweight loss. Tax incidence (who bears the tax burden) depends on elasticity: the more inelastic side bears more of the tax. If demand is inelastic, consumers bear most of it."
        }
      ],
      flashcards: [
        { id: "economics-101-l07-f1", front: "Consumer surplus", back: "The difference between what consumers are willing to pay and what they actually pay — the 'bonus' from buying" },
        { id: "economics-101-l07-f2", front: "Producer surplus", back: "The difference between the market price and the minimum price sellers would accept — the 'bonus' from selling" },
        { id: "economics-101-l07-f3", front: "Price floor", back: "A government-set minimum price above equilibrium — creates surplus (e.g., minimum wage)" },
        { id: "economics-101-l07-f4", front: "Tax incidence", back: "How the burden of a tax is split between buyers and sellers — depends on relative elasticity" }
      ]
    },

    /* ──────────────────────────────────────────────
       L08  Externalities & Market Failures  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        {
          ...
          content:
            "An externality is a cost or benefit that affects a third party not involved in a transaction. A negative externality (pollution from a factory) imposes costs on society that the producer doesn't pay. A positive externality (education) creates benefits for society beyond the individual student. Markets fail when externalities exist because the market price doesn't reflect the full social cost or benefit."
        },
        {
      ...
      interactiveActivities: [
        {
          ...
          title: "Sort into Categories",
          type: "sorting_buckets",
          buckets: ["Negative Externality", "Positive Externality"],
          items: [
            { text: "Factory pollution affecting nearby residents", bucket: "Negative Externality" },
            { text: "A neighbor's beautiful garden raising property values", bucket: "Positive Externality" },
            { text: "Secondhand cigarette smoke", bucket: "Negative Externality" },
            { text: "Flu vaccination reducing disease spread", bucket: "Positive Externality" },
            { text: "Traffic congestion from commuters", bucket: "Negative Externality" },
            { text: "Education creating a more productive workforce", bucket: "Positive Externality" }
          ]
        }
      ],
      flashcards: [
        { id: "economics-101-l08-f1", front: "Negative externality", back: "A cost imposed on third parties not involved in a transaction — e.g., pollution. Market overproduces." },
        { id: "economics-101-l08-f2", front: "Positive externality", back: "A benefit received by third parties not involved in a transaction — e.g., education. Market underproduces." },
        { id: "economics-101-l08-f3", front: "Pigouvian tax", back: "A tax on activities that generate negative externalities, designed to make producers internalize the social cost" },
        { id: "economics-101-l08-f4", front: "Coase theorem", back: "If property rights are clear and transaction costs are low, private bargaining can resolve externalities without government" }
      ]
    },

    /* ──────────────────────────────────────────────
       L09  Welfare & Externalities Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate knowledge of surplus, government intervention, and externalities"],
      questions: [
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Supply curve and the market price" },
            { id: "b", text: "Demand curve and the market price" },
            { id: "c", text: "Supply and demand curves" },
            { id: "d", text: "PPF and the origin" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Positive externalities" },
            { id: "b", text: "Monopoly power" },
            { id: "c", text: "Negative externalities" },
            { id: "d", text: "Income inequality" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Whichever side the law says pays the tax" },
            { id: "b", text: "The side with more elastic demand or supply" },
            { id: "c", text: "The side with more inelastic demand or supply" },
            { id: "d", text: "Both sides always share equally" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L10  Mastery Quiz: Microeconomics  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 12,
      objectives: ["Synthesize all microeconomics concepts"],
      questions: [
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Increase demand for the other" },
            { id: "b", text: "Decrease demand for the other" },
            { id: "c", text: "Increase supply of the other" },
            { id: "d", text: "Have no effect on the other" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Maximum economic profit" },
            { id: "b", text: "Zero economic profit" },
            { id: "c", text: "Negative economic profit" },
            { id: "d", text: "Accounting losses" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Government regulation of markets" },
            { id: "b", text: "Self-interested individuals unintentionally promoting social welfare through market prices" },
            { id: "c", text: "Central planning of the economy" },
            { id: "d", text: "Charitable donations by wealthy individuals" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "The highest absolute productivity" },
            { id: "b", text: "The most workers" },
            { id: "c", text: "The lowest opportunity cost" },
            { id: "d", text: "The most natural resources" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L11  Firm Decision-Making Lab  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          pairs: [
            { left: "Fixed cost", right: "Rent, insurance — doesn't change with output" },
            { left: "Variable cost", right: "Materials, hourly wages — changes with output" },
            { left: "Marginal cost", right: "Cost of producing one additional unit" },
            { left: "Average total cost", right: "Total cost divided by quantity (TC/Q)" },
            { left: "MR = MC", right: "Profit-maximizing output level" },
            { left: "Price < AVC", right: "Firm should shut down in the short run" }
          ]
        }
      ],
      flashcards: [
        { id: "economics-101-l11-f1", front: "Marginal revenue (MR)", back: "The additional revenue from selling one more unit — in perfect competition, MR = price" },
        { id: "economics-101-l11-f2", front: "Profit maximization rule", back: "Produce where MR = MC — the point where the last unit just covers its cost" },
        { id: "economics-101-l11-f3", front: "Shutdown rule", back: "Shut down if price < AVC in the short run; exit if price < ATC in the long run" },
        { id: "economics-101-l11-f4", front: "Sunk cost", back: "A cost already incurred that cannot be recovered — should not influence future decisions" }
      ]
    },
    ...
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 10,
      objectives: ["Demonstrate comprehensive microeconomics mastery"],
      questions: [
        {
          ...
          options: [
            ...
            { id: "b", text: "Price < AVC" },
            { id: "c", text: "MR > MC" },
            { id: "d", text: "Total revenue = total cost" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Next month's rent" },
            { id: "b", text: "Money already spent on a non-refundable concert ticket" },
            { id: "c", text: "The cost of raw materials for tomorrow's production" },
            { id: "d", text: "Employee wages for next week" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Overproduce the good" },
            { id: "b", text: "Underproduce the good" },
            { id: "c", text: "Produce the efficient quantity" },
            { id: "d", text: "Eliminate consumer surplus" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "b", text: "Monopoly" },
            { id: "c", text: "Oligopoly" },
            { id: "d", text: "Monopolistic competition" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L13  Real-World Micro: Case Studies  (video)
    ────────────────────────────────────────────── */
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Netflix operates in monopolistic competition — many streaming services, but each offers differentiated content. Their pricing strategy reflects demand elasticity: they test price sensitivity across markets and tiers. When they raised prices in 2022, subscribers in elastic markets (with many alternatives) left, while subscribers in inelastic markets (hooked on exclusive content) stayed. This is microeconomics in action."
        },
        {
          id: "economics-101-l13-c3",
          title: "Carbon Taxes: Externalities in Policy",
          content:
            "Climate change is the textbook negative externality: burning fossil fuels imposes costs (rising seas, extreme weather) on people who didn't choose to pollute. A carbon tax is a Pigouvian tax — it makes polluters pay the social cost, incentivizing cleaner alternatives. Countries like Sweden, Canada, and the EU have implemented carbon pricing. The debate centers on the right tax level and how to use the revenue."
        }
      ],
      flashcards: [
        { id: "economics-101-l13-f1", front: "Surge pricing", back: "Dynamic pricing that increases with demand — efficient allocation but raises fairness concerns" },
        { id: "economics-101-l13-f2", front: "Product differentiation", back: "Making a product distinct from competitors' to gain some market power — key to monopolistic competition" },
        { id: "economics-101-l13-f3", front: "Carbon tax", back: "A Pigouvian tax on CO₂ emissions — internalizes the externality of climate change into market prices" }
      ]
    },

    /* ──────────────────────────────────────────────
       L14  Coaching Clinic: Common Mistakes  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      interactiveActivities: [
        {
          ...
          title: "Sort into Categories",
          type: "sorting_buckets",
          buckets: ["Shift of Demand Curve", "Movement Along Demand Curve"],
          items: [
            { text: "Price of the good decreases", bucket: "Movement Along Demand Curve" },
            { text: "Consumer income increases", bucket: "Shift of Demand Curve" },
            { text: "Price of a substitute falls", bucket: "Shift of Demand Curve" },
            { text: "A sale reduces the good's price by 20%", bucket: "Movement Along Demand Curve" },
            { text: "A viral trend makes the good popular", bucket: "Shift of Demand Curve" },
            { text: "The good's price rises due to tariffs", bucket: "Movement Along Demand Curve" }
          ]
        }
      ],
      flashcards: [
        { id: "economics-101-l14-f1", front: "Sunk cost fallacy", back: "The error of continuing an action because of past costs rather than future benefits — irrational but common" },
        { id: "economics-101-l14-f2", front: "Shift vs. movement", back: "Price change = movement along curve. Non-price factor change = shift of the entire curve" }
      ]
    },
    ...
    ────────────────────────────────────────────── */
    {
      ...
      type: "quiz",
      duration: 10,
      objectives: ["Demonstrate comprehensive mastery of microeconomics"],
      questions: [
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Left (demand decreases)" },
            { id: "b", text: "Right (demand increases)" },
            { id: "c", text: "It doesn't shift — it causes a movement along the curve" },
            { id: "d", text: "The supply curve shifts instead" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "The government intervenes with taxes" },
            { id: "b", text: "Property rights are clear and transaction costs are low" },
            { id: "c", text: "All goods are public goods" },
            { id: "d", text: "There is perfect competition" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "The good is a necessity" },
            { id: "b", text: "There are few substitutes" },
            { id: "c", text: "Many close substitutes are available" },
            { id: "d", text: "The good takes a small share of income" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          skillId: "economics-101-skill-core",
          options: [
            { id: "a", text: "Fixed costs always increase" },
            { id: "b", text: "Spreading fixed costs lowers ATC at first, then diminishing returns raises it" },
            { id: "c", text: "Variable costs are constant" },
            { id: "d", text: "Marginal revenue always exceeds marginal cost" }
          ],
          correctOptionId: "b",
