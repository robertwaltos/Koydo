  ...
  "lessons": [
    {
      ...
      "flashcards": [
        ...
        {
          "id": "business-ethics-401-l01-f2",
          "front": "Servant leadership (Greenleaf)",
          "back": "Prioritizes the needs of followers and community over the leader's interests — the test: do those served grow as persons, become healthier, wiser, freer?"
        },
        {
          "id": "business-ethics-401-l01-f3",
          "front": "Trickle-down effect in ethical leadership",
          "back": "Ethical top leaders influence middle managers who shape frontline behavior — social learning cascades through organizational levels, making leadership ethics (or their absence) pervasive"
        }
      ],
      "learningAids": [
        {
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "An ethical leader because personal integrity is sufficient"
            },
            {
              "id": "b",
              "text": "A moral person but not a moral manager — sending ambiguous signals to the organization"
            },
            {
              "id": "c",
              "text": "A transformational leader who leads by quiet example"
            },
            {
              "id": "d",
              "text": "A servant leader focused on follower needs"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "He decided profit should be the only measure of success"
            },
            {
              "id": "b",
              "text": "Environmental metrics proved impossible to measure"
            },
            {
              "id": "c",
              "text": "It was being used as an accounting tool rather than driving systemic change"
            },
            {
              "id": "d",
              "text": "Governments mandated a different framework"
            }
          ],
          "correctOptionId": "c",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "It focuses too narrowly on shareholder returns"
            },
            {
              "id": "b",
              "text": "Without clear metrics, managers gain discretion that could shield self-serving behavior"
            },
            {
              "id": "c",
              "text": "It was never endorsed by any major business organization"
            },
            {
              "id": "d",
              "text": "It requires companies to become nonprofit organizations"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Convert to nonprofit status"
            },
            {
              "id": "b",
              "text": "Score at least 80 on the B Impact Assessment and amend legal governing documents"
            },
            {
              "id": "c",
              "text": "Donate at least 50% of profits to charity"
            },
            {
              "id": "d",
              "text": "Be headquartered in the United States"
            }
          ],
          "correctOptionId": "b",
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Compliance-based programs focused on rules and punishment"
            },
            {
              "id": "b",
              "text": "Values-based programs that help employees reason through ethical dilemmas"
            },
            {
              "id": "c",
              "text": "Programs that rely exclusively on written codes of conduct"
            },
            {
              "id": "d",
              "text": "Programs managed entirely by the legal department"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Cannot generate any profit"
            },
            {
              "id": "b",
              "text": "Measures success by social or environmental impact alongside financial returns"
            },
            {
              "id": "c",
              "text": "Must be organized as a nonprofit"
            },
            {
              "id": "d",
              "text": "Is exempt from all tax obligations"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Ethics policies automatically flow from headquarters to subsidiaries"
            },
            {
              "id": "b",
              "text": "Top leaders' ethical behavior cascades through middle managers to frontline employees"
            },
            {
              "id": "c",
              "text": "Ethical culture only matters at the executive level"
            },
            {
              "id": "d",
              "text": "Financial performance always improves when leaders are ethical"
            }
          ],
          "correctOptionId": "b",
