  ...
  lessons: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l02-ia1",
          type: "drag_and_drop",
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about sun and moon", correctTargetId: "plan" },
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l03-ia1",
          type: "matching_pairs",
          ...
          data: {
            left: [
              { id: "l1", label: "I forgot sun and moon" },
              { id: "l2", label: "I am unsure about planet spotting" },
              { id: "l3", label: "I need to remember day, night, and nearby space objects" }
            ],
            right: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l05-ia1",
          type: "drag_and_drop",
          title: "Learning Steps Game",
          description: "Drag each idea to the right step.",
          estimatedMinutes: 6,
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about planet spotting", correctTargetId: "plan" },
              { id: "d2", label: "Try the activity with a helper", correctTargetId: "play" },
              { id: "d3", label: "Tell someone one thing you learned", correctTargetId: "share" }
            ]
          }
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l06-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l08-ia1",
          type: "drag_and_drop",
          title: "Learning Steps Game",
          description: "Drag each idea to the right step.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l09-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "pre-k-astronomy-101-l10-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
