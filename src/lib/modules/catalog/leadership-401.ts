      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Limits to Growth"
            },
            {
              "id": "b",
              "text": "Shifting the Burden"
            },
            {
              "id": "c",
              "text": "Fixes that Fail"
            },
            {
              "id": "d",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Assigning blame to responsible parties"
            },
            {
              "id": "b",
              "text": "Expressing empathy and stating what is currently known and unknown"
            },
            {
              "id": "c",
              "text": "Waiting until all facts are gathered before saying anything"
            },
            {
              "id": "d",
              "text": "Minimizing the severity to prevent panic"
            }
          ],
          "correctOptionId": "b",
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "To declare the transformation complete"
            },
            {
              "id": "b",
              "text": "To build credibility and momentum for the broader change effort"
            },
            {
              "id": "c",
              "text": "To reward the guiding coalition financially"
            },
            {
              "id": "d",
              "text": "To eliminate all resistance to change"
            }
          ],
          "correctOptionId": "b",
