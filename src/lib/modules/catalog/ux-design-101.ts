...
export const ux_design_101_Module: LearningModule = {
  "id": "ux-design-101",
  ...
  "lessons": [
      ...
      "learningAids": [
        {
          ...
          "type": "image",
          "title": "Visualizing UX vs. UI",
          "content": "Visual Prompt: An illustration of an iceberg. The visible tip above the water is labeled 'UI' (colors, typography, buttons). The massive underwater portion is labeled 'UX' (research, wireframes, user flows, strategy, psychology)."
        }
      ]
    },
    {
      ...
      "learningAids": [
        {
          ...
          "content": "Visual Prompt: A four-quadrant chart centered around a user's face. The quadrants are labeled 'Says', 'Thinks', 'Does', and 'Feels', filled with colorful sticky notes representing user research data."
        }
      ]
    },
    {
      ...
      "learningAids": [
        {
          ...
          "type": "image",
          "title": "Card Sorting in Action",
          "content": "Visual Prompt: A top-down view of a table where a user is organizing scattered index cards (labeled with website topics) into neat, logical columns."
        }
      ]
    },
    {
      ...
      "learningAids": [
        {
          "id": "ux-design-101-l05-a1",
          "type": "image",
          "title": "The Fidelity Spectrum",
          "content": "Visual Prompt: A three-step evolution of a smartphone screen. Step 1: A rough pencil sketch on a napkin (Low-fi). Step 2: A clean, grayscale digital layout with placeholder boxes (Mid-fi). Step 3: A vibrant, fully detailed app screen with photos and brand colors (High-fi)."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "ux-design-101-l07-a1",
          "type": "image",
          "title": "Gestalt Proximity",
          "content": "Visual Prompt: Two groups of dots. On the left, dots are evenly spaced and look like a single block. On the right, the same dots are clustered into three distinct groups, instantly looking like separate objects."
        }
      ]
    },
    {
      ...
      "learningAids": [
        {
          ...
          "content": "Visual Prompt: A split-screen view. One side shows a user navigating a prototype on a laptop, looking slightly confused. The other side shows a researcher quietly taking notes and observing the user's screen via a monitor."
        }
      ]
    },
    {
