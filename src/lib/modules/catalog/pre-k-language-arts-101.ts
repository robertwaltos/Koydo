...
export const PreKLanguageArts101Module: LearningModule = {
  ...
  "description": "A playful introduction to letters A-Z, phonics, beginning sounds, rhyming word families, and sight words for children ages 3-5.",
  "subject": "Reading",
  "tags": [
    "pre-k",
    "curriculum",
      ...
      "chunks": [
        {
          ...
          "content": "Letter A looks like a pointed tent with a line across the middle. Apple and ant start with A — say /a/! Letter B looks like two round bumps stacked on a line. Ball and bee start with B — say /b/!"
        },
        {
          "id": "pre-k-language-arts-101-l01-c2",
          "title": "Letters C and D",
          "content": "Letter C is a big curve like a half moon. Cat and car start with C — say /k/! Letter D is a straight line with a big half-circle on the right. Dog and duck start with D — say /d/!"
        },
        {
          "id": "pre-k-language-arts-101-l01-c3",
          "title": "Letters E and F",
          "content": "Letter E looks like a comb with three teeth pointing right. Egg and elephant start with E — say /e/! Letter F looks like E but with only two teeth. Fish and frog start with F — say /f/!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Letter G is like a C with a little shelf inside. Goat and grapes start with G — say /g/! Letter H is two tall lines with a bridge in the middle. House and hat start with H — say /h/! Letter I is a tall line with a hat on top and shoes on the bottom. Igloo and ice cream start with I — say /i/!"
        },
        {
          "id": "pre-k-language-arts-101-l02-c2",
          "title": "Letters J, K, and L",
          "content": "Letter J is a candy cane — a line that curves at the bottom. Jam and jump start with J — say /j/! Letter K is a tall line with two arms reaching out. Kite and king start with K — say /k/! Letter L is a tall line with a short foot. Lion and lemon start with L — say /l/!"
        },
        {
          "id": "pre-k-language-arts-101-l02-c3",
          "title": "Letter M",
          "content": "Letter M has two tall peaks like mountains. Moon and monkey start with M — say /m/! M is a wide letter — it takes up more space than most other letters. Try drawing M in the air with your finger: down, up to a peak, down to a valley, up to another peak, and down!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Letter N is two tall lines with a slanted bridge between them. Nut and nest start with N — say /n/! Letter O is a perfect round circle. Orange and octopus start with O — say /o/! Letter P is a tall line with a round bump on top. Panda and pie start with P — say /p/!"
        },
        {
          "id": "pre-k-language-arts-101-l04-c2",
          "title": "Letters Q and R",
          "content": "Letter Q is a circle with a little tail at the bottom. Queen and question start with Q — say /kw/! Q almost always has its best friend U right next to it. Letter R looks like P but with a leg kicking out. Rabbit and rose start with R — say /r/!"
        },
        {
          "id": "pre-k-language-arts-101-l04-c3",
          "title": "Letters S and T",
          "content": "Letter S is a curvy snake — it wiggles from top to bottom. Snake and sun start with S — say /s/! Letter T is a tall line with a flat hat on top, like a cross. Turtle and tree start with T — say /t/!"
        }
      ],
      "flashcards": [
        {
      ...
      "questions": [
        {
          ...
          "correctOptionId": "a",
          "explanation": "Apple starts with A! A looks like a pointed tent with a line across the middle."
        },
        {
          ...
          "correctOptionId": "c",
          "explanation": "Letter C is a big curve like a half moon. Cat and car start with C!"
        },
        {
          ...
          "correctOptionId": "c",
          "explanation": "Letter S wiggles like a snake! Snake and sun start with S."
        },
        {
          ...
          "correctOptionId": "a",
          "explanation": "B says /b/ like ball, bee, and banana!"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Letter U looks like a cup or a smile. Umbrella and unicorn start with U — say /u/! Letter V looks like a bird flying — two lines meeting at a point at the bottom. Volcano and violin start with V — say /v/!"
        },
        {
          "id": "pre-k-language-arts-101-l06-c2",
          "title": "Letters W and X",
          "content": "Letter W looks like two V's side by side — it is the widest letter! Water and wolf start with W — say /w/! Letter X is two lines crossing in the middle, like a treasure map mark. X-ray starts with X — say /ks/!"
        },
        {
          "id": "pre-k-language-arts-101-l06-c3",
          "title": "Letters Y and Z",
          "content": "Letter Y looks like a slingshot or a fork with two arms up. Yarn and yellow start with Y — say /y/! Letter Z goes zigzag: across, down slanted, across again. Zebra and zipper start with Z — say /z/! Now you know ALL 26 letters from A to Z!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Rhyming words sound the same at the END. Cat and hat rhyme — they both end with -at! Dog and log rhyme — they both end with -og! When words rhyme, they are like a song. Rhyming is fun because it helps your brain remember words!"
        },
        {
          "id": "pre-k-language-arts-101-l07-c2",
          "title": "The -at and -an Families",
          "content": "The -at family: cat, hat, bat, mat, sat. They all end with -at! Change the first letter and you get a new word. The -an family: can, man, van, pan, fan, ran. They all end with -an! Say them fast: can-man-van-pan!"
        },
        {
          "id": "pre-k-language-arts-101-l07-c3",
          "title": "The -ig and -og Families",
          "content": "The -ig family: pig, wig, big, dig. They all end with -ig! The -og family: dog, log, frog, fog. They all end with -og! To find a rhyme, listen to the END of the word. If the endings sound the same, the words rhyme!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Sight words are little words you read FAST just by looking at them. You do not need to sound them out letter by letter. Words like THE, IS, A, and I are sight words. You will see them in almost every book you read!"
        },
        {
          "id": "pre-k-language-arts-101-l08-c2",
          "title": "Our First Sight Words",
          "content": "Let's learn seven sight words: THE — the most common word in English! IS — tells us what something is. A — means one of something. I — that is YOU talking about yourself! MY — means it belongs to you. AND — connects two things. TO — means going somewhere. Say each one: the, is, a, I, my, and, to!"
        },
        {
          "id": "pre-k-language-arts-101-l08-c3",
          "title": "Sight Words in Sentences",
          "content": "Now let's use our sight words! 'The cat is big.' 'I see a dog.' 'My ball is red.' 'I go to the park and play.' See how many sight words are in each sentence? The more you practice reading them, the faster you will be!"
        }
      ],
      "flashcards": [
        {
    ...
    },
    {
      ...
      "interactiveActivities": [
        ...
        },
        {
          ...
          "description": "Sort each word into the Sight Words bucket or the Regular Words bucket.",
          "estimatedMinutes": 4,
          "difficultyLevel": "easy",
          "data": {
            "buckets": [
      ...
      "questions": [
        {
          ...
          "correctOptionId": "a",
          "explanation": "Umbrella starts with U! U looks like a cup or a smile."
        },
        {
          ...
          "correctOptionId": "a",
          "explanation": "Cat and hat both end with -at, so they rhyme! They sound the same at the end."
        },
        {
          ...
          "correctOptionId": "a",
          "explanation": "'The' is a sight word — a little word you read fast just by looking at it!"
        },
        {
          ...
          "correctOptionId": "c",
          "explanation": "Zebra starts with Z — the last letter of the alphabet!"
        },
        {
          ...
          "correctOptionId": "a",
          "explanation": "Pig and wig both end with -ig, so they rhyme!"
        },
        {
          ...
          "correctOptionId": "c",
          "explanation": "There are 26 letters in the English alphabet — from A all the way to Z!"
        }
      ]
    }
  ]
