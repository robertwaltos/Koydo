  ...
  lessons: [
    {
      ...
      duration: 8,
      learningAids: [
        { id: "pre-k-language-arts-101-l01-a1", type: "image", title: "Picture Story Card", content: "Color visual showing letters, sounds, and storytelling." },
        { id: "pre-k-language-arts-101-l01-a2", type: "animation", title: "Animated Walkthrough", content: "Short animation introducing letters, sounds, and storytelling with simple narration." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l02-a1", type: "practice", title: "Play Activity", content: "Guided hands-on practice for phonics with caregiver support." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "The example that shows phonics clearly" },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "d", text: "A statement not connected to story sequencing" }
          ],
          correctOptionId: "a"
        },
        {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l03-a1", type: "mnemonic", title: "Remembering Phrase", content: "Think, Try, Explain for every letters, sounds, and storytelling challenge." }
      ]
    },
    {
      ...
      duration: 8,
      learningAids: [
        { id: "pre-k-language-arts-101-l04-a1", type: "image", title: "Picture Story Card", content: "Color visual showing phonics." },
        { id: "pre-k-language-arts-101-l04-a2", type: "animation", title: "Animated Walkthrough", content: "Short animation introducing phonics with simple narration." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l05-a1", type: "practice", title: "Play Activity", content: "Guided hands-on practice for story sequencing with caregiver support." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l06-a1", type: "mnemonic", title: "Remembering Phrase", content: "Think, Try, Explain for every letters, sounds, and storytelling challenge." }
      ]
    },
    {
      ...
      duration: 8,
      learningAids: [
        { id: "pre-k-language-arts-101-l07-a1", type: "image", title: "Picture Story Card", content: "Color visual showing letters, sounds, and storytelling." },
        { id: "pre-k-language-arts-101-l07-a2", type: "animation", title: "Animated Walkthrough", content: "Short animation introducing letters, sounds, and storytelling with simple narration." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l08-a1", type: "practice", title: "Play Activity", content: "Guided hands-on practice for phonics with caregiver support." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l09-a1", type: "mnemonic", title: "Remembering Phrase", content: "Think, Try, Explain for every letters, sounds, and storytelling challenge." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "pre-k-language-arts-101-l10-a1", type: "mnemonic", title: "Remembering Phrase", content: "Think, Try, Explain for every letters, sounds, and storytelling challenge." }
      ]
    }
  ],
};
