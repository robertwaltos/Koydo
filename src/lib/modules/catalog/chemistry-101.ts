  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          title: "States of Matter Overview",
          content: "In this lesson, we focus on states of matter through the lens of matter and reactions. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "chemistry-101-l01-c2",
          title: "Core Concept",
          content: "states of matter and atoms work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "chemistry-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for atoms, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "chemistry-101-l01-f1", front: "states of matter", back: "A central target skill in this module. Name it before solving." },
        { id: "chemistry-101-l01-f2", front: "atoms", back: "Use this as the method step after defining the goal." },
        { id: "chemistry-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "chemistry-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for states of matter", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for atoms", correctTargetId: "execute" },
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Matter Basics",
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about states of matter" },
              { id: "l2", label: "Inconsistent approach to atoms" },
              { id: "l3", label: "Weak transfer of matter and reactions under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Mixtures and Solutions Focus",
          content: "This lesson deepens mixtures using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "chemistry-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to mixtures. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "chemistry-101-l04-f1", front: "mixtures", back: "State the target and pick a strategy before solving." },
        { id: "chemistry-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "chemistry-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "chemistry-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "mixtures Concept" },
              { id: "process", label: "chemical change Process" },
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Reaction Evidence",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about mixtures" },
              { id: "l2", label: "Inconsistent approach to chemical change" },
              { id: "l3", label: "Weak transfer of matter and reactions under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Acids, Bases, and pH Setup",
          content: "Use chemical change to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "chemistry-101-l07-f1", front: "chemical change", back: "Use this as your organizing framework before execution." },
        { id: "chemistry-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "chemistry-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "chemistry-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Review: Chemistry Ideas",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about atoms" },
              { id: "l2", label: "Inconsistent approach to chemical change" },
              { id: "l3", label: "Weak transfer of matter and reactions under timing" }
            ],
            right: [
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Mastery: Chemistry",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about states of matter" },
              { id: "l2", label: "Inconsistent approach to mixtures" },
              { id: "l3", label: "Weak transfer of matter and reactions under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          ...
          "Apply a step-by-step correction using mixtures.",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in atoms", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on chemical change", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "chemistry-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Chemistry Mastery Applied Retest",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "chemistry-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines states of matter, mixtures, and chemical change in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "chemistry-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "chemistry-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "chemistry-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "chemistry-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "chemistry-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting states of matter, mixtures, and chemical change." },
        { id: "chemistry-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on states of matter setup" },
              { id: "l2", label: "Losses due to rushed chemical change decisions" },
      ...
      learningAids: [
        { id: "chemistry-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "chemistry-101-l15",
      title: "Chemistry Mastery Mastery Sprint",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Chemistry Mastery Mastery Sprint",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "chemistry-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
