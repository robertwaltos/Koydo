...
export const PreKFarming101Module: LearningModule = {
  ...
  lessons: [
    ...
    },
    {
      ...
      title: "Guided Play: Garden and Food Explorers",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about seed to plant", correctTargetId: "plan" },
    ...
    },
    {
      ...
      title: "Checkpoint: Core Idea (Garden and Food Explorers)",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "I forgot seed to plant" },
              { id: "l2", label: "I am unsure about farm tools" },
              { id: "l3", label: "I need to remember seeds, soil, and growing food" }
            ],
            right: [
    ...
    },
    {
      ...
      title: "Story and Example Time: Garden and Food Explorers",
      type: "video",
      duration: 8,
      learningAids: [
    ...
    },
    {
      ...
      title: "Hands-On Practice: Garden and Food Explorers",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about farm tools", correctTargetId: "plan" },
              { id: "d2", label: "Try the activity with a helper", correctTargetId: "play" },
              { id: "d3", label: "Tell someone one thing you learned", correctTargetId: "share" }
            ]
          }
    ...
    },
    {
      ...
      title: "Checkpoint: Practice Skills (Garden and Food Explorers)",
      type: "quiz",
      duration: 10,
      questions: [
        {
    ...
    },
    {
      ...
      title: "Build and Create: Garden and Food Explorers",
      type: "video",
      duration: 8,
      learningAids: [
    ...
    },
    {
      ...
      title: "Reflection Circle: Garden and Food Explorers",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
    ...
    },
    {
      ...
      title: "Review Game: Garden and Food Explorers",
      type: "quiz",
      duration: 10,
      questions: [
        {
    ...
    },
    {
      ...
      title: "Celebration Quiz: Garden and Food Explorers",
      type: "quiz",
      duration: 10,
      questions: [
        {
