      ...
      "chunks": [
        {
          ...
          "content": "Central tendency tells us where the 'center' of our data lies. The mean (average) sums all values and divides by count — useful for symmetric data like monthly revenue. The median is the middle value when data is sorted — better for skewed data like household income or home prices. The mode is the most frequent value — useful for categorical data like the most popular product size."
        },
        {
          "id": "business-analytics-101-l03-c2",
          "title": "Measures of Variability",
          "content": "Variability describes how spread out data is. Range (max minus min) gives a rough picture but is sensitive to outliers. Variance measures the average squared deviation from the mean. Standard deviation — the square root of variance — is expressed in the original units, making it more interpretable. In business, variability matters: two products with the same average revenue but different variability represent different risk profiles."
        },
        {
          "id": "business-analytics-101-l03-c3",
          "title": "Choosing the Right Statistics",
          "content": "The best summary statistic depends on the data and the question. For normally distributed revenue data, mean and standard deviation work well. For salary data with extreme outliers, median and interquartile range are more informative. For customer satisfaction ratings on a 1-5 scale, mode and frequency distributions tell the story. Always pair a measure of center with a measure of spread for a complete picture."
        }
      ],
      "flashcards": [
        {
