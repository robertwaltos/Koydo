  ...
  lessons: [
    {
      ...
      duration: 9,
      learningAids: [
        { id: "project-management-201-l01-a1", type: "image", title: "Concept Card", content: "Visual summary for Project Management." },
        { id: "project-management-201-l01-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Project Management." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l02-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l03-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l04-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "project-management-201-l05-a1", type: "image", title: "Concept Card", content: "Visual summary for Project Management." },
        { id: "project-management-201-l05-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Project Management." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l06-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "project-management-201-l07-a1", type: "image", title: "Concept Card", content: "Visual summary for Project Management." },
        { id: "project-management-201-l07-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Project Management." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l08-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l09-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "project-management-201-l10-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    }
  ],
};
