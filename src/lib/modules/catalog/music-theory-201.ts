...
export const MusicTheory201Module: LearningModule = {
  ...
  "description": "Explore intervals, build major and minor chords, master key signatures, and train your ear. Bridge the gap between reading notes and understanding harmony.",
  "subject": "Music",
  "tags": [
    "core",
    "curriculum",
      ...
      "chunks": [
        {
          ...
          "content": "An interval is the distance in pitch between two notes. When you sing the first two notes of 'Twinkle, Twinkle Little Star,' you're singing an interval of a perfect 5th. Intervals are the DNA of melody and harmony — every chord and scale is built from them. We measure intervals by counting letter names: from C to E is a 3rd (C-D-E, three letter names)."
        },
        {
          "id": "music-theory-201-l01-c2",
          "title": "Melodic vs. Harmonic Intervals",
          "content": "A melodic interval occurs when two notes are played one after the other — like a melody. A harmonic interval occurs when two notes sound at the same time — like in a chord. The same interval (say, a 3rd from C to E) sounds different depending on whether the notes are played sequentially or simultaneously. Both types are measured the same way."
        },
        {
          "id": "music-theory-201-l01-c3",
          "title": "Interval Numbers",
          "content": "We name intervals by counting the letter names from the lower note to the upper note, including both endpoints. C to D is a 2nd. C to E is a 3rd. C to F is a 4th. C to G is a 5th. C to A is a 6th. C to B is a 7th. C to the next C is an octave (8th). A unison means two notes of the same pitch."
        }
      ],
      "flashcards": [
        {
          ...
          "front": "Interval",
          "back": "The distance in pitch between two notes, measured by counting letter names"
        },
        {
          "id": "music-theory-201-l01-f2",
          "front": "Melodic interval",
          "back": "Two notes played one after the other (sequentially)"
        },
        {
          "id": "music-theory-201-l01-f3",
          "front": "Harmonic interval",
          "back": "Two notes played at the same time (simultaneously)"
        },
        {
          "id": "music-theory-201-l01-f4",
          "front": "Unison",
          "back": "An interval of zero distance — two notes of the same pitch"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Interval number alone doesn't tell the whole story. C to E and C to E♭ are both 3rds, but they sound very different. The first is a major 3rd (4 half steps) and the second is a minor 3rd (3 half steps). Quality describes the exact size of an interval. The five qualities are: perfect, major, minor, augmented, and diminished."
        },
        {
          "id": "music-theory-201-l02-c2",
          "title": "Perfect Intervals",
          "content": "Unisons, 4ths, 5ths, and octaves are called 'perfect' intervals. A perfect 4th has 5 half steps (C to F). A perfect 5th has 7 half steps (C to G). These intervals sound very stable and consonant. If you make a perfect interval one half step larger, it becomes augmented. One half step smaller becomes diminished."
        },
        {
          "id": "music-theory-201-l02-c3",
          "title": "Major and Minor Intervals",
          "content": "2nds, 3rds, 6ths, and 7ths come in major and minor qualities. A major interval is one half step larger than its minor counterpart. Major 2nd = 2 half steps; minor 2nd = 1 half step. Major 3rd = 4 half steps; minor 3rd = 3 half steps. Major 6th = 9 half steps; minor 6th = 8 half steps. Major 7th = 11 half steps; minor 7th = 10 half steps."
        }
      ],
      ...
      "flashcards": [
        {
          ...
          "back": "Unisons, 4ths, 5ths, and octaves — the most consonant and stable intervals"
        },
        {
        ...
        },
        {
          ...
          "back": "A perfect or major interval raised by one half step"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "A triad is the simplest chord: three notes stacked in intervals of a 3rd. Start with any note (the root), add a note a 3rd above (the 3rd), then add another 3rd above that (the 5th). For example, a C major triad is C-E-G. The root gives the chord its letter name. Triads are the foundation of all Western harmony."
        },
        {
          "id": "music-theory-201-l04-c2",
          "title": "Major Triads",
          "content": "A major triad is built with a major 3rd on the bottom and a minor 3rd on top. From C: C to E is a major 3rd (4 half steps), and E to G is a minor 3rd (3 half steps). The total from root to 5th is a perfect 5th (7 half steps). Major triads sound bright, stable, and 'happy.' Every major scale has three major triads built on scale degrees 1, 4, and 5."
        },
        {
      ...
      "flashcards": [
        {
          ...
          "front": "Triad",
          "back": "A three-note chord built by stacking two intervals of a 3rd (root, 3rd, 5th)"
        },
        {
          "id": "music-theory-201-l04-f2",
          "front": "Major triad formula",
          "back": "Major 3rd (4 half steps) + Minor 3rd (3 half steps) = Perfect 5th"
        },
        {
          "id": "music-theory-201-l04-f3",
          "front": "Minor triad formula",
          "back": "Minor 3rd (3 half steps) + Major 3rd (4 half steps) = Perfect 5th"
        },
        {
          "id": "music-theory-201-l04-f4",
          "front": "Diminished triad",
          "back": "Two stacked minor 3rds; root to 5th is a diminished 5th (tritone)"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "To build a major triad from any root: count up 4 half steps for the 3rd, then 3 more for the 5th. For G major: G → B (4 half steps) → D (3 half steps). For E♭ major: E♭ → G (4 half steps) → B♭ (3 half steps). For minor, reverse the order: 3 half steps then 4. For G minor: G → B♭ (3) → D (4)."
        },
        {
          "id": "music-theory-201-l05-c2",
          "title": "Quick Quality Check",
          "content": "A shortcut to check triad quality: look at the outer interval (root to 5th). If it's a perfect 5th, the triad is either major or minor — check the bottom 3rd to decide. If the outer interval is an augmented 5th, it's augmented. If it's a diminished 5th, it's diminished. This 'outside-in' method is faster than counting every half step."
        }
      ],
      "interactiveActivities": [
        {
      ...
      "flashcards": [
        {
          ...
          "front": "Root",
          "back": "The bottom note of a triad in root position; gives the chord its letter name"
        },
        {
        ...
        },
        {
          ...
          "front": "Tritone",
          "back": "An interval of 6 half steps (diminished 5th or augmented 4th); the most dissonant interval"
        }
      ],
      "learningAids": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Instead of writing a sharp or flat every time a note appears, composers place them all at the beginning of each line in a key signature. A key signature tells performers which notes are consistently raised or lowered throughout the piece. It also tells us which major or minor scale the music is based on. C major has no sharps or flats; every other key has at least one."
        },
        {
          "id": "music-theory-201-l07-c2",
          "title": "The Order of Sharps",
          "content": "Sharps are always added in the same order: F♯, C♯, G♯, D♯, A♯, E♯, B♯. A handy mnemonic: 'Father Charles Goes Down And Ends Battle.' One sharp = G major. Two sharps = D major. Three sharps = A major. The pattern: the last sharp is always the 7th degree of the major scale — go up one half step from the last sharp to find the key."
        },
        {
          "id": "music-theory-201-l07-c3",
          "title": "The Order of Flats",
          "content": "Flats are added in reverse order from sharps: B♭, E♭, A♭, D♭, G♭, C♭, F♭. Mnemonic: 'Battle Ends And Down Goes Charles' Father.' One flat = F major. Two flats = B♭ major. The shortcut: the second-to-last flat is the key name. Exception: one flat is always F major (no second-to-last flat to read)."
        },
        {
      ...
      "flashcards": [
        {
          ...
          "front": "Key signature",
          "back": "Sharps or flats placed at the beginning of each staff line, indicating which notes are consistently altered"
        },
        {
        ...
        },
        {
          ...
          "back": "The minor key sharing the same key signature as a major key, starting on its 6th scale degree"
        }
      ],
      "learningAids": [
        {
      ...
      "flashcards": [
        {
          ...
          "back": "A diagram arranging all 12 keys by ascending 5ths (clockwise) or ascending 4ths (counterclockwise)"
        },
        {
          "id": "music-theory-201-l08-f2",
          "front": "Closely related keys",
          "back": "Keys adjacent on the circle of fifths, differing by only one sharp or flat"
        },
        {
          "id": "music-theory-201-l08-f3",
          "front": "Enharmonic equivalent",
          "back": "Two keys that sound identical but are spelled differently (e.g., F♯ major and G♭ major)"
        }
      ],
      "learningAids": [
        {
      ...
      "flashcards": [
        {
          ...
          "back": "W-H-W-W-H-W-W — the 3rd, 6th, and 7th degrees are lowered compared to major"
        },
        {
          "id": "music-theory-201-l11-f2",
          "front": "Harmonic minor",
          "back": "Natural minor with a raised 7th degree, creating a leading tone and an augmented 2nd between 6 and 7"
        },
        {
          "id": "music-theory-201-l11-f3",
          "front": "Melodic minor (ascending)",
          "back": "Natural minor with raised 6th and 7th ascending; reverts to natural minor descending"
        },
        {
          "id": "music-theory-201-l11-f4",
          "front": "Leading tone",
          "back": "The 7th degree of a scale when it's a half step below the tonic — it 'leads' the ear toward resolution"
        }
      ]
    },
    {
      ...
      "flashcards": [
        {
          ...
          "back": "The ability to identify intervals and notes by comparison to a reference note — trainable through practice"
        },
        {
        ...
        },
        {
          ...
          "front": "Minor 3rd song reference",
          "back": "'Greensleeves' (first two notes of the melody)"
        },
        {
      ...
      "flashcards": [
        {
          ...
          "front": "Transposition",
          "back": "Moving every note of a melody or passage up or down by the same interval, preserving the musical shape"
        },
        {
          "id": "music-theory-201-l14-f2",
          "front": "Transposing instrument",
          "back": "An instrument whose written pitch differs from its sounding pitch (e.g., B♭ trumpet, F horn)"
        },
        {
          "id": "music-theory-201-l14-f3",
          "front": "Concert pitch",
          "back": "The actual sounding pitch — what the audience hears, regardless of how the music is notated for a transposing instrument"
        }
      ]
    },
    {
