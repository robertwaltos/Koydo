  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on research design through the lens of capstone scientific inquiry. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "general-science-401-l01-c2",
          title: "Core Concept",
          content: "research design and evidence synthesis work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "general-science-401-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for evidence synthesis, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "general-science-401-l01-f1", front: "research design", back: "A central target skill in this module. Name it before solving." },
        { id: "general-science-401-l01-f2", front: "evidence synthesis", back: "Use this as the method step after defining the goal." },
        { id: "general-science-401-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "general-science-401-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "general-science-401-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about research design and evidence synthesis." },
        { id: "general-science-401-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing Science vocabulary." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for research design", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for evidence synthesis", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "general-science-401-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on evidence synthesis and write one reflection." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains research design using evidence from the lesson." },
            { id: "b", text: "It ignores how research design works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for evidence synthesis." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to evidence synthesis." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to capstone scientific inquiry." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about research design" },
              { id: "l2", label: "Inconsistent approach to evidence synthesis" },
              { id: "l3", label: "Weak transfer of capstone scientific inquiry under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-science-401-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      flashcards: [
        { id: "general-science-401-l04-f1", front: "model revision", back: "State the target and pick a strategy before solving." },
        { id: "general-science-401-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "general-science-401-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "general-science-401-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "general-science-401-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for model revision scenarios." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              ...
              { id: "process", label: "scientific communication Process" },
      ...
      learningAids: [
        { id: "general-science-401-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a model revision challenge." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "general-science-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for scientific communication." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to scientific communication." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              ...
              { id: "l2", label: "Inconsistent approach to scientific communication" },
              { id: "l3", label: "Weak transfer of capstone scientific inquiry under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "general-science-401-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "Use scientific communication to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "general-science-401-l07-f1", front: "scientific communication", back: "Use this as your organizing framework before execution." },
        { id: "general-science-401-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "general-science-401-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "general-science-401-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "general-science-401-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on scientific communication." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-science-401-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "general-science-401-skill-core",
          options: [
            { id: "a", text: "It explains evidence synthesis using evidence from the lesson." },
            { id: "b", text: "It ignores how evidence synthesis works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Science." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about evidence synthesis" },
              { id: "l2", label: "Inconsistent approach to scientific communication" },
              { id: "l3", label: "Weak transfer of capstone scientific inquiry under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-science-401-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-science-401-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in evidence synthesis", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on scientific communication", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "general-science-401-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-science-401-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines research design, model revision, and scientific communication in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "general-science-401-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "general-science-401-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "general-science-401-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "general-science-401-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "general-science-401-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting research design, model revision, and scientific communication." },
        { id: "general-science-401-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on research design setup" },
              { id: "l2", label: "Losses due to rushed scientific communication decisions" },
      ...
      learningAids: [
        { id: "general-science-401-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-science-401-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
