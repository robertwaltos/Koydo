      ...
      "chunks": [
        {
          ...
          "content": "In his insightful book 'The Mom Test,' Rob Fitzpatrick shares an important lesson for anyone thinking about starting a business: many entrepreneurs often ask questions that lead to misleading answers. This can happen even when asking someone close to you, like your mom, who might say your idea is amazing just to support you! To get the most honest and useful feedback, it’s crucial to focus on what people have actually done in the past instead of what they might do in the future. For instance, instead of asking, 'Would you use an app that does X?' which is a hypothetical question, you should ask, 'How do you currently solve this problem?' This approach encourages people to share their real experiences and challenges. Good questions can help you uncover valuable information. You might ask, 'Can you tell me about the last time you faced [specific problem]?' or 'What solutions have you tried in the past?' These types of questions are more likely to reveal the truth about the problem you’re trying to solve. If a customer hasn’t actively tried to address the issue, it probably means that the problem isn’t serious enough for them to want a solution. Understanding this can help you determine whether your business idea is worth pursuing or if you need to rethink your approach. By asking the right questions, you can gather the insights necessary to build a successful business that truly meets the needs of your customers.\nContext recap: In his insightful book 'The Mom Test,' Rob Fitzpatrick shares an important lesson for anyone thinking about starting a business: many entrepreneurs often ask questions that lead to misleading answers. This can happen even when asking someone close to you, like your mom, who might say your idea is amazing just to support you! To get the most honest and useful feedback, it’s crucial to focus on what people have actually done in the past instead of what they might do in the future. For instance, instead of asking, 'Would you use an app that does X?' which is a hypothetical question, you should ask, 'How do you currently solve this problem?' This approach encourages people to share their real experiences and challenges.\nWhy this matters: The Mom Test: Asking the Right Questions helps learners in Entrepreneurship connect ideas from Entrepreneurship Fundamentals to decisions they make during practice and assessment. Highlight tradeoffs, assumptions, and verification."
        },
        {
          "id": "entrepreneurship-101-l02-c2",
          "title": "Validation Evidence Hierarchy",
          "content": "When you're trying to find out if your business idea is good, it's important to understand that not all feedback is equally valuable. Here’s a helpful way to think about the different types of feedback you might receive, ranked from the least helpful to the most helpful: (1) When someone says, 'That’s a cool idea,' this kind of comment is nice to hear, but it doesn’t really mean much. It’s almost like a compliment without any real commitment. (2) If people sign up for a waitlist, that’s a bit better. It shows some interest, but since they don’t have to put anything on the line, it’s still not a strong indicator of true demand. (3) When people agree to share their email and take the time to talk with you in an interview, that’s a moderate signal. It shows they are interested enough to engage further. (4) If people are willing to pre-order your product or put down a deposit, that’s a strong signal! It means they are ready to commit some of their money, which is a good sign of interest. (5) The strongest signal you can get is when people actually pay for a rough version of your product, like a prototype. This is considered the gold standard of validation because it shows they believe in your idea enough to invest in it. A great example of this is the Pebble Watch, which raised an incredible $10 million from 69,000 backers on Kickstarter before it was even fully developed. This clearly demonstrated that there was a real demand for the product. So, always strive to gather the strongest validation possible before you dive into developing your idea further. This way, you can be more confident that your efforts will pay off!\nContext recap: When you're trying to find out if your business idea is good, it's important to understand that not all feedback is equally valuable. Here’s a helpful way to think about the different types of feedback you might receive, ranked from the least helpful to the most helpful: (1) When someone says, 'That’s a cool idea,' this kind of comment is nice to hear, but it doesn’t really mean much. It’s almost like a compliment without any real commitment. (2) If people sign up for a waitlist, that’s a bit better.\nWhy this matters: Validation Evidence Hierarchy helps learners in Entrepreneurship connect ideas from Entrepreneurship Fundamentals to decisions they make during practice and assessment. Highlight tradeoffs, assumptions, and verification."
        },
        {
          "id": "entrepreneurship-101-l02-c3",
          "title": "Concierge and Wizard-of-Oz Testing",
          "content": "A concierge minimum viable product (MVP) is a way to test your business idea by providing the value of your product or service directly to a small group of customers, but in a manual way. For example, the company Food on the Table began its journey by having the founder personally visit customers' homes. During these visits, he would help them plan their meals and shop for groceries, all before any software was developed. This hands-on approach allowed him to understand what customers really wanted and needed.\nOn the other hand, a Wizard-of-Oz MVP gives the impression that the service is automated, but in reality, it is supported by people working behind the scenes. A great example of this is Zappos, which wanted to see if people would buy shoes online. To test this, they took pictures of shoes that were available in local stores and posted them online. When customers placed orders, they would go to the store, buy the shoes, and then ship them to the customers. This method helped them learn about customer demand without spending a lot of money.\nBoth of these strategies are valuable because they allow you to validate whether there is a demand for your product or service at a low cost. The most important thing to remember is that the goal is to learn about your customers and their preferences. You should focus on gathering insights and understanding what they truly value before you think about expanding your business. Only after you have confirmed that customers appreciate what you are offering should you consider scaling up your operations.\nContext recap: A concierge minimum viable product (MVP) is a way to test your business idea by providing the value of your product or service directly to a small group of customers, but in a manual way. For example, the company Food on the Table began its journey by having the founder personally visit customers' homes. During these visits, he would help them plan their meals and shop for groceries, all before any software was developed. This hands-on approach allowed him to understand what customers really wanted and needed.\nWhy this matters: Concierge and Wizard-of-Oz Testing helps learners in Entrepreneurship connect ideas from Entrepreneurship Fundamentals to decisions they make during practice and assessment. Highlight tradeoffs, assumptions, and verification."
        }
      ],
