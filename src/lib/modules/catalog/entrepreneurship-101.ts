  ...
  "lessons": [
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "content": "Not all problems are worth solving as a business. A strong startup problem passes three tests: Frequency — how often does the customer encounter it? (daily beats yearly). Intensity — how painful is it when it occurs? (migraine beats mild annoyance). Willingness-to-pay — are customers already spending money, time, or effort on workarounds? If people are using spreadsheets, hiring assistants, or duct-taping three apps together to solve a problem, there's a real market. Dropbox succeeded because people were already emailing files to themselves — a clear signal of a high-frequency, high-friction pain point."
        },
        {
          "id": "entrepreneurship-101-l01-c4",
          "title": "Aulet's 24 Steps: A Systematic Framework",
          "content": "Bill Aulet's 'Disciplined Entrepreneurship' presents a 24-step framework that transforms entrepreneurship from an art into a teachable, repeatable process. The journey begins with Step 0 (Getting Started — identifying whether you are driven by an idea, a technology, or a passion), moves through Market Segmentation (Step 1), selecting a Beachhead Market (Step 2), building an End User Profile (Step 3), calculating Total Addressable Market (Step 4), and profiling a detailed Persona (Step 5). These early steps ensure founders are laser-focused on a specific customer before designing any solution. As Aulet argues: 'The single necessary and sufficient condition for a business is a paying customer.' The 24 Steps provide a systematic roadmap that complements the Lean Startup's experimental approach with structured market analysis."
        }
      ],
      "flashcards": [
        {
    ...
    },
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "content": "A minimum viable product is not a crappy product — it's the smallest thing you can build to learn whether your value hypothesis is true. Drew Houston's Dropbox MVP was a three-minute demo video showing how the product would work: signups jumped from 5,000 to 75,000 overnight, validating demand before engineering began. Buffer started as a two-page landing page describing pricing tiers — if visitors clicked 'buy,' they saw a 'coming soon' message, and the click-through rate validated willingness to pay. The key principle: identify your riskiest assumption (usually 'will anyone want this?') and design the cheapest test that addresses it directly."
        },
        {
          "id": "entrepreneurship-101-l05-c3",
          "title": "Pivot or Persevere",
          "content": "After running experiments, founders face the pivot-or-persevere decision. A pivot is a structured course correction — not a random change, but a specific shift in one element of the business model while keeping what's working. Common pivot types include: customer segment pivot (Slack started as an internal gaming tool), zoom-in pivot (Instagram stripped down from a check-in app called Burbn to focus only on photo filters), channel pivot, and revenue model pivot. Vanity metrics (total signups, page views) obscure truth; actionable metrics (activation rate, retention, revenue per user) reveal it. The discipline to pivot based on data, not ego, separates successful founders from those who burn through their runway."
        },
        {
          "id": "entrepreneurship-101-l05-c4",
          "title": "Lean Experimentation and Viability Testing",
          "content": "Brant Cooper's 'The Lean Entrepreneur' extends the Build-Measure-Learn loop with a critical insight: before building anything, define your customer segment with precision — not 'everyone' or 'women aged 18–73,' but a specific group sharing the same problem who speak the same language. Cooper emphasizes that until you have conducted transactions where customers paid something of value, you don't truly know your value proposition. Viability experiments test whether your vision creates real customer value, not just whether the technology works. Bill Aulet's Disciplined Entrepreneurship reinforces this with Step 8 (Quantify the Value Proposition): compare the customer's 'as-is' state to the 'possible' state with your product and ensure the improvement is measurable. Together, these frameworks show that lean entrepreneurship is not about moving fast and breaking things — it's about moving fast and learning things."
        }
      ],
      "interactiveActivities": [
        {
