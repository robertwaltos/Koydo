      ...
      "chunks": [
        {
          ...
          "content": "A dollar today is worth more than a dollar tomorrow — this is the Time Value of Money (TVM), the most fundamental concept in finance. Three forces explain why: (1) Opportunity cost — money available now can be invested to earn a return. (2) Inflation — prices rise over time, eroding purchasing power; at 3% annual inflation, $100 today buys only about $74 worth of goods in 10 years. (3) Risk — a promise of future payment carries uncertainty. TVM underpins every financial decision: pricing loans, valuing companies, evaluating capital projects, and planning for retirement. When a bank charges 7% interest on a car loan, it is compensating for all three factors."
        },
        {
