  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on model construction through the lens of capstone physics modeling and validation. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "physics-401-l01-c2",
          title: "Core Concept",
          content: "model construction and assumption management work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "physics-401-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for assumption management, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "physics-401-l01-f1", front: "model construction", back: "A central target skill in this module. Name it before solving." },
        { id: "physics-401-l01-f2", front: "assumption management", back: "Use this as the method step after defining the goal." },
        { id: "physics-401-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "physics-401-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "physics-401-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about model construction and assumption management." },
        { id: "physics-401-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing Physics vocabulary." }
      ]
    },
    {
      id: "physics-401-l02",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for model construction", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for assumption management", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "physics-401-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on assumption management and write one reflection." }
      ]
    },
    {
      id: "physics-401-l03",
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains model construction using evidence from the lesson." },
            { id: "b", text: "It ignores how model construction works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for assumption management." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to assumption management." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to capstone physics modeling and validation." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about model construction" },
              { id: "l2", label: "Inconsistent approach to assumption management" },
              { id: "l3", label: "Weak transfer of capstone physics modeling and validation under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "physics-401-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "physics-401-l04",
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens multi-system coupling using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "physics-401-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to multi-system coupling. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "physics-401-l04-f1", front: "multi-system coupling", back: "State the target and pick a strategy before solving." },
        { id: "physics-401-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "physics-401-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "physics-401-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "physics-401-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for multi-system coupling scenarios." }
      ]
    },
    {
      id: "physics-401-l05",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "multi-system coupling Concept" },
      ...
      learningAids: [
        { id: "physics-401-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a multi-system coupling challenge." }
      ]
    },
    {
      id: "physics-401-l06",
      ...
      questions: [
        {
          ...
          skillId: "physics-401-skill-core",
          options: [
            { id: "a", text: "It explains multi-system coupling using evidence from the lesson." },
            { id: "b", text: "It ignores how multi-system coupling works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Physics." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about multi-system coupling" },
      ...
      learningAids: [
        { id: "physics-401-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "physics-401-l07",
      ...
      flashcards: [
        { id: "physics-401-l07-f1", front: "quantitative validation", back: "Use this as your organizing framework before execution." },
        { id: "physics-401-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "physics-401-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "physics-401-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "physics-401-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on quantitative validation." }
      ]
    },
    {
      id: "physics-401-l08",
      ...
      learningAids: [
        { id: "physics-401-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      id: "physics-401-l09",
      ...
      questions: [
        {
          ...
          skillId: "physics-401-skill-core",
          options: [
            { id: "a", text: "It explains assumption management using evidence from the lesson." },
            { id: "b", text: "It ignores how assumption management works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Physics." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about assumption management" },
              { id: "l2", label: "Inconsistent approach to quantitative validation" },
              { id: "l3", label: "Weak transfer of capstone physics modeling and validation under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "physics-401-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "physics-401-l10",
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "physics-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for multi-system coupling." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to multi-system coupling." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about model construction" },
              { id: "l2", label: "Inconsistent approach to multi-system coupling" },
              { id: "l3", label: "Weak transfer of capstone physics modeling and validation under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "physics-401-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "physics-401-l11",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in assumption management", correctBucketId: "diagnose" },
      ...
      learningAids: [
        { id: "physics-401-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      id: "physics-401-l12",
      ...
      learningAids: [
        { id: "physics-401-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "physics-401-l13",
      ...
      chunks: [
        {
          ...
          content: "This scenario combines model construction, multi-system coupling, and quantitative validation in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "physics-401-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "physics-401-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "physics-401-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "physics-401-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "physics-401-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting model construction, multi-system coupling, and quantitative validation." },
        { id: "physics-401-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      id: "physics-401-l14",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on model construction setup" },
      ...
      learningAids: [
        { id: "physics-401-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "physics-401-l15",
      ...
      learningAids: [
        { id: "physics-401-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
