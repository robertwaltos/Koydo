  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on rhetorical strategy through the lens of capstone communication and rhetoric. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "language-arts-401-l01-c2",
          title: "Core Concept",
          content: "rhetorical strategy and text synthesis work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "language-arts-401-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for text synthesis, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-401-l01-f1", front: "rhetorical strategy", back: "A central target skill in this module. Name it before solving." },
        { id: "language-arts-401-l01-f2", front: "text synthesis", back: "Use this as the method step after defining the goal." },
        { id: "language-arts-401-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "language-arts-401-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "language-arts-401-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about rhetorical strategy and text synthesis." },
        { id: "language-arts-401-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing Language Arts vocabulary." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for rhetorical strategy", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for text synthesis", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "language-arts-401-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on text synthesis and write one reflection." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains rhetorical strategy using evidence from the lesson." },
            { id: "b", text: "It ignores how rhetorical strategy works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for text synthesis." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to text synthesis." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to capstone communication and rhetoric." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about rhetorical strategy" },
              { id: "l2", label: "Inconsistent approach to text synthesis" },
              { id: "l3", label: "Weak transfer of capstone communication and rhetoric under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "language-arts-401-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens argument architecture using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "language-arts-401-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to argument architecture. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-401-l04-f1", front: "argument architecture", back: "State the target and pick a strategy before solving." },
        { id: "language-arts-401-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "language-arts-401-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "language-arts-401-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "language-arts-401-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for argument architecture scenarios." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "argument architecture Concept" },
              { id: "process", label: "editing for audience Process" },
      ...
      learningAids: [
        { id: "language-arts-401-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a argument architecture challenge." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "language-arts-401-skill-core",
          options: [
            { id: "a", text: "It explains argument architecture using evidence from the lesson." },
            { id: "b", text: "It ignores how argument architecture works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Language Arts." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
        },
        {
          ...
          skillId: "language-arts-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for editing for audience." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to editing for audience." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about argument architecture" },
              { id: "l2", label: "Inconsistent approach to editing for audience" },
              { id: "l3", label: "Weak transfer of capstone communication and rhetoric under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "language-arts-401-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "Use editing for audience to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-401-l07-f1", front: "editing for audience", back: "Use this as your organizing framework before execution." },
        { id: "language-arts-401-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "language-arts-401-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "language-arts-401-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "language-arts-401-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on editing for audience." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "language-arts-401-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "language-arts-401-skill-core",
          options: [
            { id: "a", text: "It explains text synthesis using evidence from the lesson." },
            { id: "b", text: "It ignores how text synthesis works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Language Arts." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about text synthesis" },
              { id: "l2", label: "Inconsistent approach to editing for audience" },
              { id: "l3", label: "Weak transfer of capstone communication and rhetoric under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "language-arts-401-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "language-arts-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for argument architecture." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to argument architecture." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about rhetorical strategy" },
              { id: "l2", label: "Inconsistent approach to argument architecture" },
              { id: "l3", label: "Weak transfer of capstone communication and rhetoric under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "language-arts-401-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in text synthesis", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on editing for audience", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "language-arts-401-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "language-arts-401-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines rhetorical strategy, argument architecture, and editing for audience in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-401-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "language-arts-401-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "language-arts-401-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "language-arts-401-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "language-arts-401-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting rhetorical strategy, argument architecture, and editing for audience." },
        { id: "language-arts-401-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on rhetorical strategy setup" },
              { id: "l2", label: "Losses due to rushed editing for audience decisions" },
      ...
      learningAids: [
        { id: "language-arts-401-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "language-arts-401-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
