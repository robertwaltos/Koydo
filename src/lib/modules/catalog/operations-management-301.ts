...
export const OperationsManagement301Module: LearningModule = {
  ...
  description:
    "Design resilient supply chains and optimize inventory decisions. Master EOQ models, safety stock calculations, JIT delivery systems, demand forecasting, and supplier relationship strategies that balance cost, speed, and reliability across global networks.",
  subject: "Business",
  ...
  lessons: [
    ...
    },
    {
      ...
      flashcards: [
        { id: "operations-management-301-l02-f1", front: "Economic Order Quantity (EOQ)", back: "EOQ = sqrt(2DS/H) — the order size that minimizes total inventory cost by balancing ordering costs (S) and holding costs (H) for annual demand (D)" },
        { id: "operations-management-301-l02-f2", front: "Reorder point formula", back: "ROP = (Average daily demand × Lead time) + Safety stock. Safety stock = z × σ of demand during lead time, where z reflects the desired service level" },
        { id: "operations-management-301-l02-f3", front: "ABC analysis", back: "Pareto-based classification: A items (20% of SKUs, 80% of value) get tight controls; B items (30%, 15%) get moderate controls; C items (50%, 5%) use simple rules" }
      ]
    },
    {
      ...
      flashcards: [
        { id: "operations-management-301-l03-f1", front: "Push vs. pull inventory systems", back: "Push: production driven by forecasts, products pushed to market. Pull: actual customer demand triggers replenishment backward through the supply chain" },
        { id: "operations-management-301-l03-f2", front: "JIT delivery prerequisites", back: "Reliable nearby suppliers, frequent dependable transport, consistently high quality, transparent information sharing, and short setup times" },
        { id: "operations-management-301-l03-f3", front: "Just-in-case strategy", back: "Post-pandemic shift from pure JIT to maintaining strategic buffer stocks and dual-sourcing critical components to improve supply chain resilience" }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content:
            "Qualitative methods rely on expert judgment when historical data is unavailable or unreliable — new product launches, market disruptions, or emerging technologies. The Delphi method surveys a panel of experts through multiple anonymous rounds, converging toward consensus. Market research uses surveys, focus groups, and test markets. Sales force composites aggregate individual sales representatives' estimates. Executive opinion pools senior leadership's strategic insights. These methods are subjective but invaluable when launching a product with no sales history, such as when Apple forecasted initial iPhone demand."
        },
        {
          id: "operations-management-301-l04-c2",
          title: "Quantitative Forecasting",
          content:
            "Time-series methods use historical patterns to predict the future. A simple moving average smooths fluctuations by averaging the last n periods — a 3-month moving average of sales of 100, 120, and 110 forecasts 110. Weighted moving averages assign more importance to recent data. Exponential smoothing is the workhorse of demand planning: Forecast = α × (latest actual) + (1 − α) × (previous forecast), where α (0 to 1) controls how quickly the forecast reacts to new data. High α values (0.3–0.5) respond quickly to changes; low values (0.05–0.1) produce stable forecasts."
        },
        {
          id: "operations-management-301-l04-c3",
          title: "Measuring Forecast Accuracy",
          content:
            "No forecast is perfect, so measuring error is essential. Mean Absolute Deviation (MAD) averages the absolute differences between forecasted and actual values — easy to interpret as the typical error in the same units as demand. Mean Squared Error (MSE) squares errors before averaging, penalizing large misses more heavily. Mean Absolute Percentage Error (MAPE) expresses errors as percentages, making it easy to compare accuracy across products with different demand volumes. A MAPE of 15% means forecasts are typically off by 15%. Tracking bias (consistently over- or under-forecasting) is equally important."
        }
      ],
      flashcards: [
        { id: "operations-management-301-l04-f1", front: "Delphi method", back: "Qualitative forecasting technique using multiple anonymous rounds of expert surveys that converge toward consensus — useful when no historical data exists" },
        { id: "operations-management-301-l04-f2", front: "Exponential smoothing formula", back: "Forecast = α × (latest actual) + (1 − α) × (previous forecast). Alpha (0–1) controls responsiveness: higher α reacts faster to changes" },
        { id: "operations-management-301-l04-f3", front: "MAPE (Mean Absolute Percentage Error)", back: "Average of absolute forecast errors expressed as percentages of actual demand — enables comparison of accuracy across products with different volume levels" }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Efficient supply chain with lean inventory" },
            { id: "b", text: "Responsive supply chain with speed and flexibility" },
            { id: "c", text: "Cost-minimizing supply chain with large batch production" },
            { id: "d", text: "Stable supply chain with long planning horizons" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "The forecast becomes more stable and ignores recent changes" },
            { id: "b", text: "The forecast reacts more quickly to recent actual demand" },
            { id: "c", text: "The forecast always equals the historical average" },
            { id: "d", text: "The forecast becomes a simple moving average" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "A items — 20% of SKUs representing 80% of value" },
            { id: "b", text: "B items — 30% of SKUs representing 15% of value" },
            { id: "c", text: "C items — 50% of SKUs representing 5% of value" },
            { id: "d", text: "All items should receive equal attention" }
          ],
          correctOptionId: "a",
    ...
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Four root causes drive the bullwhip effect, each with a remedy. Demand signal processing (overreacting to short-term demand) is countered by sharing point-of-sale data across the chain. Order batching (placing large infrequent orders) is reduced by smaller, more frequent orders and consolidated shipments. Price fluctuations (forward-buying during promotions) are addressed by everyday low pricing strategies. Shortage gaming (inflating orders during supply constraints) is managed through allocation based on actual sales history. Walmart's Vendor Managed Inventory program, where suppliers manage shelf stock based on real-time data, exemplifies these solutions."
        },
        {
          id: "operations-management-301-l06-c3",
          title: "Supplier Relationship Management",
          content:
            "Supplier relationships exist on a spectrum. Arm's-length transactions work for commodity purchases where switching costs are low — buying office supplies from the cheapest vendor. Preferred supplier agreements offer better terms in exchange for volume commitments. Strategic partnerships involve deep integration: shared systems, joint product development, and long-term contracts. Toyota maintains strategic partnerships with key suppliers, investing in their capabilities and sharing productivity gains. Keiretsu-style relationships built Toyota's supplier base into a competitive weapon, reducing costs 3% annually while improving quality."
        }
      ],
      flashcards: [
        { id: "operations-management-301-l06-f1", front: "Bullwhip effect", back: "Amplification of demand variability as orders move upstream through a supply chain — small consumer demand changes create massive swings at the supplier level" },
        { id: "operations-management-301-l06-f2", front: "Four causes of the bullwhip effect", back: "1) Demand signal processing (overreacting) 2) Order batching (lumpy orders) 3) Price fluctuations (forward-buying) 4) Shortage gaming (inflating orders)" },
        { id: "operations-management-301-l06-f3", front: "Vendor Managed Inventory (VMI)", back: "Supplier manages the buyer's inventory levels using shared real-time demand data — reduces bullwhip effect and shifts replenishment decisions to the party with better supply-side information" }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It requires too many workers" },
            { id: "b", text: "It is too expensive to implement" },
            { id: "c", text: "Minimal inventory buffers amplify the impact of supply disruptions" },
            { id: "d", text: "It only works for service industries" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "MAD (Mean Absolute Deviation)" },
            { id: "b", text: "MAPE (Mean Absolute Percentage Error)" },
            { id: "c", text: "MSE (Mean Squared Error)" },
            { id: "d", text: "Bias" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "b", text: "The bullwhip effect" },
            { id: "c", text: "Diminishing returns" },
            { id: "d", text: "Diseconomies of scope" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Forward integration" },
            { id: "b", text: "Postponement" },
            { id: "c", text: "Vertical integration" },
            { id: "d", text: "Push-based manufacturing" }
          ],
          correctOptionId: "b",
