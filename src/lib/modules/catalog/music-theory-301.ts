      ...
      "chunks": [
        {
          ...
          "content": "Roman numeral analysis assigns a numeral to each chord based on which scale degree it's built on. In C major, a C chord is I, a D minor chord is ii, an E minor chord is iii, and so on. The beauty of this system is that it's key-independent: I-V-vi-IV means the same progression in every key. Uppercase = major, lowercase = minor, ° = diminished, + = augmented."
        },
        {
          "id": "music-theory-301-l01-c2",
          "title": "Diatonic Chords in Major",
          "content": "Every major scale produces seven diatonic triads: I (major), ii (minor), iii (minor), IV (major), V (major), vi (minor), vii° (diminished). These seven chords are the harmonic palette of a key. Most popular music uses only 4-6 of them. The I chord is 'home' (tonic), V wants to resolve home (dominant), and IV leads somewhere (subdominant)."
        },
        {
          "id": "music-theory-301-l01-c3",
          "title": "Reading a Chord Chart",
          "content": "When you see 'I - V - vi - IV' you're looking at the most common progression in pop music. In C major that's C - G - Am - F. In G major it's G - D - Em - C. Roman numerals let musicians communicate harmonic ideas without being locked to a specific key. This is essential for transposing, arranging, and improvisation."
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "This four-chord loop dominates pop, rock, and country music. In C: C-G-Am-F. It works because it balances tension (V), release (I), and emotional depth (vi). Songs like 'Let It Be,' 'No Woman No Cry,' 'With or Without You,' and hundreds of others use this exact progression. It feels familiar because our ears have been trained on it for decades."
        },
        {
          "id": "music-theory-301-l02-c2",
          "title": "The Blues and Rock Progression: I-IV-V",
          "content": "The three-chord I-IV-V progression is the backbone of blues, early rock, and folk. In A: A-D-E. The 12-bar blues structures this into a repeating form: 4 bars of I, 2 of IV, 2 of I, then V-IV-I-V (the turnaround). This progression feels grounded and driving because it uses only the three major chords in the key."
        },
        {
          "id": "music-theory-301-l02-c3",
          "title": "The Jazz Turnaround: ii-V-I",
          "content": "In jazz, the ii-V-I is the fundamental building block. In C: Dm-G-C (or Dm7-G7-Cmaj7 with 7th chords). The ii chord sets up tension, V intensifies it, and I resolves it. Jazz standards chain multiple ii-V-Is together, sometimes in different keys. Mastering this progression is the gateway to jazz improvisation and arranging."
        }
      ],
      ...
      "chunks": [
        {
          ...
          "content": "The seven modes are seven different 'rotations' of the major scale. Start a major scale on each of its seven notes and you get a different mode: Ionian (1st degree, = major scale), Dorian (2nd), Phrygian (3rd), Lydian (4th), Mixolydian (5th), Aeolian (6th, = natural minor), Locrian (7th). Each has a unique step pattern and character."
        },
        {
    ...
    },
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "content": "In C major, the V chord is G. The V of G is D major — which has an F♯ that doesn't belong in C major. That F♯ is a chromatic intruder that pulls the ear toward G. So a progression like C – D – G – C (I – V/V – V – I) sounds richer than staying purely diatonic. The D chord is called V/V ('five of five'). It intensifies the arrival on V."
        },
        {
          "id": "music-theory-301-l11-c3",
          "title": "Other Secondary Dominants",
          "content": "Any diatonic chord (except the diminished vii°) can be preceded by its own secondary dominant. V/ii pulls toward ii, V/IV pulls toward IV, V/vi pulls toward vi. In C major: A7 → Dm is V7/ii → ii. D7 → G is V7/V → V. E7 → Am is V7/vi → vi. Each one introduces a chromatic note that adds color and forward motion."
        }
      ],
      "interactiveActivities": [
        {
