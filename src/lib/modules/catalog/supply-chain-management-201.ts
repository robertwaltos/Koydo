...
export const SupplyChainManagement201Module: LearningModule = {
  ...
  "description": "Master the strategic sourcing process, supplier evaluation frameworks, and relationship management techniques. Learn to apply the Kraljic matrix, calculate total cost of ownership, and build ethical, sustainable procurement strategies.",
  "subject": "Business",
  "tags": [
    "core",
    "curriculum",
      ...
      "chunks": [
        {
          ...
          "content": "Supplier evaluation considers multiple dimensions: quality (defect rates, certifications like ISO 9001), cost (unit price, payment terms, volume discounts), delivery (on-time delivery rate, lead time consistency), capacity (ability to scale), financial stability (balance sheet health, credit ratings), and innovation capability (R&D investment, willingness to co-develop). The relative importance of each criterion depends on the category and business strategy."
        },
        {
          "id": "supply-chain-management-201-l02-c2",
          "title": "Weighted Scoring Model",
          "content": "A weighted scoring model assigns importance weights to each criterion (summing to 100%), rates each supplier on every criterion (e.g., 1–5 scale), and calculates a weighted total score. For example, if quality has 30% weight and a supplier scores 4/5, their quality contribution is 0.30 × 4 = 1.20. The model makes subjective trade-offs explicit and defensible, and it provides a structured basis for comparing alternatives."
        },
        {
          "id": "supply-chain-management-201-l02-c3",
          "title": "Supplier Audits and Qualification",
          "content": "Before awarding contracts, leading firms conduct on-site supplier audits to verify capabilities claimed in proposals. Audits assess production processes, quality systems, labor practices, environmental compliance, and financial records. A pre-qualification stage filters out suppliers that do not meet minimum thresholds before the full evaluation begins. Ongoing performance monitoring through scorecards ensures standards are maintained post-selection."
        }
      ],
      "flashcards": [
        {
          "id": "supply-chain-management-201-l02-f1",
          "front": "Key supplier evaluation dimensions",
          "back": "Quality, cost, delivery, capacity, financial stability, and innovation capability — weighted differently depending on category and strategy"
        },
        {
          "id": "supply-chain-management-201-l02-f2",
          "front": "Weighted scoring model",
          "back": "Assigns percentage weights to criteria, rates suppliers on each (e.g., 1–5), multiplies and sums for a total score — makes trade-offs explicit and comparable"
        },
        {
          "id": "supply-chain-management-201-l02-f3",
          "front": "Supplier audit",
          "back": "On-site verification of a supplier's production processes, quality systems, labor practices, environmental compliance, and financial records before contract award"
        }
      ],
      "learningAids": [
        {
          "id": "supply-chain-management-201-l02-a1",
          "type": "image",
          "title": "Concept Card",
          "content": "Visual summary of the lesson's main concept."
        }
      ...
      "chunks": [
        {
          ...
          "content": "Peter Kraljic's 1983 matrix classifies procurement items along two dimensions: profit impact (how much the item affects the bottom line through cost, quality, or revenue contribution) and supply risk (how difficult the item is to source due to scarcity, few suppliers, substitution difficulty, or geopolitical factors). These two axes create four quadrants, each requiring a different procurement strategy."
        },
        {
          "id": "supply-chain-management-201-l03-c2",
          "title": "The Four Quadrants",
          "content": "Non-critical items (low impact, low risk) — office supplies, standard fasteners. Simplify purchasing with automation and catalog buying. Leverage items (high impact, low risk) — commodity raw materials with many suppliers. Use competitive bidding to drive costs down. Bottleneck items (low impact, high risk) — specialized components with few suppliers. Secure supply through buffer stock and alternative development. Strategic items (high impact, high risk) — critical materials from limited sources. Build deep partnerships."
        },
        {
          "id": "supply-chain-management-201-l03-c3",
          "title": "Applying Kraljic to Procurement Strategy",
          "content": "For non-critical items, automate and reduce transaction costs with e-procurement. For leverage items, aggregate volumes and negotiate aggressively. For bottleneck items, develop alternative suppliers and maintain safety stock. For strategic items, invest in long-term partnerships, joint development, and risk-sharing agreements. The matrix should be revisited regularly because items can shift quadrants as markets, technologies, and strategies evolve."
        }
      ],
      "flashcards": [
        {
          "id": "supply-chain-management-201-l03-f1",
          "front": "Kraljic matrix dimensions",
          "back": "Profit impact (effect on bottom line) × Supply risk (difficulty of sourcing) — creating four quadrants for procurement strategy"
        },
        {
          "id": "supply-chain-management-201-l03-f2",
          "front": "Four Kraljic quadrants",
          "back": "Non-critical (low/low — simplify), Leverage (high impact/low risk — compete), Bottleneck (low impact/high risk — secure supply), Strategic (high/high — partner deeply)"
        },
        {
          "id": "supply-chain-management-201-l03-f3",
          "front": "Strategy for bottleneck items",
          "back": "Develop alternative suppliers, maintain safety stock, and reduce dependency — these items have high supply risk but lower profit impact"
        }
      ],
      "learningAids": [
        {
          "id": "supply-chain-management-201-l03-a1",
          "type": "practice",
      ...
      "chunks": [
        {
          ...
          "content": "Total cost of ownership (TCO) captures all costs associated with acquiring, using, and disposing of a product or service over its entire lifecycle. It goes far beyond the purchase price to include acquisition costs (sourcing, ordering, shipping, customs), usage costs (installation, training, maintenance, energy consumption, quality losses), and end-of-life costs (disposal, recycling, environmental compliance). TCO reveals the true economic impact of sourcing decisions."
        },
        {
          "id": "supply-chain-management-201-l04-c2",
          "title": "Hidden Costs in Procurement",
          "content": "Purchase price is often only 25–40% of total cost. Hidden costs include: quality failures (rework, scrap, warranty claims), delivery unreliability (expedited freight, production downtime from late deliveries), inventory carrying costs (warehousing, insurance, obsolescence for items ordered in bulk for discounts), and administrative costs (managing multiple invoices, resolving disputes). A supplier with a 5% lower price but 3× the defect rate may actually cost more."
        },
        {
          "id": "supply-chain-management-201-l04-c3",
          "title": "Building a TCO Model",
          "content": "A TCO model identifies all cost elements, assigns monetary values (using actual data or estimates), and projects costs over the relevant time horizon. Steps: (1) Define the scope and time frame. (2) Identify all cost categories. (3) Gather data from accounting, operations, and quality systems. (4) Quantify each cost element. (5) Compare suppliers on total cost. The model makes cost trade-offs transparent — for example, a higher-quality supplier's premium may be offset by lower warranty and rework costs."
        }
      ],
      "flashcards": [
        {
          "id": "supply-chain-management-201-l04-f1",
          "front": "Total cost of ownership (TCO)",
          "back": "All costs of acquiring, using, and disposing of a product over its lifecycle — including acquisition, usage, and end-of-life costs beyond purchase price"
        },
        {
          "id": "supply-chain-management-201-l04-f2",
          "front": "Why lowest price ≠ lowest total cost",
          "back": "Purchase price is often only 25–40% of total cost — hidden costs from quality failures, delivery unreliability, inventory carrying, and administration can make a 'cheap' supplier the most expensive choice"
        },
        {
          "id": "supply-chain-management-201-l04-f3",
          "front": "Steps to build a TCO model",
          "back": "Define scope/timeframe → Identify cost categories → Gather data → Quantify each element → Compare suppliers on total cost"
        }
      ],
      "learningAids": [
        {
          "id": "supply-chain-management-201-l04-a1",
          "type": "image",
          "title": "Concept Card",
          "content": "Visual summary of the lesson's main concept."
        }
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Low profit impact and low supply risk"
            },
            {
              "id": "b",
              "text": "High profit impact and low supply risk"
            },
            {
              "id": "c",
              "text": "Low profit impact and high supply risk"
            },
            {
              "id": "d",
              "text": "High profit impact and high supply risk"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            ...
            {
              "id": "b",
              "text": "Maintenance and repair costs"
            },
            {
              "id": "c",
              "text": "Competitor's profit margins"
            },
            {
              "id": "d",
              "text": "Disposal and recycling costs"
            }
          ],
          "correctOptionId": "c",
        ...
        },
        {
          ...
          "options": [
            ...
            {
              "id": "b",
              "text": "Profile the category and analyze spend"
            },
            {
              "id": "c",
              "text": "Issue a request for proposal"
            },
            {
              "id": "d",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Eliminates the need for supplier audits"
            },
            {
              "id": "b",
              "text": "Always selects the cheapest supplier"
            },
            {
              "id": "c",
              "text": "Makes subjective trade-offs explicit and enables structured comparison"
            },
            {
              "id": "d",
              "text": "Guarantees that the selected supplier will perform well"
            }
          ],
          "correctOptionId": "c",
      ...
      "chunks": [
        {
          ...
          "content": "A well-structured procurement contract specifies: scope and specifications (what is being purchased), pricing and payment terms (unit costs, escalation clauses, discounts), delivery requirements (schedules, Incoterms, penalties for late delivery), quality standards (acceptance criteria, inspection rights, warranty), intellectual property rights, confidentiality clauses, termination conditions, and dispute resolution mechanisms. Contracts must balance protecting the buyer with maintaining a workable relationship."
        },
        {
          "id": "supply-chain-management-201-l06-c2",
          "title": "Arm's-Length vs. Partnership Relationships",
          "content": "Arm's-length relationships are transactional — focused on price, governed by short-term contracts, with minimal information sharing. They suit non-critical and leverage items. Partnership relationships involve long-term commitment, shared goals, joint problem-solving, and deep information exchange. They suit strategic and bottleneck items. The spectrum ranges from spot buying (most transactional) through preferred suppliers to strategic alliances and joint ventures (most collaborative)."
        },
        {
          "id": "supply-chain-management-201-l06-c3",
          "title": "Supplier Relationship Management (SRM)",
          "content": "SRM is the systematic approach to evaluating and managing supplier interactions to maximize value. Key practices include regular performance reviews using scorecards, joint improvement initiatives (such as lean projects at supplier facilities), executive-level relationship governance, early supplier involvement in product design, and innovation days where suppliers present new technologies. Companies with mature SRM programs report 5–15% cost savings and measurably faster innovation cycles."
        }
      ],
      "flashcards": [
        {
          "id": "supply-chain-management-201-l06-f1",
          "front": "Key elements of a procurement contract",
          "back": "Scope, pricing/payment terms, delivery requirements, quality standards, IP rights, confidentiality, termination conditions, and dispute resolution"
        },
        {
          "id": "supply-chain-management-201-l06-f2",
          "front": "Arm's-length vs. partnership supplier relationships",
          "back": "Arm's-length: transactional, price-focused, short-term. Partnership: long-term commitment, shared goals, joint problem-solving — suited for strategic/bottleneck items"
        },
        {
          "id": "supply-chain-management-201-l06-f3",
          "front": "Supplier relationship management (SRM)",
          "back": "Systematic approach to evaluating and managing supplier interactions — includes scorecards, joint improvement, executive governance, and early supplier involvement in design"
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Automate purchasing with e-procurement catalogs"
            },
            {
              "id": "b",
              "text": "Use aggressive competitive bidding among many suppliers"
            },
            {
              "id": "c",
              "text": "Build deep, long-term partnerships with risk-sharing"
            },
            {
              "id": "d",
              "text": "Maintain minimal inventory to reduce costs"
            }
          ],
          "correctOptionId": "c",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Verifying suppliers comply with labor laws"
            },
            {
              "id": "b",
              "text": "Prioritizing the lowest possible price above all other factors"
            },
            {
              "id": "c",
              "text": "Assessing environmental impact of supply operations"
            },
            {
              "id": "d",
              "text": "Ensuring transparency in the sourcing process"
            }
          ],
          "correctOptionId": "b",
