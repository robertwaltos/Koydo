...
export const SupplyChainManagement401Module: LearningModule = {
  ...
  description:
    "Navigate supply chain disruptions and harness digital technologies. Learn to build resilient networks, leverage IoT, blockchain, and AI for real-time visibility, measure supply chain sustainability, and turn your supply chain into a competitive advantage.",
  subject: "Business",
  ...
  lessons: [
    {
      ...
      flashcards: [
        { id: "supply-chain-management-401-l01-f1", front: "Six categories of supply chain risk", back: "Operational, Supply, Demand, Environmental (natural disasters/pandemics), Geopolitical (trade wars/sanctions), and Cyber (data breaches/ransomware)" },
        { id: "supply-chain-management-401-l01-f2", front: "Risk heat map", back: "A matrix plotting risks by likelihood (probability) and impact (severity) — enabling prioritization of mitigation efforts on the highest-risk threats" },
        { id: "supply-chain-management-401-l01-f3", front: "Multi-sourcing as risk mitigation", back: "Using multiple suppliers for critical items avoids single-source dependency — if one supplier fails, others can absorb demand, though it may reduce volume discounts" }
      ]
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Decades of lean optimization created brittle supply chains — just-in-time inventory, single sourcing, and offshore consolidation minimized costs but maximized vulnerability. The efficiency-resilience trade-off requires deliberate choices: lean where risk is low, resilient where risk is high. Toyota's response to the 2011 Fukushima disaster showed that even lean pioneers need resilience — the company subsequently increased safety stock of critical components and diversified its supplier base."
        },
        {
          id: "supply-chain-management-401-l02-c3",
          title: "Three Pillars of Resilience",
          content:
            "Resilience rests on three pillars: (1) Redundancy — backup suppliers, safety stock, reserve capacity, and alternative transportation routes. Costly but provides immediate buffer. (2) Flexibility — the ability to rapidly switch suppliers, production sites, or logistics modes. Requires modular product designs and multi-skilled workforces. (3) Visibility — real-time knowledge of inventory, shipments, and supplier status across all tiers. Enables early warning and faster response. The most resilient supply chains invest in all three."
        }
      ],
      flashcards: [
        { id: "supply-chain-management-401-l02-f1", front: "Supply chain resilience", back: "The ability to anticipate, prepare for, respond to, and recover from disruptions — combining resistance (withstand impact) and recovery (speed of restoration)" },
        { id: "supply-chain-management-401-l02-f2", front: "Efficiency vs. resilience trade-off", back: "Lean optimization minimizes cost but maximizes vulnerability — resilience requires deliberate investment in buffers and flexibility that appear wasteful during normal operations" },
        { id: "supply-chain-management-401-l02-f3", front: "Three pillars of supply chain resilience", back: "Redundancy (backup capacity/stock), Flexibility (ability to switch rapidly), Visibility (real-time knowledge across all tiers)" }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content:
            "IoT connects physical assets — containers, pallets, vehicles, warehouse equipment — to the digital world through sensors, GPS trackers, and RFID tags. These devices generate continuous data on location, temperature, humidity, shock, and tilt. IoT enables real-time shipment tracking, automated inventory counts, predictive maintenance of equipment, and condition monitoring for cold chain compliance. Maersk tracks over 300,000 refrigerated containers globally using IoT sensors, preventing millions in spoilage losses annually."
        },
        {
        ...
        },
        {
          ...
          content:
            "AI transforms supply chains through: demand forecasting (machine learning models process hundreds of demand signals including weather, social media, and economic indicators to improve forecast accuracy by 20–50%), inventory optimization (dynamic safety stock and reorder points), autonomous warehousing (robotic picking and sorting), intelligent transportation routing (real-time route optimization considering traffic, weather, and delivery windows), and supplier risk prediction (analyzing news, financial data, and social sentiment to flag emerging risks)."
        }
      ],
      flashcards: [
        { id: "supply-chain-management-401-l03-f1", front: "IoT in supply chains", back: "Sensors, GPS, and RFID on physical assets providing real-time data on location, temperature, and condition — enabling tracking, predictive maintenance, and cold chain compliance" },
        { id: "supply-chain-management-401-l03-f2", front: "Blockchain in supply chains", back: "Immutable shared ledger recording every transaction — enables provenance tracking, food safety traceability (seconds vs. days), counterfeit prevention, and automated smart contracts" },
        { id: "supply-chain-management-401-l03-f3", front: "AI applications in supply chains", back: "Demand forecasting (20–50% accuracy improvement), inventory optimization, autonomous warehousing, intelligent routing, and supplier risk prediction" }
      ]
    },
    {
      ...
      flashcards: [
        { id: "supply-chain-management-401-l04-f1", front: "Demand sensing vs. traditional forecasting", back: "Demand sensing uses ML on real-time signals (POS, social media, weather) for daily/hourly forecasts — reducing forecast error 30–40% vs. monthly historical-data-based models" },
        { id: "supply-chain-management-401-l04-f2", front: "Supply chain control tower", back: "Centralized platform integrating data from all supply chain systems into real-time dashboards with exception alerts and predictive analytics" },
        { id: "supply-chain-management-401-l04-f3", front: "CPFR", back: "Collaborative Planning, Forecasting, and Replenishment — a framework where trading partners share demand data and jointly plan inventory to reduce the bullwhip effect" }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Cost, quality, and speed" },
            { id: "b", text: "Redundancy, flexibility, and visibility" },
            { id: "c", text: "Planning, sourcing, and delivery" },
            { id: "d", text: "Prevention, detection, and correction" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Uses only historical sales data" },
            { id: "b", text: "Is updated annually" },
            { id: "c", text: "Incorporates real-time signals like POS data, weather, and social media" },
            { id: "d", text: "Eliminates the need for any demand planning" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Physical storage for inventory buffers" },
            { id: "b", text: "End-to-end real-time visibility with exception alerts and predictive analytics" },
            { id: "c", text: "Air traffic control for drone deliveries" },
            { id: "d", text: "A communication channel for supplier negotiations" }
          ],
          correctOptionId: "b",
    ...
    },
    {
      ...
      flashcards: [
        { id: "supply-chain-management-401-l06-f1", front: "Scope 3 emissions in supply chains", back: "Indirect value chain emissions — typically 70–90% of a company's total carbon footprint — including supplier operations, transportation, packaging, and end-of-life disposal" },
        { id: "supply-chain-management-401-l06-f2", front: "China-plus-one strategy", back: "Diversifying sourcing beyond a single country by maintaining primary production in China while developing alternative capacity in another country (Vietnam, India, Mexico) to reduce concentration risk" },
        { id: "supply-chain-management-401-l06-f3", front: "Key post-pandemic supply chain lessons", back: "Diversify geographically, hold strategic buffers, invest in multi-tier visibility, build scenario planning, and develop regional alongside global networks" }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "The speed at which normal operations are restored after disruption" },
            { id: "b", text: "The ability to withstand disruption with minimal impact" },
            { id: "c", text: "Resistance to adopting new technologies" },
            { id: "d", text: "Opposition from employees during organizational change" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Increasing batch order sizes" },
            { id: "b", text: "Sharing real-time point-of-sale data with upstream suppliers" },
            { id: "c", text: "Offering deeper volume discounts" },
            { id: "d", text: "Reducing the number of supply chain partners" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Keeping the lowest possible inventory at all times" },
            { id: "b", text: "Outsourcing all logistics to the cheapest provider" },
            { id: "c", text: "Integrating resilience, digital capabilities, sustainability, and cost efficiency into a cohesive strategy" },
            { id: "d", text: "Focusing exclusively on transportation cost reduction" }
          ],
          correctOptionId: "c",
