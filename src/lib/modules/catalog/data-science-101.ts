  ...
  "lessons": [
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "title": "Types of Data",
          "content": "Data comes in two broad categories. Structured data lives in rows and columns — spreadsheets, SQL databases, and CSV files are classic examples. Unstructured data lacks a predefined schema: text documents, images, audio recordings, and social media posts all qualify. Semi-structured data (JSON, XML) sits in between. Roughly 80 percent of the world's data is unstructured, which is why modern data science increasingly relies on natural language processing and computer vision techniques."
        },
        {
      ...
      "chunks": [
        {
          ...
          "content": "Raw data is rarely analysis-ready. Data wrangling is the process of transforming messy data into a clean, consistent format. Missing values are the most common issue — you can drop rows with too many gaps, impute numeric fields with the median, or fill categorical fields with the mode. Duplicate records inflate counts and skew statistics, so deduplication is essential. Standardizing formats (dates, currencies, capitalization) ensures consistency across the dataset."
        },
        {
          "id": "data-science-101-l04-c2",
          "title": "Handling Outliers",
          "content": "Outliers are data points that deviate significantly from the rest. They can result from measurement errors, data entry mistakes, or genuine rare events. Common detection methods include the IQR rule (values below Q1 − 1.5×IQR or above Q3 + 1.5×IQR) and z-scores (absolute value greater than 3). Deciding what to do with outliers depends on context: remove them if they are errors, cap them to reduce influence, or keep them if they represent real phenomena worth studying."
        },
        {
          "id": "data-science-101-l04-c3",
          "title": "Chart Types and Storytelling with Data",
          "content": "Choosing the right chart is critical for clear communication. Bar charts compare categories; line charts show trends over time; scatter plots reveal relationships between two numeric variables; histograms display frequency distributions. Pie charts work only for a small number of categories that sum to 100 percent. Effective data storytelling follows a narrative arc: set context, present the insight, and recommend an action. Annotating key data points and using consistent color scales help the audience grasp findings quickly."
        }
      ],
      "flashcards": [
        {
