  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          title: "Reading for Main Idea Overview",
          content: "In this lesson, we focus on main idea through the lens of reading and writing. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "language-arts-101-l01-c2",
          title: "Core Concept",
          content: "main idea and context clues work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "language-arts-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for context clues, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-101-l01-f1", front: "main idea", back: "A central target skill in this module. Name it before solving." },
        { id: "language-arts-101-l01-f2", front: "context clues", back: "Use this as the method step after defining the goal." },
        { id: "language-arts-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "language-arts-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for main idea", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for context clues", correctTargetId: "execute" },
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Reading Comprehension",
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about main idea" },
              { id: "l2", label: "Inconsistent approach to context clues" },
              { id: "l3", label: "Weak transfer of reading and writing under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Writing Strong Sentences Focus",
          content: "This lesson deepens paragraph structure using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "language-arts-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to paragraph structure. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-101-l04-f1", front: "paragraph structure", back: "State the target and pick a strategy before solving." },
        { id: "language-arts-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "language-arts-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "language-arts-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "paragraph structure Concept" },
              { id: "process", label: "revision Process" },
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Writing Basics",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about paragraph structure" },
              { id: "l2", label: "Inconsistent approach to revision" },
              { id: "l3", label: "Weak transfer of reading and writing under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Story Elements and Theme Setup",
          content: "Use revision to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-101-l07-f1", front: "revision", back: "Use this as your organizing framework before execution." },
        { id: "language-arts-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "language-arts-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "language-arts-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Review: Language Skills",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about context clues" },
              { id: "l2", label: "Inconsistent approach to revision" },
              { id: "l3", label: "Weak transfer of reading and writing under timing" }
            ],
            right: [
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Mastery: Language Arts",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about main idea" },
              { id: "l2", label: "Inconsistent approach to paragraph structure" },
              { id: "l3", label: "Weak transfer of reading and writing under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          ...
          "Apply a step-by-step correction using paragraph structure.",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in context clues", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on revision", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "language-arts-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Language Arts Mastery Applied Retest",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "language-arts-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines main idea, paragraph structure, and revision in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "language-arts-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "language-arts-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "language-arts-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "language-arts-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "language-arts-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting main idea, paragraph structure, and revision." },
        { id: "language-arts-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on main idea setup" },
              { id: "l2", label: "Losses due to rushed revision decisions" },
      ...
      learningAids: [
        { id: "language-arts-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "language-arts-101-l15",
      title: "Language Arts Mastery Mastery Sprint",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Language Arts Mastery Mastery Sprint",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "language-arts-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
