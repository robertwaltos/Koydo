...
export const LanguageArts201Module: LearningModule = {
  ...
  "description": "Master the art of writing and literary analysis. From essay structure and argumentative writing to literary analysis, narrative techniques, poetry, and research skills — become a confident, expressive writer and critical thinker.",
  ...
  "lessons": [
      ...
      "chunks": [
        {
          ...
          "content": "Every great essay starts with an introduction. It grabs the reader's attention with a hook — a question, quote, or surprising fact. Then it narrows the topic with background information and ends with a thesis statement: one sentence that tells the reader your main argument or point."
        },
        {
          "id": "language-arts-201-l01-c2",
          "title": "Body Paragraphs",
          "content": "The body is the heart of your essay — usually 3 paragraphs. Each starts with a topic sentence that supports your thesis. Then add evidence (facts, examples, quotes) and explain how that evidence supports your point. End each paragraph with a transition to the next idea. Think of it as a sandwich: topic sentence (bread), evidence (filling), explanation (bread)."
        },
        {
          "id": "language-arts-201-l01-c3",
          "title": "Conclusion",
          "content": "The conclusion wraps up your essay. Restate your thesis in a new way — don't just copy it. Summarize your main points briefly. Then end with a 'so what?' — a final thought that shows why your topic matters or leaves the reader thinking. Never introduce new evidence in the conclusion."
        }
      ],
      "flashcards": [
        {
          "id": "language-arts-201-l01-f1",
          "front": "One sentence stating your essay's main argument",
          "back": "Thesis statement"
        },
        {
          "id": "language-arts-201-l01-f2",
          "front": "Opening sentence that grabs the reader's attention",
          "back": "Hook"
        },
        {
          "id": "language-arts-201-l01-f3",
          "front": "First sentence of a body paragraph that introduces its main idea",
          "back": "Topic sentence"
        },
        {
          "id": "language-arts-201-l01-f4",
          "front": "Word or phrase that connects ideas between paragraphs",
          "back": "Transition"
        }
      ],
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "One sentence that states your main argument"
            },
            {
              "id": "b",
              "text": "The title of your essay"
            },
            {
              "id": "c",
              "text": "A summary of someone else's work"
            },
            {
              "id": "d",
              "text": "The last sentence of your essay"
            }
          ],
          "correctOptionId": "a",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "A surprising fact or question"
            },
            {
              "id": "b",
              "text": "The word 'The'"
            ...
            {
              "id": "c",
              "text": "A list of vocabulary words"
            },
            {
              "id": "d",
              "text": "Your name and date"
            }
          ],
          "correctOptionId": "a",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Introduce new evidence"
            },
            {
              "id": "b",
              "text": "Restate your thesis"
            },
            {
              "id": "c",
      ...
      "chunks": [
        {
          ...
          "content": "Argumentative writing persuades the reader. Start with a clear claim — your position on an issue. Then support it with evidence: facts, statistics, expert opinions, and examples. Every argument needs solid proof. Saying 'I think dogs are the best' is an opinion; saying 'Studies show dog owners exercise 30 minutes more daily' is evidence."
        },
        {
          "id": "language-arts-201-l02-c2",
          "title": "Counterarguments",
          "content": "Strong argumentative essays address counterarguments — the opposing side's best points. Acknowledge them, then refute them with stronger evidence. This shows you've considered multiple perspectives and makes your argument more convincing. Use phrases like 'Some may argue... however...'"
        },
        {
          "id": "language-arts-201-l02-c3",
          "title": "Persuasive Techniques",
          "content": "Three powerful techniques from ancient Greece: Ethos (credibility — citing experts), Pathos (emotion — telling a story that moves people), and Logos (logic — using facts and reasoning). The best arguments combine all three. Use strong verbs, avoid 'I think,' and end with a clear call to action."
        }
      ],
      "flashcards": [
        {
          "id": "language-arts-201-l02-f1",
          "front": "Your position or main argument in argumentative writing",
          "back": "Claim"
        },
        {
          "id": "language-arts-201-l02-f2",
          "front": "The opposing side's best points that you address and refute",
          "back": "Counterargument"
        },
        {
          "id": "language-arts-201-l02-f3",
          "front": "Persuasion through credibility and expert sources",
          "back": "Ethos"
        },
        {
          "id": "language-arts-201-l02-f4",
          "front": "Persuasion through emotion and personal stories",
          "back": "Pathos"
        }
      ],
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Supporting evidence like facts and statistics"
            },
            {
              "id": "b",
              "text": "Writing in all capital letters"
            },
            {
              "id": "c",
              "text": "Using bigger words"
            },
            {
              "id": "d",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "More convincing by showing you considered other views"
            },
            {
              "id": "b",
              "text": "Weaker because you agree with the other side"
            },
            {
              "id": "c",
              "text": "Longer without adding value"
            },
            {
              "id": "d",
              "text": "Confusing for the reader"
            }
          ],
          "correctOptionId": "a",
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "The central message or lesson of a story"
            },
            {
              "id": "b",
              "text": "The main character's name"
            },
            {
              "id": "c",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Person vs. self conflict"
            },
            {
              "id": "b",
              "text": "Person vs. nature conflict"
            },
            {
              "id": "c",
              "text": "Person vs. person conflict"
            },
            {
              "id": "d",
              "text": "Symbolism"
      ...
      "chunks": [
        {
          ...
          "content": "A five-paragraph essay has an introduction (hook + thesis), three body paragraphs (topic sentence + evidence + explanation), and a conclusion (restated thesis + so what)."
        },
        {
          "id": "language-arts-201-l04-c2",
          "title": "Argumentative Writing Review",
          "content": "Strong arguments use a clear claim, supporting evidence, and address counterarguments. Ethos, pathos, and logos are the three modes of persuasion from ancient Greece."
        },
        {
          "id": "language-arts-201-l04-c3",
          "title": "Literary Analysis Review",
          "content": "Literary analysis examines theme (central message), character motivation (why characters act), symbolism (objects representing bigger ideas), and conflict types (person vs. person, self, society, nature)."
        }
      ],
      "flashcards": [
        {
          "id": "language-arts-201-l04-f1",
          "front": "Three parts of a five-paragraph essay",
          "back": "Introduction, body paragraphs, conclusion"
        },
        {
          "id": "language-arts-201-l04-f2",
          "front": "Three modes of persuasion",
          "back": "Ethos (credibility), Pathos (emotion), Logos (logic)"
        },
        {
          "id": "language-arts-201-l04-f3",
          "front": "The deeper meaning or central message of a story",
          "back": "Theme"
        },
        {
          "id": "language-arts-201-l04-f4",
          "front": "Essay part where you never introduce new evidence",
          "back": "Conclusion"
        }
      ],
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Person vs. society conflict"
            },
            {
              "id": "b",
              "text": "Person vs. nature conflict"
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Credibility and expert sources"
            },
            {
              "id": "b",
      ...
      "chunks": [
        {
          ...
          "content": "Not all sources are equal. Credible sources include books by experts, academic journals, government websites (.gov), and educational sites (.edu). Be cautious with social media, personal blogs, and Wikipedia (good for background, but verify with primary sources). Check: Who wrote it? When? What's their expertise?"
        },
        {
          "id": "language-arts-201-l05-c2",
          "title": "Taking Notes and Avoiding Plagiarism",
          "content": "Plagiarism means copying someone else's words or ideas without credit — it's like stealing. To avoid it: paraphrase (rewrite in your own words), use quotation marks for exact words, and always cite your source. Good note-taking means writing key ideas in YOUR words, not copying sentences."
        },
        {
          "id": "language-arts-201-l05-c3",
          "title": "Citations and Works Cited",
          "content": "Citations tell readers where your information came from. In-text citations go right in your essay: (Smith, 2023). A Works Cited page at the end lists every source. Basic format: Author Last Name, First Name. Title. Publisher, Year. Proper citations build credibility and let readers verify your facts."
        }
      ],
      "flashcards": [
        {
          "id": "language-arts-201-l05-f1",
          "front": "Copying someone's words or ideas without credit",
          "back": "Plagiarism"
        },
        {
          "id": "language-arts-201-l05-f2",
          "front": "Rewriting information in your own words",
          "back": "Paraphrasing"
        },
        {
          "id": "language-arts-201-l05-f3",
          "front": "Reference placed within your essay text, like (Smith, 2023)",
          "back": "In-text citation"
        },
        {
          "id": "language-arts-201-l05-f4",
          "front": "Reliable source domain endings",
          "back": ".gov and .edu"
        }
      ],
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "A university research study (.edu)"
            },
            {
              "id": "b",
              "text": "A random social media post"
            },
            {
              "id": "c",
              "text": "An anonymous blog"
            },
            {
              "id": "d",
              "text": "A friend's opinion"
            }
          ],
          "correctOptionId": "a",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Paraphrasing and citing sources"
            },
            {
              "id": "b",
              "text": "Copying and pasting quickly"
            },
            {
              "id": "c",
              "text": "Changing a few words"
            },
            {
              "id": "d",
              "text": "Not using any sources"
            }
          ],
          "correctOptionId": "a",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "All sources used in your essay"
            },
            {
              "id": "b",
    ...
    },
    {
      ...
      "flashcards": [
        {
          "id": "language-arts-201-l06-f1",
          "front": "Controlling how fast or slow a story feels through sentence length and detail",
          "back": "Pacing"
        },
        {
          "id": "language-arts-201-l06-f2",
          "front": "A scene that takes the reader back in time to an earlier event",
          "back": "Flashback"
        },
        {
          "id": "language-arts-201-l06-f3",
          "front": "Hints or clues about what will happen later in a story",
          "back": "Foreshadowing"
        },
        {
          "id": "language-arts-201-l06-f4",
          "front": "The perspective from which a story is told (first, third limited, third omniscient)",
          "back": "Point of view"
        }
      ],
      "questions": [
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Lines 1 and 3, lines 2 and 4"
            },
            {
              "id": "b",
              "text": "Lines 1 and 2, lines 3 and 4"
            },
            {
              "id": "c",
              "text": "All four lines"
      ...
      "chunks": [
        {
          ...
          "content": "Essays use thesis statements, topic sentences, and transitions. Arguments need claims, evidence, and counterarguments. Ethos, pathos, and logos are the pillars of persuasion."
        },
        {
          "id": "language-arts-201-l08-c2",
          "title": "Analysis and Research Review",
          "content": "Literary analysis examines theme, character motivation, conflict, and symbolism. Research requires credible sources (.edu, .gov), proper citations, and avoiding plagiarism by paraphrasing and citing."
        },
        {
          "id": "language-arts-201-l08-c3",
          "title": "Narrative and Poetry Review",
          "content": "Narrative techniques include pacing, flashback, foreshadowing, and point of view. Poetry uses rhyme scheme, meter, imagery, and figurative language. A haiku has 5-7-5 syllables; a sonnet has 14 lines with a volta."
        }
      ],
      "flashcards": [
        {
          "id": "language-arts-201-l08-f1",
          "front": "Hints or clues about what will happen later in a story",
          "back": "Foreshadowing"
        },
        {
          "id": "language-arts-201-l08-f2",
          "front": "Extreme exaggeration for effect",
          "back": "Hyperbole"
        },
        {
          "id": "language-arts-201-l08-f3",
          "front": "Copying words/ideas without credit",
          "back": "Plagiarism"
        },
        {
          "id": "language-arts-201-l08-f4",
          "front": "The rhythmic pattern of stressed and unstressed syllables in poetry",
          "back": "Meter"
        }
      ],
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Takes the reader back in time to an earlier event"
            },
            {
              "id": "b",
              "text": "Speeds up the pacing"
            },
            {
              "id": "c",
              "text": "Introduces a new character"
            },
            {
              "id": "d",
              "text": "Ends the story"
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "The shift or turn in thought, usually around line 9"
            },
            {
              "id": "b",
              "text": "The title of the poem"
            },
            {
              "id": "c",
              "text": "The rhyme scheme"
            },
            {
              "id": "d",
              "text": "The final word"
