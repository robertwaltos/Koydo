  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on frames of reference through the lens of spacetime concepts. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "general-relativity-101-l01-c2",
          title: "Core Concept",
          content: "frames of reference and spacetime work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "general-relativity-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for spacetime, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-101-l01-f1", front: "frames of reference", back: "A central target skill in this module. Name it before solving." },
        { id: "general-relativity-101-l01-f2", front: "spacetime", back: "Use this as the method step after defining the goal." },
        { id: "general-relativity-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "general-relativity-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "general-relativity-101-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about frames of reference and spacetime." },
        { id: "general-relativity-101-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing General Relativity vocabulary." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for frames of reference", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for spacetime", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "general-relativity-101-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on spacetime and write one reflection." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains frames of reference using evidence from the lesson." },
            { id: "b", text: "It ignores how frames of reference works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for spacetime." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to spacetime." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to spacetime concepts." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about frames of reference" },
              { id: "l2", label: "Inconsistent approach to spacetime" },
              { id: "l3", label: "Weak transfer of spacetime concepts under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-relativity-101-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens gravity curvature using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "general-relativity-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to gravity curvature. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-101-l04-f1", front: "gravity curvature", back: "State the target and pick a strategy before solving." },
        { id: "general-relativity-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "general-relativity-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "general-relativity-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "general-relativity-101-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for gravity curvature scenarios." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "gravity curvature Concept" },
      ...
      learningAids: [
        { id: "general-relativity-101-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a gravity curvature challenge." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "general-relativity-101-skill-core",
          options: [
            { id: "a", text: "It explains gravity curvature using evidence from the lesson." },
            { id: "b", text: "It ignores how gravity curvature works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside General Relativity." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about gravity curvature" },
      ...
      learningAids: [
        { id: "general-relativity-101-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      flashcards: [
        { id: "general-relativity-101-l07-f1", front: "evidence", back: "Use this as your organizing framework before execution." },
        { id: "general-relativity-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "general-relativity-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "general-relativity-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "general-relativity-101-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on evidence." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-101-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "general-relativity-101-skill-core",
          options: [
            { id: "a", text: "It explains spacetime using evidence from the lesson." },
            { id: "b", text: "It ignores how spacetime works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside General Relativity." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about spacetime" },
              { id: "l2", label: "Inconsistent approach to evidence" },
              { id: "l3", label: "Weak transfer of spacetime concepts under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-relativity-101-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "general-relativity-101-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for gravity curvature." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to gravity curvature." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about frames of reference" },
              { id: "l2", label: "Inconsistent approach to gravity curvature" },
              { id: "l3", label: "Weak transfer of spacetime concepts under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "general-relativity-101-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in spacetime", correctBucketId: "diagnose" },
      ...
      learningAids: [
        { id: "general-relativity-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines frames of reference, gravity curvature, and evidence in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "general-relativity-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "general-relativity-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "general-relativity-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "general-relativity-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting frames of reference, gravity curvature, and evidence." },
        { id: "general-relativity-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on frames of reference setup" },
      ...
      learningAids: [
        { id: "general-relativity-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
