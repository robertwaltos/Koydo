...
export const Nursing101Module: LearningModule = {
  ...
  description:
    "Master the essential principles of professional nursing — from the nursing process and patient assessment to infection control, medication administration, ethical practice, and clinical documentation.",
  subject: "Nursing",
  tags: ["core", "curriculum", "interactive", "healthcare", "nursing"],
  minAge: 16,
  maxAge: 99,
  version: "2.0.0",
  ...
  lessons: [
      ...
      chunks: [
        {
          ...
          content:
            "The nursing process is a systematic, patient-centered framework with five steps: Assessment, Diagnosis, Planning, Implementation, and Evaluation (ADPIE). Assessment is the first and most critical step — the nurse collects subjective data (what the patient reports, such as pain level or symptoms) and objective data (measurable findings like blood pressure, temperature, and lab results). A thorough assessment forms the foundation for all subsequent care decisions. The nursing diagnosis differs from a medical diagnosis: it focuses on the patient's response to illness rather than the disease itself — for example, 'Impaired Gas Exchange' rather than 'pneumonia.'"
        },
        {
          id: "nursing-101-l01-c2",
          title: "Planning and Implementation",
          content:
            "During Planning, the nurse establishes measurable, patient-centered goals and selects evidence-based interventions. Goals should be SMART — Specific, Measurable, Achievable, Relevant, and Time-bound. For example, 'Patient will ambulate 50 feet with a walker by discharge day 3.' Implementation is carrying out the care plan: administering medications, performing wound care, educating the patient, and coordinating with the interdisciplinary team. The nurse must continuously assess the patient during implementation, as conditions can change rapidly. Accurate documentation of every intervention is essential for continuity of care and legal protection."
        },
        {
          id: "nursing-101-l01-c3",
          title: "Evaluation and Reassessment",
          content:
            "Evaluation is the final step where the nurse determines whether the patient has met the established goals. If a goal is met, the care plan may be continued or discontinued. If not met, the nurse reassesses, modifies the nursing diagnosis, adjusts the plan, and re-implements — making the nursing process cyclical rather than linear. For instance, if a patient's pain goal was 'rate pain ≤ 3/10 within one hour of analgesic,' but the patient still reports 6/10, the nurse would reassess the pain source, consult the provider, and adjust the intervention. This iterative loop ensures care is always responsive to the patient's evolving needs."
        }
      ],
      flashcards: [
        { id: "nursing-101-l01-f1", front: "What does ADPIE stand for?", back: "Assessment, Diagnosis, Planning, Implementation, Evaluation — the five steps of the nursing process" },
        { id: "nursing-101-l01-f2", front: "Subjective vs. objective data", back: "Subjective: what the patient tells you (symptoms, feelings). Objective: measurable findings (vital signs, lab values, observations)" },
        { id: "nursing-101-l01-f3", front: "How does a nursing diagnosis differ from a medical diagnosis?", back: "A nursing diagnosis focuses on the patient's response to illness (e.g., 'Risk for Falls'), while a medical diagnosis identifies the disease (e.g., 'osteoporosis')" },
        { id: "nursing-101-l01-f4", front: "What makes the nursing process cyclical?", back: "If goals are not met during Evaluation, the nurse reassesses and revises the care plan, restarting the cycle" }
      ]
    },

    /* ──────────────────────────────────────────────
       L02  Patient Assessment and Vital Signs  (interactive)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l02",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "subjective", label: "Subjective Data" },
              { id: "objective", label: "Objective Data" }
            ],
            items: [
              { id: "i1", label: "Patient states 'I feel dizzy'", correctBucketId: "subjective" },
              { id: "i2", label: "Blood pressure 142/90 mmHg", correctBucketId: "objective" },
              { id: "i3", label: "Patient reports nausea after eating", correctBucketId: "subjective" },
              { id: "i4", label: "SpO₂ reading of 94%", correctBucketId: "objective" },
              { id: "i5", label: "Patient describes pain as 7/10 in the right knee", correctBucketId: "subjective" },
              { id: "i6", label: "Temperature 38.4 °C (101.1 °F)", correctBucketId: "objective" },
              { id: "i7", label: "Patient says 'I haven't slept in two days'", correctBucketId: "subjective" },
              { id: "i8", label: "Heart rate 112 bpm on monitor", correctBucketId: "objective" }
            ]
          }
        }
      ],
      flashcards: [
        { id: "nursing-101-l02-f1", front: "Normal adult resting heart rate", back: "60–100 beats per minute" },
        { id: "nursing-101-l02-f2", front: "Normal adult blood pressure", back: "Less than 120/80 mmHg (systolic/diastolic)" },
        { id: "nursing-101-l02-f3", front: "Cephalocaudal assessment", back: "A systematic examination performed from head to toe to ensure no body system is overlooked" },
        { id: "nursing-101-l02-f4", front: "Normal adult respiratory rate", back: "12–20 breaths per minute; rates above 20 (tachypnea) or below 12 (bradypnea) are abnormal" }
      ]
    },

    /* ──────────────────────────────────────────────
       L03  Nursing Process & Assessment Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l03",
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate understanding of the nursing process and patient assessment techniques"],
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Assessment, Diagnosis, Planning, Implementation, Evaluation" },
            { id: "b", text: "Diagnosis, Assessment, Implementation, Planning, Evaluation" },
            { id: "c", text: "Planning, Assessment, Diagnosis, Evaluation, Implementation" },
            { id: "d", text: "Implementation, Evaluation, Assessment, Diagnosis, Planning" }
          ],
          correctOptionId: "a",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Objective data" },
            { id: "b", text: "Subjective data" },
            { id: "c", text: "A nursing diagnosis" },
            { id: "d", text: "An evaluation finding" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Heart rate 72 bpm" },
            { id: "b", text: "Blood pressure 118/76 mmHg" },
            { id: "c", text: "Respiratory rate 28 breaths/min" },
            { id: "d", text: "Temperature 36.8 °C" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "A nursing diagnosis identifies the disease causing symptoms" },
            { id: "b", text: "A nursing diagnosis focuses on the patient's response to a health condition" },
            { id: "c", text: "A nursing diagnosis can only be made by a physician" },
            { id: "d", text: "A nursing diagnosis requires laboratory confirmation" }
          ],
          correctOptionId: "b",
    ...
    /* ──────────────────────────────────────────────
       L04  Infection Control and Patient Safety  (video)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l04",
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "PPE creates a barrier between the nurse and infectious material. The correct donning order is: hand hygiene → gown → mask or respirator → eye protection → gloves. Doffing (removal) follows the reverse principle to avoid self-contamination: gloves (most contaminated) → eye protection → gown → mask → hand hygiene. Transmission-based precautions add to standard precautions: contact precautions (gown and gloves for MRSA, C. difficile), droplet precautions (surgical mask for influenza, pertussis), and airborne precautions (N95 respirator and negative-pressure room for tuberculosis, measles, varicella). Selecting the correct level of PPE is determined by the mode of transmission of the specific pathogen."
        },
        {
          id: "nursing-101-l04-c3",
          title: "Patient Safety and Fall Prevention",
          content:
            "Patient safety is a core nursing responsibility encompassing fall prevention, pressure injury prevention, and error reduction. Falls are the most common adverse event in hospitals: risk factors include advanced age, medication effects (sedatives, antihypertensives), altered mental status, and mobility impairment. Evidence-based interventions include hourly rounding, keeping the call light within reach, ensuring non-slip footwear, locking bed wheels, and using bed alarms for high-risk patients. The National Patient Safety Goals (NPSGs) from The Joint Commission also require two patient identifiers before any procedure, medication, or blood transfusion — typically the patient's full name and date of birth."
        }
      ],
      flashcards: [
        { id: "nursing-101-l04-f1", front: "Six links in the chain of infection", back: "Infectious agent → Reservoir → Portal of exit → Mode of transmission → Portal of entry → Susceptible host" },
        { id: "nursing-101-l04-f2", front: "Correct PPE donning order", back: "Hand hygiene → Gown → Mask/respirator → Eye protection → Gloves" },
        { id: "nursing-101-l04-f3", front: "When to use airborne precautions", back: "For pathogens that remain suspended in air (tuberculosis, measles, varicella) — requires N95 respirator and negative-pressure room" },
        { id: "nursing-101-l04-f4", front: "Two patient identifiers", back: "Full name and date of birth — required before medications, procedures, and blood transfusions per Joint Commission NPSGs" }
      ]
    },

    /* ──────────────────────────────────────────────
       L05  Medication Administration  (interactive)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l05",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            pairs: [
              { left: "Intravenous (IV)", right: "Fastest onset — seconds to minutes; used in emergencies" },
              { left: "Oral (PO)", right: "Most common route; requires functioning GI tract" },
              { left: "Intramuscular (IM)", right: "Injected into muscle; absorbs over 10–30 minutes" },
              { left: "Subcutaneous (subQ)", right: "Injected into fatty tissue; used for insulin and heparin" },
              { left: "Sublingual", right: "Dissolves under the tongue; bypasses first-pass metabolism" },
              { left: "Transdermal", right: "Absorbed through skin via patch; provides sustained release" }
            ]
          }
        }
      ],
      flashcards: [
        { id: "nursing-101-l05-f1", front: "The six traditional rights of medication administration", back: "Right Patient, Right Medication, Right Dose, Right Route, Right Time, Right Documentation" },
        { id: "nursing-101-l05-f2", front: "First-pass metabolism", back: "Oral drugs are absorbed from the GI tract and pass through the liver before reaching systemic circulation, which can reduce the active drug amount" },
        { id: "nursing-101-l05-f3", front: "Basic dosage formula", back: "Desired dose ÷ Available dose × Quantity = Amount to administer" },
        { id: "nursing-101-l05-f4", front: "When to question a dosage calculation", back: "Any result that seems unusually large or small (e.g., 10 tablets, 50 mL IM) should be rechecked and verified with pharmacy" }
      ]
    },

    /* ──────────────────────────────────────────────
       L06  Safety & Medications Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l06",
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate understanding of infection control, patient safety, and medication administration"],
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Gloves" },
            { id: "b", text: "Gown (after hand hygiene)" },
            { id: "c", text: "N95 respirator" },
            { id: "d", text: "Eye protection" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Wearing gloves at all times" },
            { id: "b", text: "Administering prophylactic antibiotics" },
            { id: "c", text: "Proper hand hygiene" },
            { id: "d", text: "Using UV light sterilization in hallways" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L07  Ethics and Communication in Nursing  (video)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l07",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Patient in 204B has new onset chest pain", correctBucketId: "situation" },
              { id: "i2", label: "History of hypertension and type 2 diabetes", correctBucketId: "background" },
              { id: "i3", label: "BP 168/98, HR 110, diaphoretic, ECG shows ST elevation", correctBucketId: "assessment" },
              { id: "i4", label: "Please come evaluate; I recommend a stat 12-lead ECG and cardiology consult", correctBucketId: "recommendation" },
              { id: "i5", label: "Admitted two days ago for elective cholecystectomy", correctBucketId: "background" },
              { id: "i6", label: "I believe this is a possible cardiac event requiring urgent intervention", correctBucketId: "recommendation" }
            ]
          }
        }
      ],
      flashcards: [
        { id: "nursing-101-l08-f1", front: "SOAP", back: "Subjective, Objective, Assessment, Plan — a structured format for clinical documentation" },
        { id: "nursing-101-l08-f2", front: "SBAR", back: "Situation, Background, Assessment, Recommendation — a standardized handoff communication framework to reduce errors" },
        { id: "nursing-101-l08-f3", front: "Components of a nursing care plan", back: "Nursing diagnosis, expected outcomes (measurable), interventions with rationales, and evaluation of outcome achievement" },
        { id: "nursing-101-l08-f4", front: "Why is SBAR important?", back: "It ensures critical patient information is communicated clearly and completely during care transitions, reducing miscommunication-related errors" }
      ]
    },

    /* ──────────────────────────────────────────────
       L09  Ethics & Documentation Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l09",
      ...
      type: "quiz",
      duration: 8,
      objectives: ["Demonstrate understanding of nursing ethics, therapeutic communication, and clinical documentation"],
      questions: [
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Administer the transfusion anyway because it is medically necessary" },
            { id: "b", text: "Respect the patient's decision, document the refusal, and notify the provider" },
            { id: "c", text: "Ask the family to convince the patient to accept the transfusion" },
            { id: "d", text: "Defer the decision until the next shift" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "'Don't worry, everything will be fine.'" },
            { id: "b", text: "'Tell me more about what you're experiencing.'" },
            { id: "c", text: "'You should try not to think about it.'" },
            { id: "d", text: "'I know exactly how you feel.'" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Actions taken by the nurse during the shift" },
            { id: "b", text: "Allergies and adverse reactions" },
            { id: "c", text: "The nurse's clinical interpretation and nursing diagnosis" },
            { id: "d", text: "Administrations of prescribed medications" }
          ],
          correctOptionId: "c",
    ...
    /* ──────────────────────────────────────────────
       L10  Mastery Quiz: Nursing Foundations  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "nursing-101-l10",
      ...
      type: "quiz",
      duration: 10,
      objectives: ["Demonstrate comprehensive mastery of nursing foundations across all module topics"],
      questions: [
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "Document that the goal was not met and discontinue the care plan" },
            { id: "b", text: "Reassess the patient, modify the plan, and implement revised interventions" },
            { id: "c", text: "Repeat the same interventions and re-evaluate tomorrow" },
            { id: "d", text: "Delegate the reassessment to unlicensed personnel" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Dorsal forearm" },
            { id: "d", text: "Anterior thigh only" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          skillId: "nursing-101-skill-core",
          options: [
            { id: "a", text: "The principle of beneficence" },
            { id: "b", text: "HIPAA regulations on protecting patient health information" },
            { id: "c", text: "The nursing process Evaluation step" },
            { id: "d", text: "Standard precautions for infection control" }
          ],
          correctOptionId: "b",
