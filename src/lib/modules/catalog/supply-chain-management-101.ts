      ...
      "chunks": [
        {
          ...
          "content": "Fill rate measures the percentage of customer demand that is met immediately from available stock — a fill rate of 95% means 5% of orders face stockouts. Order accuracy tracks the percentage of orders delivered without errors (wrong item, wrong quantity, damage). World-class supply chains achieve fill rates above 98% and order accuracy above 99%. These metrics directly affect customer satisfaction and retention."
        },
        {
          "id": "supply-chain-management-101-l06-c2",
          "title": "Lead Time and Cycle Time",
          "content": "Lead time is the total elapsed time from when a customer places an order to when they receive it. It includes processing time, production time, and transportation time. Cycle time is the time to complete one internal process — for example, manufacturing cycle time. Reducing lead time is a major competitive lever: Amazon's supply chain dominance is built on consistently shrinking delivery lead times from days to hours."
        },
        {
          "id": "supply-chain-management-101-l06-c3",
          "title": "Inventory Turns and Cash-to-Cash Cycle",
          "content": "Inventory turns measure how many times inventory is sold and replaced in a period — calculated as cost of goods sold divided by average inventory. Higher turns mean less capital tied up in stock. The cash-to-cash cycle measures how long cash is committed from paying suppliers to receiving payment from customers. Dell revolutionized computing with negative cash-to-cash cycles — collecting from customers before paying suppliers."
        }
      ],
      "flashcards": [
        {
