...
export const BusinessAnalytics401Module: LearningModule = {
  ...
  description:
    "Lead the analytics transformation in your organization. Master prescriptive analytics, A/B testing at scale, deep learning applications, NLP, data governance, and the organizational models needed to build a world-class analytics culture.",
  subject: "Business",
  ...
  lessons: [
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Airlines use optimization for revenue management — dynamically pricing seats to maximize total revenue across flights. Supply chains optimize routing, inventory placement, and supplier selection simultaneously. Marketing teams optimize budget allocation across channels to maximize return on ad spend. Workforce scheduling optimizes staffing levels to minimize labor costs while meeting service targets. The common thread: making the best possible decision given limited resources and known constraints."
        }
      ],
      flashcards: [
        { id: "business-analytics-401-l01-f1", front: "Prescriptive analytics", back: "The most advanced analytics type — recommends optimal actions using optimization, simulation, and decision models, going beyond prediction to actionable recommendations" },
        { id: "business-analytics-401-l01-f2", front: "Linear programming", back: "A mathematical method that maximizes or minimizes an objective function subject to linear constraints — used for production planning, resource allocation, and logistics optimization" },
        { id: "business-analytics-401-l01-f3", front: "Revenue management (optimization application)", back: "Dynamically pricing products or services (airline seats, hotel rooms) to maximize total revenue — uses optimization to balance demand, capacity, and willingness to pay" }
      ]
    },
    {
      ...
      flashcards: [
        { id: "business-analytics-401-l02-f1", front: "Minimum detectable effect (MDE)", back: "The smallest effect size an A/B test is designed to detect — smaller MDEs require larger sample sizes and longer test durations" },
        { id: "business-analytics-401-l02-f2", front: "Peeking problem in A/B testing", back: "Checking results before the test reaches its required sample size inflates false positive rates — sequential testing methods or pre-committed analysis plans prevent this" },
        { id: "business-analytics-401-l02-f3", front: "HiPPO (experimentation culture)", back: "Highest Paid Person's Opinion — the tendency for decisions to be driven by seniority rather than data. Experimentation culture replaces HiPPO with evidence-based decision-making." }
      ]
    },
    {
      ...
      flashcards: [
        { id: "business-analytics-401-l03-f1", front: "Backpropagation", back: "The algorithm neural networks use to learn — calculates how much each weight contributed to prediction error and adjusts weights to reduce that error iteratively" },
        { id: "business-analytics-401-l03-f2", front: "When deep learning outperforms traditional ML", back: "With large amounts of unstructured data (images, text, audio) and complex patterns — it struggles with small datasets, structured tabular data, and explainability requirements" },
        { id: "business-analytics-401-l03-f3", front: "Computer vision in business", back: "Deep learning applied to images and video — powers manufacturing quality inspection, autonomous vehicles, medical imaging, retail shelf monitoring, and security surveillance" }
      ]
    },
    {
      ...
      flashcards: [
        { id: "business-analytics-401-l04-f1", front: "Named entity recognition (NER)", back: "An NLP task that identifies and extracts specific entities (people, companies, locations, dates) from unstructured text — used for information extraction from documents and news" },
        { id: "business-analytics-401-l04-f2", front: "LLM hallucination", back: "When a large language model generates plausible-sounding but factually incorrect information — a critical risk requiring human verification before using outputs for business decisions" },
        { id: "business-analytics-401-l04-f3", front: "Fine-tuning an LLM", back: "Adapting a pre-trained large language model to a specific domain or task using a smaller, specialized dataset — more efficient than training from scratch" }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Stop the test and implement the winning variant immediately" },
            { id: "b", text: "Continue to the planned sample size — early peeking inflates false positive rates" },
            { id: "c", text: "Double the sample size to be safe" },
            { id: "d", text: "Restart the test with different groups" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Image classification with millions of labeled examples" },
            { id: "b", text: "Predicting customer churn from a 500-row spreadsheet" },
            { id: "c", text: "Real-time speech recognition" },
            { id: "d", text: "Generating natural language responses to customer queries" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "The model will be too slow to respond" },
            { id: "b", text: "The model may hallucinate incorrect information and mislead customers" },
            { id: "c", text: "The model will always refuse to answer questions" },
            { id: "d", text: "The model requires too much training data" }
          ],
          correctOptionId: "b",
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Hiring more data scientists to the central team" },
            { id: "b", text: "Moving to a hub-and-spoke model with embedded analysts" },
            { id: "c", text: "Eliminating the analytics team entirely" },
            { id: "d", text: "Purchasing more advanced BI tools" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Increase the training data size" },
            { id: "b", text: "Deploy the model anyway since it reflects historical patterns" },
            { id: "c", text: "Conduct a bias audit and identify which features drive the discriminatory outcome" },
            { id: "d", text: "Switch from a neural network to logistic regression" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Prescriptive analytics and revenue management" },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Restricting data access to the analytics team only" },
            { id: "b", text: "Requiring all decisions to be made by machine learning models" },
            { id: "c", text: "Democratizing experimentation and empowering teams to run their own A/B tests" },
            { id: "d", text: "Replacing all managers with data scientists" }
          ],
          correctOptionId: "c",
