  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          title: "Expressions and Equations Overview",
          content: "In this lesson, we focus on expressions through the lens of advanced problem solving. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "advanced-math-201-l01-c2",
          title: "Core Concept",
          content: "expressions and linear functions work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "advanced-math-201-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for linear functions, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "advanced-math-201-l01-f1", front: "expressions", back: "A central target skill in this module. Name it before solving." },
        { id: "advanced-math-201-l01-f2", front: "linear functions", back: "Use this as the method step after defining the goal." },
        { id: "advanced-math-201-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "advanced-math-201-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for expressions", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for linear functions", correctTargetId: "execute" },
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "advanced-math-201-l03-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Algebra Skills",
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about expressions" },
              { id: "l2", label: "Inconsistent approach to linear functions" },
              { id: "l3", label: "Weak transfer of advanced problem solving under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Systems and Modeling Focus",
          content: "This lesson deepens probability using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "advanced-math-201-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to probability. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "advanced-math-201-l04-f1", front: "probability", back: "State the target and pick a strategy before solving." },
        { id: "advanced-math-201-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "advanced-math-201-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "advanced-math-201-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "probability Concept" },
              { id: "process", label: "proof reasoning Process" },
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "advanced-math-201-l06-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Data Reasoning",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about probability" },
              { id: "l2", label: "Inconsistent approach to proof reasoning" },
              { id: "l3", label: "Weak transfer of advanced problem solving under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          title: "Geometric Reasoning Setup",
          content: "Use proof reasoning to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "advanced-math-201-l07-f1", front: "proof reasoning", back: "Use this as your organizing framework before execution." },
        { id: "advanced-math-201-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "advanced-math-201-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "advanced-math-201-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "advanced-math-201-l09-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Review: Advanced Strategies",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about linear functions" },
              { id: "l2", label: "Inconsistent approach to proof reasoning" },
              { id: "l3", label: "Weak transfer of advanced problem solving under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "advanced-math-201-l10-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Mastery: Advanced Math",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about expressions" },
              { id: "l2", label: "Inconsistent approach to probability" },
              { id: "l3", label: "Weak transfer of advanced problem solving under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          ...
          "Apply a step-by-step correction using probability.",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in linear functions", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on proof reasoning", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "advanced-math-201-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      id: "advanced-math-201-l12",
      title: "Advanced Math Mastery Applied Retest",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "advanced-math-201-l12-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Advanced Math Mastery Applied Retest",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "advanced-math-201-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines expressions, probability, and proof reasoning in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "advanced-math-201-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "advanced-math-201-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "advanced-math-201-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "advanced-math-201-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "advanced-math-201-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting expressions, probability, and proof reasoning." },
        { id: "advanced-math-201-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on expressions setup" },
              { id: "l2", label: "Losses due to rushed proof reasoning decisions" },
      ...
      learningAids: [
        { id: "advanced-math-201-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "advanced-math-201-l15",
      title: "Advanced Math Mastery Mastery Sprint",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          ...
          type: "matching_pairs",
          title: "Reasoning Match: Advanced Math Mastery Mastery Sprint",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "advanced-math-201-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
