...
export const PreKChemistry101Module: LearningModule = {
  ...
  lessons: [
    ...
    },
    {
      ...
      title: "Guided Play: Matter and Mixtures Playlab",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l02-ia1",
          type: "drag_and_drop",
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about materials", correctTargetId: "plan" },
    ...
    },
    {
      ...
      title: "Checkpoint: Core Idea (Matter and Mixtures Playlab)",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l03-ia1",
          type: "matching_pairs",
          ...
          data: {
            left: [
              { id: "l1", label: "I forgot materials" },
              { id: "l2", label: "I am unsure about mixing and separating" },
              { id: "l3", label: "I need to remember mixing, materials, and simple changes" }
            ],
            right: [
    ...
    },
    {
      ...
      title: "Story and Example Time: Matter and Mixtures Playlab",
      type: "video",
      duration: 8,
      learningAids: [
    ...
    },
    {
      ...
      title: "Hands-On Practice: Matter and Mixtures Playlab",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l05-ia1",
          type: "drag_and_drop",
          title: "Learning Steps Game",
          description: "Drag each idea to the right step.",
          estimatedMinutes: 6,
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about mixing and separating", correctTargetId: "plan" },
              { id: "d2", label: "Try the activity with a helper", correctTargetId: "play" },
              { id: "d3", label: "Tell someone one thing you learned", correctTargetId: "share" }
            ]
          }
    ...
    },
    {
      ...
      title: "Checkpoint: Practice Skills (Matter and Mixtures Playlab)",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l06-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      title: "Build and Create: Matter and Mixtures Playlab",
      type: "video",
      duration: 8,
      learningAids: [
    ...
    },
    {
      ...
      title: "Reflection Circle: Matter and Mixtures Playlab",
      type: "interactive",
      duration: 10,
      metadata: {
        prompts: [
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l08-ia1",
          type: "drag_and_drop",
          title: "Learning Steps Game",
          description: "Drag each idea to the right step.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      title: "Review Game: Matter and Mixtures Playlab",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l09-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
    ...
    },
    {
      ...
      title: "Celebration Quiz: Matter and Mixtures Playlab",
      type: "quiz",
      duration: 10,
      questions: [
        {
      ...
      interactiveActivities: [
        {
          id: "pre-k-chemistry-101-l10-ia1",
          type: "matching_pairs",
          title: "Match and Learn",
          description: "Match each learning clue to the best action.",
          estimatedMinutes: 6,
