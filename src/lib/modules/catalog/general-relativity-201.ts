  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on geodesics through the lens of spacetime applications and evidence. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "general-relativity-201-l01-c2",
          title: "Core Concept",
          content: "geodesics and spacetime curvature work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "general-relativity-201-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for spacetime curvature, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-201-l01-f1", front: "geodesics", back: "A central target skill in this module. Name it before solving." },
        { id: "general-relativity-201-l01-f2", front: "spacetime curvature", back: "Use this as the method step after defining the goal." },
        { id: "general-relativity-201-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "general-relativity-201-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "general-relativity-201-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about geodesics and spacetime curvature." },
        { id: "general-relativity-201-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing General Relativity vocabulary." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for geodesics", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for spacetime curvature", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "general-relativity-201-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on spacetime curvature and write one reflection." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains geodesics using evidence from the lesson." },
            { id: "b", text: "It ignores how geodesics works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for spacetime curvature." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to spacetime curvature." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to spacetime applications and evidence." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about geodesics" },
              { id: "l2", label: "Inconsistent approach to spacetime curvature" },
              { id: "l3", label: "Weak transfer of spacetime applications and evidence under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-relativity-201-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens relativistic effects using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "general-relativity-201-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to relativistic effects. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-201-l04-f1", front: "relativistic effects", back: "State the target and pick a strategy before solving." },
        { id: "general-relativity-201-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "general-relativity-201-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "general-relativity-201-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "general-relativity-201-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for relativistic effects scenarios." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "relativistic effects Concept" },
              { id: "process", label: "observational tests Process" },
      ...
      learningAids: [
        { id: "general-relativity-201-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a relativistic effects challenge." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "general-relativity-201-skill-core",
          options: [
            { id: "a", text: "It explains relativistic effects using evidence from the lesson." },
            { id: "b", text: "It ignores how relativistic effects works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside General Relativity." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
        },
        {
          ...
          skillId: "general-relativity-201-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for observational tests." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to observational tests." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about relativistic effects" },
              { id: "l2", label: "Inconsistent approach to observational tests" },
              { id: "l3", label: "Weak transfer of spacetime applications and evidence under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "general-relativity-201-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "Use observational tests to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-201-l07-f1", front: "observational tests", back: "Use this as your organizing framework before execution." },
        { id: "general-relativity-201-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "general-relativity-201-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "general-relativity-201-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "general-relativity-201-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on observational tests." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-201-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "general-relativity-201-skill-core",
          options: [
            { id: "a", text: "It explains spacetime curvature using evidence from the lesson." },
            { id: "b", text: "It ignores how spacetime curvature works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside General Relativity." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about spacetime curvature" },
              { id: "l2", label: "Inconsistent approach to observational tests" },
              { id: "l3", label: "Weak transfer of spacetime applications and evidence under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "general-relativity-201-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "general-relativity-201-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for relativistic effects." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to relativistic effects." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about geodesics" },
              { id: "l2", label: "Inconsistent approach to relativistic effects" },
              { id: "l3", label: "Weak transfer of spacetime applications and evidence under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "general-relativity-201-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in spacetime curvature", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on observational tests", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "general-relativity-201-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-201-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines geodesics, relativistic effects, and observational tests in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "general-relativity-201-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "general-relativity-201-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "general-relativity-201-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "general-relativity-201-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "general-relativity-201-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting geodesics, relativistic effects, and observational tests." },
        { id: "general-relativity-201-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on geodesics setup" },
              { id: "l2", label: "Losses due to rushed observational tests decisions" },
      ...
      learningAids: [
        { id: "general-relativity-201-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "general-relativity-201-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
