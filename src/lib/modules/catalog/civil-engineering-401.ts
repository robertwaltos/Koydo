...
export const CivilEngineering401Module: LearningModule = {
  ...
  lessons: [
    {
      ...
      duration: 9,
      learningAids: [
        { id: "civil-engineering-401-l01-a1", type: "image", title: "Concept Card", content: "Visual summary for Civil Engineering." },
        { id: "civil-engineering-401-l01-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Civil Engineering." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l02-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "civil-engineering-401-skill-core",
          options: [
        ...
        },
        {
          ...
          skillId: "civil-engineering-401-skill-review",
          options: [
      ...
      learningAids: [
        { id: "civil-engineering-401-l03-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l04-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "civil-engineering-401-l05-a1", type: "image", title: "Concept Card", content: "Visual summary for Civil Engineering." },
        { id: "civil-engineering-401-l05-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Civil Engineering." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l06-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "civil-engineering-401-l07-a1", type: "image", title: "Concept Card", content: "Visual summary for Civil Engineering." },
        { id: "civil-engineering-401-l07-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Civil Engineering." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l08-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l09-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "civil-engineering-401-l10-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    }
  ],
};
