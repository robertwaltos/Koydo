...
export const BusinessEthics201Module: LearningModule = {
  ...
  "description": "Understand the governance structures and legal frameworks that shape ethical business conduct. Explore board responsibilities, key regulations like Sarbanes-Oxley, whistleblower protections, insider trading rules, antitrust law, and intellectual property basics.",
  "subject": "Business",
  "tags": [
    "core",
    "curriculum",
      ...
      "chunks": [
        {
          ...
          "content": "Corporate governance is the system of rules, practices, and processes by which a company is directed and controlled. It defines the distribution of rights and responsibilities among shareholders, the board of directors, managers, and other stakeholders. Good governance ensures accountability, fairness, and transparency in a company's relationship with all its stakeholders. It is the mechanism through which the agency problem — the conflict between owners and managers — is managed."
        },
        {
          "id": "business-ethics-201-l01-c2",
          "title": "Key Players in Governance",
          "content": "Shareholders are the owners who elect the board and vote on major decisions. The board of directors oversees management, sets strategic direction, and has fiduciary duties of care and loyalty. The CEO and executive team handle day-to-day operations. Independent directors — those without material ties to the company — provide unbiased oversight. Institutional investors like pension funds and mutual funds increasingly use their voting power to push for governance reforms."
        },
        {
          "id": "business-ethics-201-l01-c3",
          "title": "One-Tier vs. Two-Tier Boards",
          "content": "The Anglo-American one-tier model combines executive and non-executive directors on a single board. This allows close collaboration but can create conflicts when the board must oversee the very executives who sit on it. The Continental European two-tier model separates the management board (running operations) from the supervisory board (overseeing management). Germany's model also includes employee representation on the supervisory board through codetermination, giving workers a formal voice in governance."
        }
      ],
      "flashcards": [
        {
          "id": "business-ethics-201-l01-f1",
          "front": "Corporate governance",
          "back": "The system of rules, practices, and processes directing and controlling a company — managing the agency problem between owners and managers through accountability, fairness, and transparency"
        },
        {
          "id": "business-ethics-201-l01-f2",
          "front": "Agency problem",
          "back": "The conflict of interest between company owners (shareholders) and managers — managers may pursue their own interests rather than maximizing shareholder value"
        },
        {
          "id": "business-ethics-201-l01-f3",
          "front": "Two-tier board model",
          "back": "Separates management board (operations) from supervisory board (oversight); used in Continental Europe; Germany includes employee codetermination on the supervisory board"
        }
      ],
      "learningAids": [
        {
          "id": "business-ethics-201-l01-a1",
          "type": "image",
          "title": "Concept Card",
      ...
      "chunks": [
        {
          ...
          "content": "Directors owe two fundamental fiduciary duties to the corporation and its shareholders. The duty of care requires directors to make informed decisions — they must exercise the care that a reasonably prudent person would use, reviewing materials, asking questions, and seeking expert advice when needed. The duty of loyalty demands that directors put the corporation's interests ahead of personal interests, avoiding self-dealing, competing with the company, or usurping corporate opportunities for personal gain."
        },
        {
          "id": "business-ethics-201-l02-c2",
          "title": "The Business Judgment Rule",
          "content": "The business judgment rule is a legal presumption that directors made decisions on an informed basis, in good faith, and in the honest belief that the action was in the company's best interest. Courts will not second-guess board decisions that meet these criteria, even if the outcome is poor. However, the rule does not protect directors who are grossly negligent in gathering information, who have conflicts of interest, or who commit fraud. This rule encourages reasonable risk-taking without fear of personal liability."
        },
        {
          "id": "business-ethics-201-l02-c3",
          "title": "Board Best Practices",
          "content": "Effective boards maintain a majority of independent directors, separate the CEO and board chair roles, conduct regular executive sessions without management present, and establish robust audit, compensation, and nominating committees. Board diversity — in gender, ethnicity, expertise, and background — improves decision quality by reducing groupthink. Regular board evaluations, director education programs, and clear succession planning further strengthen governance effectiveness."
        }
      ],
      "flashcards": [
        {
          "id": "business-ethics-201-l02-f1",
          "front": "Duty of care",
          "back": "Directors must make informed decisions with the care a reasonably prudent person would exercise — reviewing materials, asking questions, and seeking expert advice"
        },
        {
          "id": "business-ethics-201-l02-f2",
          "front": "Duty of loyalty",
          "back": "Directors must put the corporation's interests ahead of personal interests — no self-dealing, competing with the company, or usurping corporate opportunities"
        },
        {
          "id": "business-ethics-201-l02-f3",
          "front": "Business judgment rule",
          "back": "Legal presumption protecting directors who made decisions that were informed, in good faith, and in the corporation's best interest — even if outcomes are poor"
        }
      ],
      "learningAids": [
        {
          "id": "business-ethics-201-l02-a1",
          "type": "image",
          "title": "Concept Card",
          "content": "Visual summary of the lesson's main concept."
        }
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Only officers and directors of the issuing company"
            },
            {
              "id": "b",
              "text": "Anyone who trades based on publicly available information"
            },
            {
              "id": "c",
              "text": "Outsiders who misappropriate confidential information from its source"
            },
            {
              "id": "d",
              "text": "Only those who physically access company servers"
            }
          ],
          "correctOptionId": "c",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Make a decision that results in financial losses"
            },
            {
              "id": "b",
              "text": "Decide to enter a risky new market that fails"
            },
            {
              "id": "c",
              "text": "Are grossly negligent in gathering information before deciding"
            },
            {
              "id": "d",
              "text": "Choose a strategy that competitors later outperform"
            }
          ],
          "correctOptionId": "c",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Having the CEO also serve as board chair"
            },
            {
              "id": "b",
              "text": "Filling all board seats with company executives"
            },
            {
              "id": "c",
              "text": "Maintaining a majority of independent directors on the board"
            },
            {
              "id": "d",
              "text": "Limiting board meetings to once per year"
            }
          ],
          "correctOptionId": "c",
      ...
      "chunks": [
        {
          ...
          "content": "Antitrust law prevents businesses from engaging in practices that restrain trade or reduce competition. In the United States, the Sherman Act (1890) prohibits monopolization and agreements that restrain trade. The Clayton Act (1914) addresses specific practices like price discrimination, tying arrangements, and mergers that may substantially lessen competition. The Federal Trade Commission Act created the FTC to enforce fair competition. Violations can result in criminal prosecution, treble damages in civil suits, and forced divestitures."
        },
        {
          "id": "business-ethics-201-l06-c2",
          "title": "Common Antitrust Violations",
          "content": "Price fixing — competitors agreeing to set prices — is a per se illegal violation, meaning no justification is accepted. Market allocation, where competitors divide territories or customers, is similarly per se illegal. Bid rigging, where competitors coordinate bids on contracts, carries criminal penalties. Monopolization — using market power to exclude competitors through predatory pricing, exclusive dealing, or tying arrangements — is evaluated under the rule of reason, considering market context and competitive effects."
        },
        {
          "id": "business-ethics-201-l06-c3",
          "title": "Intellectual Property Basics",
          "content": "Intellectual property law grants creators exclusive rights to their innovations. Patents protect inventions and processes for 20 years, requiring novelty, usefulness, and non-obviousness. Trademarks protect brand identifiers — names, logos, slogans — indefinitely, as long as they are used in commerce. Copyrights protect original creative works for the author's life plus 70 years. Trade secrets — like the Coca-Cola formula — are protected indefinitely through confidentiality, not registration. Each form of IP serves a different strategic purpose."
        }
      ],
      "flashcards": [
        {
          "id": "business-ethics-201-l06-f1",
          "front": "Sherman Act (1890)",
          "back": "Foundational U.S. antitrust law prohibiting monopolization and agreements that unreasonably restrain trade — violations can lead to criminal prosecution and treble damages"
        },
        {
          "id": "business-ethics-201-l06-f2",
          "front": "Per se illegal vs. rule of reason",
          "back": "Per se: automatically illegal with no justification accepted (price fixing, market allocation). Rule of reason: evaluated considering market context and competitive effects (monopolization)"
        },
        {
          "id": "business-ethics-201-l06-f3",
          "front": "Four types of intellectual property",
          "back": "Patents (inventions, 20 years), Trademarks (brand identifiers, indefinite), Copyrights (creative works, life + 70 years), Trade secrets (confidential info, indefinite through secrecy)"
        }
      ]
    },
    {
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "A company achieving a dominant market share through superior products"
            },
            {
              "id": "b",
              "text": "Competitors secretly agreeing to fix prices in their industry"
            },
            {
              "id": "c",
              "text": "A firm charging different prices in different geographic markets"
            },
            {
              "id": "d",
              "text": "A company acquiring a small competitor in a related industry"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "A fixed $100,000 reward"
            },
            {
              "id": "b",
              "text": "10-30% of the sanctions collected"
            },
            {
              "id": "c",
              "text": "50% of the sanctions collected"
            },
            {
              "id": "d",
              "text": "Only protection from retaliation, with no financial award"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Allow the CEO to control both strategic and operational decisions"
            },
            {
              "id": "b",
              "text": "Separate management oversight from day-to-day operations"
            },
            {
              "id": "c",
              "text": "Eliminate the need for shareholder voting"
            },
            {
              "id": "d",
              "text": "Reduce the number of directors required by law"
            }
          ],
          "correctOptionId": "b",
