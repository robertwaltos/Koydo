  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on comparative synthesis through the lens of capstone historical interpretation. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "world-history-401-l01-c2",
          title: "Core Concept",
          content: "comparative synthesis and source integration work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "world-history-401-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for source integration, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "world-history-401-l01-f1", front: "comparative synthesis", back: "A central target skill in this module. Name it before solving." },
        { id: "world-history-401-l01-f2", front: "source integration", back: "Use this as the method step after defining the goal." },
        { id: "world-history-401-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "world-history-401-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
        { id: "world-history-401-l01-a1", type: "image", title: "Concept Poster", content: "A colorful infographic about comparative synthesis and source integration." },
        { id: "world-history-401-l01-a2", type: "animation", title: "Warm-up Animation", content: "Short animation introducing History Worldwide vocabulary." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for comparative synthesis", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for source integration", correctTargetId: "execute" },
      ...
      learningAids: [
        { id: "world-history-401-l02-a1", type: "practice", title: "Try It Board", content: "Complete a guided activity on source integration and write one reflection." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains comparative synthesis using evidence from the lesson." },
            { id: "b", text: "It ignores how comparative synthesis works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for source integration." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to source integration." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to capstone historical interpretation." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about comparative synthesis" },
              { id: "l2", label: "Inconsistent approach to source integration" },
              { id: "l3", label: "Weak transfer of capstone historical interpretation under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "world-history-401-l03-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens argument structuring using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "world-history-401-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to argument structuring. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "world-history-401-l04-f1", front: "argument structuring", back: "State the target and pick a strategy before solving." },
        { id: "world-history-401-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "world-history-401-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "world-history-401-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
        { id: "world-history-401-l04-a1", type: "image", title: "Worked Example Sheet", content: "Step-by-step visuals for argument structuring scenarios." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "argument structuring Concept" },
              { id: "process", label: "historical evaluation Process" },
      ...
      learningAids: [
        { id: "world-history-401-l05-a1", type: "animation", title: "Challenge Walkthrough", content: "Animated sequence for solving a argument structuring challenge." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "world-history-401-skill-core",
          options: [
            { id: "a", text: "It explains argument structuring using evidence from the lesson." },
            { id: "b", text: "It ignores how argument structuring works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside History Worldwide." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
        },
        {
          ...
          skillId: "world-history-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for historical evaluation." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to historical evaluation." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about argument structuring" },
              { id: "l2", label: "Inconsistent approach to historical evaluation" },
              { id: "l3", label: "Weak transfer of capstone historical interpretation under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "world-history-401-l06-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "Use historical evaluation to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "world-history-401-l07-f1", front: "historical evaluation", back: "Use this as your organizing framework before execution." },
        { id: "world-history-401-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "world-history-401-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "world-history-401-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
        { id: "world-history-401-l07-a1", type: "practice", title: "Project Planner", content: "Template for planning a mini project focused on historical evaluation." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "world-history-401-l08-a1", type: "mnemonic", title: "Reflection Cycle", content: "Remember Observe, Adjust, Repeat while practicing." }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          skillId: "world-history-401-skill-core",
          options: [
            { id: "a", text: "It explains source integration using evidence from the lesson." },
            { id: "b", text: "It ignores how source integration works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside History Worldwide." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about source integration" },
              { id: "l2", label: "Inconsistent approach to historical evaluation" },
              { id: "l3", label: "Weak transfer of capstone historical interpretation under timing" }
            ],
            right: [
      ...
      learningAids: [
        { id: "world-history-401-l09-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "world-history-401-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for argument structuring." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to argument structuring." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about comparative synthesis" },
              { id: "l2", label: "Inconsistent approach to argument structuring" },
              { id: "l3", label: "Weak transfer of capstone historical interpretation under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      learningAids: [
        { id: "world-history-401-l10-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in source integration", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on historical evaluation", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "world-history-401-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "world-history-401-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines comparative synthesis, argument structuring, and historical evaluation in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "world-history-401-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "world-history-401-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "world-history-401-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "world-history-401-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "world-history-401-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting comparative synthesis, argument structuring, and historical evaluation." },
        { id: "world-history-401-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on comparative synthesis setup" },
              { id: "l2", label: "Losses due to rushed historical evaluation decisions" },
      ...
      learningAids: [
        { id: "world-history-401-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "world-history-401-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
