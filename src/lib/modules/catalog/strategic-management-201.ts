...
export const StrategicManagement201Module: LearningModule = {
  ...
  "description": "Dive deeper into multi-business strategy. Master diversification, vertical integration, mergers & acquisitions, strategic alliances, and the Boston Consulting Group matrix for portfolio management.",
  "subject": "Business",
  "tags": [
    "core",
    "curriculum",
      ...
      "questions": [
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Unrelated diversification"
            },
            {
              "id": "b",
            ...
            {
              "id": "d",
              "text": "Backward vertical integration"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "Forward vertical integration"
            },
            {
              "id": "b",
              "text": "Backward vertical integration"
      ...
      "chunks": [
        {
          ...
          "content": "Organic growth builds from within — investing in R&D, hiring, and marketing to expand existing operations. It's slower but maintains culture and control. Acquisitive growth buys existing businesses for speed and scale. The choice depends on urgency, available targets, integration capability, and risk tolerance. Most successful firms use a blend of both."
        },
        {
          "id": "strategic-management-201-l06-c2",
          "title": "International Entry Modes",
          "content": "Firms expanding internationally choose from a spectrum of entry modes: exporting (low risk, low control), licensing/franchising (moderate risk, shared control), joint ventures (shared investment and risk), wholly-owned subsidiaries (high control, high risk). The choice depends on: desired control level, resource commitment, risk tolerance, and local market knowledge. The Uppsala model suggests firms internationalize incrementally."
        },
        {
          "id": "strategic-management-201-l06-c3",
          "title": "First-Mover vs. Fast-Follower",
          "content": "First movers gain early market share, set industry standards, and build switching costs. But they also bear pioneering costs, face technology uncertainty, and may be leapfrogged by later entrants. Fast followers learn from first-movers' mistakes, benefit from reduced uncertainty, and can imitate at lower cost. Google wasn't the first search engine, nor was Facebook the first social network — both were fast followers who executed better."
        }
      ],
      "flashcards": [
        {
          "id": "strategic-management-201-l06-f1",
          "front": "Organic vs. acquisitive growth",
          "back": "Organic: build from within (slower, maintains culture). Acquisitive: buy existing businesses (faster, integration risk)"
        },
        {
          "id": "strategic-management-201-l06-f2",
          "front": "Uppsala internationalization model",
          "back": "Firms expand internationally in incremental steps — starting with psychically close markets and low-commitment modes, gradually increasing commitment"
        },
        {
          "id": "strategic-management-201-l06-f3",
          "front": "First-mover advantage",
          "back": "Early entry benefits (market share, standards, switching costs) but carries pioneering costs and technology uncertainty"
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            ...
            {
              "id": "c",
              "text": "Financial synergy"
            },
            {
              "id": "d",
              "text": "Strategic synergy"
            }
          ],
          "correctOptionId": "b",
        ...
        },
        {
          ...
          "options": [
            {
              "id": "a",
              "text": "High control, high risk"
            },
            {
              "id": "b",
              "text": "Moderate control, moderate risk"
            },
            {
              "id": "c",
              "text": "Low control, low risk"
            },
            {
              "id": "d",
              "text": "High control, low risk"
            }
          ],
          "correctOptionId": "b",
