...
export const Microelectronics101Module: LearningModule = {
  ...
  description: "Semiconductor fundamentals, PN junctions, basic devices, and introductory analog/digital microelectronics.",
  ...
  lessons: [
    {
      ...
      duration: 9,
      learningAids: [
        { id: "microelectronics-101-l01-a1", type: "image", title: "Concept Card", content: "Visual summary for Microelectronics." },
        { id: "microelectronics-101-l01-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Microelectronics." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l02-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "microelectronics-101-skill-review",
          options: [
      ...
      learningAids: [
        { id: "microelectronics-101-l03-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l04-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "microelectronics-101-l05-a1", type: "image", title: "Concept Card", content: "Visual summary for Microelectronics." },
        { id: "microelectronics-101-l05-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Microelectronics." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l06-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      duration: 9,
      learningAids: [
        { id: "microelectronics-101-l07-a1", type: "image", title: "Concept Card", content: "Visual summary for Microelectronics." },
        { id: "microelectronics-101-l07-a2", type: "animation", title: "Animated Example", content: "Step-by-step walkthrough for Microelectronics." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l08-a1", type: "practice", title: "Guided Practice", content: "Follow the challenge flow and record your approach." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l09-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "microelectronics-101-l10-a1", type: "mnemonic", title: "Memory Cue", content: "Use Plan, Solve, Explain to structure each response." }
      ]
    }
  ],
};
