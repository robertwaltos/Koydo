  ...
  "lessons": [
      ...
      "learningAids": [
        {
          ...
          "type": "image",
          "title": "Concept Card",
          "content": "Visual summary for Network Engineering."
        },
        {
          "id": "network-engineering-201-l01-a2",
          "type": "animation",
          "title": "Animated Example",
          "content": "Step-by-step walkthrough for Network Engineering."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "text": "Which strategy most improves long-term retention for Network Engineering Operations?",
          "skillId": "network-engineering-201-skill-core",
          "options": [
            {
              "id": "a",
    ...
    },
    {
      ...
      "learningAids": [
        ...
        {
          "id": "network-engineering-201-l05-a2",
          "type": "animation",
          "title": "Animated Example",
          "content": "Step-by-step walkthrough for Network Engineering."
        }
    ...
    },
    {
      ...
      "learningAids": [
        ...
        {
          "id": "network-engineering-201-l07-a2",
          "type": "animation",
          "title": "Animated Example",
          "content": "Step-by-step walkthrough for Network Engineering."
        }
    ...
    },
    {
      ...
      "learningAids": [
        {
          "id": "network-engineering-201-l08-a1",
          "type": "practice",
          "title": "Guided Practice",
          "content": "Follow the challenge flow and record your approach."
        }
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "id": "network-engineering-201-l09-q3",
          "text": "Which strategy most improves long-term retention for Network Engineering Operations?",
          "skillId": "network-engineering-201-skill-core",
          "options": [
            {
      ...
      "learningAids": [
        {
          "id": "network-engineering-201-l09-a1",
          "type": "mnemonic",
          "title": "Memory Cue",
          "content": "Use Plan, Solve, Explain to structure each response."
        }
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "id": "network-engineering-201-l10-q3",
          "text": "Which strategy most improves long-term retention for Network Engineering Operations?",
          "skillId": "network-engineering-201-skill-core",
          "options": [
            {
      ...
      "learningAids": [
        {
          "id": "network-engineering-201-l10-a1",
          "type": "mnemonic",
          "title": "Memory Cue",
          "content": "Use Plan, Solve, Explain to structure each response."
        }
