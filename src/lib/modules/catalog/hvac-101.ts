...
/**
 * HVAC 101 — v2.0.0 (full rewrite)
 *
 * Heating, ventilation, and air conditioning fundamentals
 * covering thermodynamics, refrigeration, heating systems,
 * air distribution, controls, and indoor air quality — ages 16+.
 *
...
export const Hvac101Module: LearningModule = {
  ...
  description:
    "Learn the core principles of heating, ventilation, and air conditioning systems — from thermodynamics and the refrigeration cycle to ductwork design, electrical controls, and indoor air quality standards.",
  subject: "Trades",
  tags: ["core", "curriculum", "interactive", "trades", "hvac"],
  minAge: 16,
  maxAge: 99,
  version: "2.0.0",
  ...
  lessons: [
    /* ──────────────────────────────────────────────
       L01  Thermodynamics for HVAC  (video)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l01",
    ...
    /* ──────────────────────────────────────────────
       L02  The Refrigeration Cycle  (interactive)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l02",
      ...
      interactiveActivities: [
        {
          ...
          description:
            "Sort each refrigerant description into the correct refrigeration cycle component.",
          estimatedMinutes: 5,
          difficultyLevel: "medium",
          buckets: ["Compressor", "Condenser", "Expansion Valve", "Evaporator"],
          items: [
            { text: "Low-pressure vapor is squeezed into high-pressure superheated vapor", bucket: "Compressor" },
            { text: "High-pressure vapor rejects heat and condenses into a liquid", bucket: "Condenser" },
            { text: "High-pressure liquid drops to low pressure and temperature", bucket: "Expansion Valve" },
            { text: "Cold refrigerant absorbs indoor heat and boils into vapor", bucket: "Evaporator" },
            { text: "Subcooling occurs to improve efficiency", bucket: "Condenser" },
            { text: "Superheat is measured to verify proper charge", bucket: "Evaporator" },
            { text: "Discharge temperature is highest here", bucket: "Compressor" },
            { text: "A TXV or EEV meters refrigerant flow", bucket: "Expansion Valve" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L03  Heat Transfer & Refrigeration Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l03",
      ...
      questions: [
        {
          ...
          correctOptionId: "c",
          explanation:
            "Conduction transfers heat through direct molecular contact. Convection requires fluid movement and radiation uses electromagnetic waves.",
        },
        {
          id: "hvac-101-l03-q2",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Sensible heat" },
            { id: "b", text: "Latent heat" },
            { id: "c", text: "Radiant heat" },
            { id: "d", text: "Specific heat" },
          ],
          correctOptionId: "b",
          explanation:
            "Latent heat is the energy involved in a phase change. When moisture condenses on the evaporator coil, latent heat is removed from the air without changing its temperature.",
        },
        {
          id: "hvac-101-l03-q3",
          ...
          options: [
            ...
            { id: "b", text: "Condenser" },
            { id: "c", text: "Evaporator" },
            { id: "d", text: "Expansion valve" },
          ],
          correctOptionId: "d",
          explanation:
            "The expansion (metering) valve creates a sudden pressure drop, converting the high-pressure liquid into a cold, low-pressure liquid-vapor mixture before entering the evaporator.",
        },
        {
          id: "hvac-101-l03-q4",
          ...
          correctOptionId: "c",
          explanation:
            "One ton of cooling equals 12,000 BTU/h. Therefore 36,000 ÷ 12,000 = 3 tons.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L04  Heating Systems  (video)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l04",
    ...
    /* ──────────────────────────────────────────────
       L05  Air Distribution and Ductwork  (interactive)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l05",
      ...
      interactiveActivities: [
        {
          ...
          description:
            "Match each air distribution term to its correct definition.",
          estimatedMinutes: 5,
          difficultyLevel: "medium",
          pairs: [
            { left: "Static pressure", right: "Resistance to airflow measured in in. w.c." },
            { left: "CFM", right: "Volume of air moved per minute" },
            { left: "Flex duct", right: "Insulated flexible hose that must be pulled taut" },
            { left: "Balancing damper", right: "Adjustable plate that regulates branch airflow" },
            { left: "Flow hood", right: "Instrument that measures air volume at a register" },
            { left: "Manual D", right: "ACCA standard for residential duct design" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L06  Heating & Airflow Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l06",
      ...
      questions: [
        {
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Standard-efficiency furnace" },
            { id: "b", text: "Mid-efficiency furnace" },
            { id: "c", text: "Condensing furnace" },
            { id: "d", text: "Electric resistance furnace" },
          ],
          correctOptionId: "c",
          explanation:
            "Condensing furnaces have AFUE ratings of 90% or higher because they recover latent heat from flue gases via a secondary heat exchanger. Standard-efficiency units are typically 80% AFUE.",
        },
        {
          id: "hvac-101-l06-q2",
          ...
          correctOptionId: "c",
          explanation:
            "The rule of thumb is 400 CFM per ton. 3 tons × 400 CFM = 1,200 CFM.",
        },
        {
          id: "hvac-101-l06-q3",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Gas furnace" },
            { id: "b", text: "Steam boiler" },
            { id: "c", text: "Electric baseboard" },
            { id: "d", text: "Heat pump" },
          ],
          correctOptionId: "d",
          explanation:
            "A heat pump reverses the refrigeration cycle with a reversing valve, allowing it to provide either heating or cooling by switching the roles of the indoor and outdoor coils.",
        },
        {
          id: "hvac-101-l06-q4",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Oversized ductwork" },
            { id: "b", text: "A clean, low-MERV filter" },
            { id: "c", text: "Undersized ducts and clogged filters" },
            { id: "d", text: "An open bypass damper" },
          ],
          correctOptionId: "c",
          explanation:
            "Undersized ducts restrict airflow and dirty/clogged filters add resistance, both significantly increasing static pressure above the system's design limit.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L07  Controls and Electrical for HVAC  (video)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l07",
    ...
    /* ──────────────────────────────────────────────
       L08  Indoor Air Quality and Ventilation  (interactive)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l08",
      ...
      interactiveActivities: [
        {
          ...
          description:
            "Sort each description into the correct MERV rating range.",
          estimatedMinutes: 5,
          difficultyLevel: "medium",
          buckets: ["MERV 1–4", "MERV 5–8", "MERV 9–12", "MERV 13–16"],
          items: [
            { text: "Catches large debris like dust bunnies and textile fibers", bucket: "MERV 1–4" },
            { text: "Captures mold spores and dust-mite allergens", bucket: "MERV 5–8" },
            { text: "Filters auto-emission particles and fine dust", bucket: "MERV 9–12" },
            { text: "Captures bacteria, smoke, and aerosol droplets", bucket: "MERV 13–16" },
            { text: "Minimal pressure drop; basic equipment protection", bucket: "MERV 1–4" },
            { text: "ASHRAE-recommended level for most commercial HVAC", bucket: "MERV 13–16" },
            { text: "Common residential furnace filter level", bucket: "MERV 5–8" },
            { text: "Traps Legionella and fine pet dander", bucket: "MERV 9–12" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L09  Controls & IAQ Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l09",
      ...
      questions: [
        {
          ...
          correctOptionId: "c",
          explanation:
            "Y (yellow) carries the cooling call from the thermostat, energizing the compressor contactor. R is power, G is the fan, and W is heat.",
        },
        {
          id: "hvac-101-l09-q2",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Leave it — 38 µF is within tolerance" },
            { id: "b", text: "Replace it — it is more than 6% below its rated value" },
            { id: "c", text: "Add a second capacitor in parallel" },
            { id: "d", text: "Increase the supply voltage" },
          ],
          correctOptionId: "b",
          explanation:
            "38 µF is about 15.5% below the 45 µF rating, well beyond the ±6% tolerance. A weak capacitor causes the motor to draw excessive amps and overheat.",
        },
        {
          id: "hvac-101-l09-q3",
          ...
          correctOptionId: "c",
          explanation:
            "ASHRAE guidelines recommend keeping indoor CO₂ below 1,000 ppm. Levels above this indicate insufficient outdoor-air ventilation.",
        },
        {
          id: "hvac-101-l09-q4",
          ...
          options: [
            { id: "a", text: "MERV 5–8" },
            { id: "b", text: "MERV 9–12" },
            { id: "c", text: "MERV 13–16" },
            { id: "d", text: "MERV 17–20" },
          ],
          correctOptionId: "d",
          explanation:
            "MERV 17–20 corresponds to HEPA filtration, capturing at least 99.97% of particles 0.3 µm and larger. These filters are used in hospitals, clean rooms, and critical environments.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L10  Mastery Quiz: HVAC Foundations  (quiz)
    ────────────────────────────────────────────── */
    {
      id: "hvac-101-l10",
      ...
      quizBlueprint: {
        totalQuestions: 4,
        bloomProfile: { understand: 1, apply: 2, analyze: 1 },
      },
      questions: [
        {
          id: "hvac-101-l10-q1",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "3 tons / 1,200 CFM" },
            { id: "b", text: "5 tons / 2,000 CFM" },
            { id: "c", text: "5 tons / 2,500 CFM" },
            { id: "d", text: "6 tons / 2,400 CFM" },
          ],
          correctOptionId: "b",
          explanation:
            "60,000 BTU/h ÷ 12,000 BTU/ton = 5 tons. At 400 CFM per ton, the blower needs approximately 2,000 CFM.",
        },
        {
          id: "hvac-101-l10-q2",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "The compressor has failed" },
            { id: "b", text: "Air-source heat pumps lose heating capacity as outdoor temperature drops" },
            { id: "c", text: "The thermostat is wired incorrectly" },
            { id: "d", text: "The evaporator is oversized" },
          ],
          correctOptionId: "b",
          explanation:
            "Air-source heat pumps extract heat from outdoor air. As the outdoor temperature falls, there is less heat available and the unit's capacity decreases, often requiring auxiliary strip heat below a balance point.",
        },
        {
          id: "hvac-101-l10-q3",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Increase the thermostat set point" },
            { id: "b", text: "Open the branch balancing damper and re-measure" },
            { id: "c", text: "Replace the register grille" },
            { id: "d", text: "Add refrigerant to the system" },
          ],
          correctOptionId: "b",
          explanation:
            "Low airflow at a register usually means the balancing damper on that branch is partially closed. Opening it and re-measuring is the correct air-balancing procedure.",
        },
        {
          id: "hvac-101-l10-q4",
          ...
          skillId: "hvac-101-skill-core",
          options: [
            { id: "a", text: "Lower the thermostat to 68 °F" },
            { id: "b", text: "Increase outdoor-air damper opening" },
            { id: "c", text: "Replace the air filter" },
            { id: "d", text: "Add a dehumidifier" },
          ],
          correctOptionId: "b",
          explanation:
            "1,400 ppm CO₂ exceeds the 1,000 ppm guideline, indicating insufficient ventilation. Increasing the outdoor-air damper opening brings in more fresh air to dilute CO₂. Temperature is already acceptable at 72 °F.",
        },
      ],
    },
  ],
