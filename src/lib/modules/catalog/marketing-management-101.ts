...
export const MarketingManagement101Module: LearningModule = {
  ...
  description:
    "Understand how firms create, communicate, and deliver value to customers. Master the marketing mix, segmentation, targeting, positioning, consumer behavior, and the strategic role of marketing in driving business growth.",
  subject: "Business",
  tags: ["core", "curriculum", "interactive", "mba", "marketing"],
  minAge: 18,
  maxAge: 99,
  moduleVersion: "2.0.0",
  version: "2.0.0",
  ...
  lessons: [
    {
      ...
      flashcards: [
        { id: "marketing-management-101-l01-f1", front: "Marketing", back: "The process of creating, communicating, and delivering value to customers — encompasses product, price, distribution, branding, and relationships" },
        { id: "marketing-management-101-l01-f2", front: "Five eras of marketing", back: "Production → Product → Selling → Marketing (customer-centric) → Societal marketing (long-term welfare)" },
        { id: "marketing-management-101-l01-f3", front: "Customer Lifetime Value (CLV)", back: "The total value a customer generates over their entire relationship with a firm — purchases, referrals, and reduced acquisition costs" }
      ]
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Services — intangible, inseparable from production, variable, and perishable — require three additional Ps. People: employees who deliver the service are part of the product (a rude barista ruins the coffee shop experience). Process: the systems and flow of activities (how Starbucks consistently produces your order). Physical evidence: tangible cues that signal quality (restaurant décor, airline seating, hospital cleanliness). All seven Ps must be aligned for a coherent market offering."
        }
      ],
      flashcards: [
        { id: "marketing-management-101-l02-f1", front: "Marketing Mix (4Ps)", back: "Product (what you sell), Price (what you charge), Place (where you sell), Promotion (how you communicate) — all must be aligned" },
        { id: "marketing-management-101-l02-f2", front: "Product lifecycle stages", back: "Introduction → Growth → Maturity → Decline — each stage needs different marketing strategies (e.g., heavy promotion at intro, differentiation at maturity)" },
        { id: "marketing-management-101-l02-f3", front: "7Ps for services", back: "The 4Ps plus People (service employees), Process (service delivery systems), and Physical Evidence (tangible quality cues)" }
      ]
    },
    {
      ...
      flashcards: [
        { id: "marketing-management-101-l03-f1", front: "STP process", back: "Segmentation (divide market) → Targeting (choose segments) → Positioning (differentiate in customer minds)" },
        { id: "marketing-management-101-l03-f2", front: "Effective segment criteria", back: "Measurable, Substantial, Accessible, Differentiable, and Actionable" },
        { id: "marketing-management-101-l03-f3", front: "Positioning statement template", back: "For [target], [brand] is the [category] that [benefit] because [reason to believe]" }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content:
            "Consumers typically follow five stages: (1) Problem recognition — becoming aware of a need. (2) Information search — seeking alternatives (internal memory first, then external sources). (3) Evaluation of alternatives — comparing options against criteria. (4) Purchase decision — choosing and buying. (5) Post-purchase evaluation — satisfaction or regret. Marketers can influence each stage: triggering need recognition through ads, providing information via content marketing, and reducing post-purchase dissonance through follow-up communications."
        },
        {
        ...
        },
        {
          ...
          content:
            "High-involvement purchases (cars, houses, education) involve extensive research, careful evaluation, and significant risk. Consumers follow the full decision process. Low-involvement purchases (toothpaste, snacks) involve minimal search and habitual buying. Marketing strategies differ: high-involvement products need detailed information and trust-building; low-involvement products need repetitive exposure, shelf placement, and simple messaging. Brand loyalty can shortcut the decision process at any involvement level."
        }
      ],
      flashcards: [
        { id: "marketing-management-101-l04-f1", front: "Five-stage purchase decision process", back: "Problem recognition → Information search → Evaluation → Purchase → Post-purchase evaluation" },
        { id: "marketing-management-101-l04-f2", front: "High vs. low involvement", back: "High: extensive research, careful evaluation (cars, houses). Low: minimal search, habitual buying (toothpaste). Marketing strategies differ for each." },
        { id: "marketing-management-101-l04-f3", front: "Social proof", back: "People look to others' behavior to guide decisions — reviews, recommendations, and influencer endorsements are powerful because of this principle" }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Production concept" },
            { id: "b", text: "Selling concept" },
            { id: "c", text: "Marketing concept" },
            { id: "d", text: "Product concept" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Demographic" },
            { id: "b", text: "Geographic" },
            { id: "c", text: "Psychographic" },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Problem recognition" },
            { id: "b", text: "Information search" },
            { id: "c", text: "Evaluation of alternatives" },
            { id: "d", text: "Post-purchase evaluation" }
          ],
          correctOptionId: "d",
    ...
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Market research follows six steps: (1) Define the problem and objectives. (2) Develop the research plan (what data, from whom, how). (3) Collect information — primary data (surveys, interviews, experiments, observation) or secondary data (existing reports, databases). (4) Analyze the data. (5) Present findings. (6) Make decisions. Common pitfalls include: asking leading questions, sampling bias, confirmation bias in interpretation, and acting on insufficient data."
        },
        {
          id: "marketing-management-101-l06-c3",
          title: "Qualitative vs. Quantitative Research",
          content:
            "Qualitative research explores 'why' through focus groups, depth interviews, and ethnographic observation — rich insights but not statistically generalizable. Quantitative research measures 'how many' through surveys, experiments, and data analysis — statistically robust but may miss nuance. The best approach often combines both: qualitative research first to identify key themes, then quantitative to measure their prevalence. Modern marketing also uses big data and A/B testing for rapid, data-driven insights."
        }
      ],
      flashcards: [
        { id: "marketing-management-101-l06-f1", front: "B2B buying center roles", back: "Initiator, Gatekeeper, Influencer, Decider, Buyer, User — multiple people involved in organizational purchasing" },
        { id: "marketing-management-101-l06-f2", front: "Primary vs. secondary data", back: "Primary: collected firsthand for this study (surveys, interviews). Secondary: pre-existing data (reports, databases, public records)" },
        { id: "marketing-management-101-l06-f3", front: "Qualitative vs. quantitative research", back: "Qualitative: explores 'why' (focus groups, interviews). Quantitative: measures 'how many' (surveys, experiments). Best results combine both." }
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Target segment" },
            { id: "b", text: "Key benefit" },
            { id: "c", text: "Reason to believe" },
            { id: "d", text: "Exact price point" }
          ],
          correctOptionId: "d",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Elastic demand" },
            { id: "b", text: "Derived demand" },
            { id: "c", text: "Inelastic demand" },
            { id: "d", text: "Seasonal demand" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Undifferentiated marketing" },
            { id: "b", text: "Differentiated marketing" },
            { id: "c", text: "Concentrated marketing" },
            { id: "d", text: "Micromarketing" }
          ],
          correctOptionId: "d",
