  ...
  lessons: [
    {
      ...
      chunks: [
        {
          ...
          content: "In this lesson, we focus on schedules through the lens of home planning. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "household-management-101-l01-c2",
          title: "Core Concept",
          content: "schedules and cleaning systems work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "household-management-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for cleaning systems, then verify the result with a quick check."
        },
        {
      ...
      flashcards: [
        { id: "household-management-101-l01-f1", front: "schedules", back: "A central target skill in this module. Name it before solving." },
        { id: "household-management-101-l01-f2", front: "cleaning systems", back: "Use this as the method step after defining the goal." },
        { id: "household-management-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "household-management-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for schedules", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for cleaning systems", correctTargetId: "execute" },
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "It explains schedules using evidence from the lesson." },
            { id: "b", text: "It ignores how schedules works in practice." },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Define the goal and examine evidence for cleaning systems." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to cleaning systems." },
        ...
        },
        {
          ...
          options: [
            ...
            { id: "c", text: "Use assumptions unrelated to home planning." },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about schedules" },
              { id: "l2", label: "Inconsistent approach to cleaning systems" },
              { id: "l3", label: "Weak transfer of home planning under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This lesson deepens meal planning using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "household-management-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to meal planning. Step 3: justify with evidence."
        },
        {
      ...
      flashcards: [
        { id: "household-management-101-l04-f1", front: "meal planning", back: "State the target and pick a strategy before solving." },
        { id: "household-management-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "household-management-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "household-management-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "meal planning Concept" },
              { id: "process", label: "home safety Process" },
      ...
      questions: [
        {
          ...
          skillId: "household-management-101-skill-core",
          options: [
            { id: "a", text: "It explains meal planning using evidence from the lesson." },
            { id: "b", text: "It ignores how meal planning works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Household Management." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
        },
        {
          ...
          skillId: "household-management-101-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for home safety." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to home safety." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about meal planning" },
              { id: "l2", label: "Inconsistent approach to home safety" },
              { id: "l3", label: "Weak transfer of home planning under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      chunks: [
        {
          ...
          content: "Use home safety to organize your approach before starting. Planning first improves quality and speed."
        },
        {
      ...
      flashcards: [
        { id: "household-management-101-l07-f1", front: "home safety", back: "Use this as your organizing framework before execution." },
        { id: "household-management-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "household-management-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "household-management-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
      ...
      questions: [
        {
          ...
          skillId: "household-management-101-skill-core",
          options: [
            { id: "a", text: "It explains cleaning systems using evidence from the lesson." },
            { id: "b", text: "It ignores how cleaning systems works in practice." },
            { id: "c", text: "It focuses on an unrelated topic outside Household Management." },
            { id: "d", text: "It repeats terms without showing meaning." }
          ],
          correctOptionId: "a"
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about cleaning systems" },
              { id: "l2", label: "Inconsistent approach to home safety" },
              { id: "l3", label: "Weak transfer of home planning under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          skillId: "household-management-101-skill-process",
          options: [
            { id: "a", text: "Define the goal and examine evidence for meal planning." },
            { id: "b", text: "Guess quickly without checking evidence." },
            { id: "c", text: "Use data unrelated to meal planning." },
            { id: "d", text: "Skip the context and jump to a conclusion." }
          ],
          correctOptionId: "a"
        },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about schedules" },
              { id: "l2", label: "Inconsistent approach to meal planning" },
              { id: "l3", label: "Weak transfer of home planning under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in cleaning systems", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on home safety", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "household-management-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "household-management-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      ...
      chunks: [
        {
          ...
          content: "This scenario combines schedules, meal planning, and home safety in one applied challenge."
        },
        {
      ...
      flashcards: [
        { id: "household-management-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "household-management-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "household-management-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "household-management-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "household-management-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting schedules, meal planning, and home safety." },
        { id: "household-management-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on schedules setup" },
              { id: "l2", label: "Losses due to rushed home safety decisions" },
      ...
      learningAids: [
        { id: "household-management-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      ...
      learningAids: [
        { id: "household-management-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
