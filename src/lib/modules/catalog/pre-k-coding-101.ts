      ...
      "chunks": [
        {
          ...
          "content": "Robo is a little blue robot who loves to help, but Robo can only do exactly what you tell it — one step at a time! 🤖 If you say 'pick up the cup' before 'walk to the table,' Robo will try to grab thin air and get very confused! Computers work the same way: they follow instructions in order, from first to last."
        },
        {
          "id": "prek-coding-l01-c2",
          "title": "Making a Peanut Butter Sandwich",
          "content": "Let's give Robo instructions to make a sandwich! Step 1: Get two slices of bread 🍞. Step 2: Spread peanut butter on one slice 🥜. Step 3: Put the slices together. If we skip Step 1 and go straight to spreading, Robo will put peanut butter all over the table — what a mess! The order of steps matters."
        },
        {
          "id": "prek-coding-l01-c3",
          "title": "You Are Already a Coder!",
          "content": "Every time you get dressed in the morning, you follow steps: underwear first, then pants, then shoes. You would never put shoes on before pants! 👟 That means you already know how to think like a coder — you put instructions in the right order every single day."
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "A pattern is something that repeats over and over in the same way! 🔴🔵🔴🔵 — red, blue, red, blue. Your striped shirt has a pattern. The days of the week repeat in a pattern. Clapping hands then stomping feet, clap-stomp-clap-stomp — that is a pattern too! 👏🦶"
        },
        {
          "id": "prek-coding-l02-c2",
          "title": "Patterns Help Coders",
          "content": "Coders love patterns because once you know the rule, you can predict what comes next! If the pattern is circle-star-circle-star, what comes after the second star? Circle! ⭐⚪⭐⚪ Computers are super good at repeating patterns — they never get tired or bored."
        },
        {
          "id": "prek-coding-l02-c3",
          "title": "Pattern Detective Game",
          "content": "Let's be pattern detectives! Look at these beads: 🟡🟢🟡🟢🟡... What bead comes next? Green! 🟢 Now a tricky one: 🔺🔺🔵🔺🔺🔵... What comes next? Triangle triangle! 🔺🔺 You are getting so good at this!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "A loop is when you do the same thing over and over! 🔄 Think about brushing your teeth: you move the brush up-down, up-down, up-down — that is a loop! You do not write 'move brush up, move brush down' a hundred times. You just say 'repeat up-down until teeth are clean.'"
        },
        {
          "id": "prek-coding-l04-c2",
          "title": "Robo's Loop Dance",
          "content": "Robo wants to do a silly dance! 🕺 The dance steps are: spin, clap, jump. Instead of saying spin-clap-jump-spin-clap-jump-spin-clap-jump, we can tell Robo: 'repeat spin-clap-jump 3 times.' That is a loop! It saves us from writing the same thing again and again."
        },
        {
          "id": "prek-coding-l04-c3",
          "title": "Loops in Your Day",
          "content": "You use loops all the time! Bouncing a ball: bounce-catch, bounce-catch, bounce-catch 🏀. Singing a song chorus: la-la-la, la-la-la 🎵. Even walking is a loop: left foot, right foot, left foot, right foot. Loops make life (and coding!) much simpler."
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "If-then is how we make choices! 🤔 IF it is raining, THEN take an umbrella. IF you are hungry, THEN eat a snack. IF the light is red, THEN stop. You already use if-then thinking every day — you just did not know it had a coding name!"
        },
        {
          "id": "prek-coding-l06-c2",
          "title": "Robo's If-Then Rules",
          "content": "We can give Robo if-then rules too! IF Robo sees a wall, THEN turn around. IF Robo hears clapping, THEN dance. 🤖💃 Without if-then rules, Robo would just keep walking into the wall forever — bonk, bonk, bonk!"
        },
        {
          "id": "prek-coding-l06-c3",
          "title": "If-Then-Else: Two Choices!",
          "content": "Sometimes there are two paths! IF it is sunny, THEN wear a t-shirt, ELSE wear a jacket. ☀️🧥 The 'else' part is what happens when the 'if' is NOT true. IF you have homework, THEN do homework, ELSE go play! Computers use if-then-else all the time to pick the right thing to do."
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Imagine someone says 'clean your whole room!' That sounds huge and scary! 😱 But what if we break it into tiny pieces? Step 1: Pick up toys. Step 2: Put books on the shelf. Step 3: Make the bed. Step 4: Done! Each little step is easy. That is called decomposition — a fancy word for breaking things into pieces!"
        },
        {
          "id": "prek-coding-l08-c2",
          "title": "How Coders Decompose",
          "content": "Real coders do this too! Building a game sounds impossible — but broken into steps, it becomes: draw a character, make it move left-right, add a score counter, add sound effects. 🎮 Each tiny step is something you CAN do. Put them all together and — wow — you made a game!"
        },
        {
          "id": "prek-coding-l08-c3",
          "title": "Let's Decompose Getting Ready",
          "content": "Let's practice! The big task is: 'get ready for school.' Break it down: 1) Wake up and stretch 🌅, 2) Brush teeth 🪥, 3) Get dressed 👕, 4) Eat breakfast 🥞, 5) Pack your bag 🎒. Five small steps instead of one confusing big one!"
        }
      ],
      "flashcards": [
        {
      ...
      "chunks": [
        {
          ...
          "title": "What Is a Bug?",
          "content": "In coding, a 'bug' is a mistake! 🐛 The name comes from a real moth that got stuck inside an old computer and made it break. Now whenever code does not work right, coders say 'there is a bug!' and they go on a bug hunt to find and fix it."
        },
        {
          "id": "prek-coding-l09-c2",
          "title": "Robo's Buggy Morning",
          "content": "Robo tried to get dressed but something is wrong! Look at Robo's steps: 1) Put on shoes 👟, 2) Put on socks 🧦, 3) Put on pants 👖. That is buggy! You cannot put shoes on before socks! The fix: swap steps 1 and 2 — socks first, then shoes! 🐛→✅"
        },
        {
          "id": "prek-coding-l09-c3",
          "title": "Everyone Makes Bugs!",
          "content": "Here is a secret: even the best coders in the whole world make bugs! 🌍 The important thing is not to be perfect — it is to be a good bug hunter. Check your steps, find what is wrong, and fix it. That is debugging, and it is one of the most important coding skills ever!"
        }
      ],
      "flashcards": [
        {
