...
/**
 * Meteorology 101 — v2.0.0 (full rewrite)
 *
 * Weather science fundamentals covering atmospheric structure,
 * solar radiation, moisture and clouds, wind systems, air masses,
 * fronts, and severe weather — ages 16+.
 *
...
export const Meteorology101Module: LearningModule = {
  ...
  description:
    "Explore the science of weather and atmospheric phenomena — from the structure of the atmosphere and solar energy transfer to cloud formation, pressure systems, air masses, fronts, and severe weather events including thunderstorms, tornadoes, and hurricanes.",
  subject: "Science",
  tags: ["core", "curriculum", "interactive", "science", "meteorology"],
  minAge: 16,
  maxAge: 99,
  version: "2.0.0",
  ...
  lessons: [
    ...
    /* ──────────────────────────────────────────────
       L02  Solar Radiation and Heat Transfer  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      interactiveActivities: [
        {
          ...
          buckets: ["Radiation", "Conduction", "Convection"],
          items: [
            { text: "Sunlight warming Earth's surface from 150 million km away", bucket: "Radiation" },
            { text: "Hot sand burning bare feet at the beach", bucket: "Conduction" },
            { text: "Warm air rising in a cumulus cloud updraft", bucket: "Convection" },
            { text: "Earth emitting infrared energy toward space", bucket: "Radiation" },
            { text: "A metal spoon heating up in a pot of boiling water", bucket: "Conduction" },
            { text: "Sea breeze carrying cool ocean air inland during the afternoon", bucket: "Convection" },
            { text: "A greenhouse glass pane warming objects inside by trapping longwave radiation", bucket: "Radiation" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L03  Atmosphere & Energy Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      questions: [
        {
          ...
          correctOptionId: "b",
          explanation:
            "The stratosphere (roughly 12–50 km altitude) contains the ozone layer, which absorbs UV radiation and causes a temperature inversion — temperature rising with height.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "30% of incoming solar radiation is reflected back to space" },
            { id: "b", text: "30% of outgoing longwave radiation is absorbed by clouds" },
            { id: "c", text: "70% of incoming solar radiation is reflected back to space" },
            { id: "d", text: "70% of the atmosphere is composed of reflective gases" },
          ],
          correctOptionId: "a",
          explanation:
            "An albedo of 0.30 means 30% of the incoming solar radiation is reflected by Earth's atmosphere and surface combined, while 70% is absorbed.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Absolutely stable" },
            { id: "b", text: "Conditionally unstable" },
            { id: "c", text: "Absolutely unstable" },
            { id: "d", text: "Neutral" },
          ],
          correctOptionId: "c",
          explanation:
            "When the environmental lapse rate exceeds the dry adiabatic lapse rate (10 > 9.8 °C/km), the atmosphere is absolutely unstable — a rising parcel remains warmer than its surroundings and continues to accelerate upward.",
        },
        {
          ...
          correctOptionId: "d",
          explanation:
            "Water vapor ranges from nearly 0% to about 4% of the atmosphere. It drives cloud formation, releases latent heat during condensation, and is a powerful greenhouse gas — making it the most important gas for weather.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L04  Moisture and Cloud Formation  (video)
    ────────────────────────────────────────────── */
    {
    ...
    /* ──────────────────────────────────────────────
       L05  Wind and Pressure Systems  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      interactiveActivities: [
        {
          ...
          pairs: [
            { left: "Pressure gradient force", right: "Drives air from high to low pressure perpendicular to isobars" },
            { left: "Coriolis effect", right: "Apparent deflection of moving air due to Earth's rotation" },
            { left: "Geostrophic wind", right: "Upper-level wind flowing parallel to isobars when PGF balances Coriolis" },
            { left: "Trade winds", right: "Surface easterlies blowing from subtropical highs toward the ITCZ" },
            { left: "Polar jet stream", right: "Fast upper-level wind band near 60° latitude that steers mid-latitude storms" },
            { left: "ITCZ", right: "Low-pressure belt near the equator where trade winds converge and air rises" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L06  Moisture & Wind Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      questions: [
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "6.5 °C/km — the environmental lapse rate" },
            { id: "b", text: "9.8 °C/km — the dry adiabatic lapse rate" },
            { id: "c", text: "5 °C/km — the saturated adiabatic lapse rate" },
            { id: "d", text: "3.5 °C/km — the isothermal lapse rate" },
          ],
          correctOptionId: "b",
          explanation:
            "An unsaturated rising air parcel cools at the dry adiabatic lapse rate (DALR) of approximately 9.8 °C per kilometer due to expansion as pressure decreases with altitude.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Cirrostratus" },
            { id: "b", text: "Altostratus" },
            { id: "c", text: "Nimbostratus" },
            { id: "d", text: "Cumulonimbus" },
          ],
          correctOptionId: "d",
          explanation:
            "Cumulonimbus clouds extend vertically from the low levels to above 12 km and produce heavy rain, lightning, hail, strong winds, and occasionally tornadoes.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Clockwise and outward" },
            { id: "b", text: "Counterclockwise and inward" },
            { id: "c", text: "Clockwise and inward" },
            { id: "d", text: "Counterclockwise and outward" },
          ],
          correctOptionId: "b",
          explanation:
            "In the Northern Hemisphere, the Coriolis effect deflects wind to the right, causing surface air flowing toward a low-pressure center to spiral counterclockwise inward (cyclonic flow).",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "The Intertropical Convergence Zone" },
            { id: "b", text: "Subtropical high-pressure belts" },
            { id: "c", text: "Polar easterly winds" },
            { id: "d", text: "The polar jet stream" },
          ],
          correctOptionId: "b",
          explanation:
            "Air that rose at the equatorial ITCZ cools and sinks around 30° latitude, creating persistent subtropical high-pressure belts (such as the Bermuda-Azores and Pacific highs) that produce arid conditions and the trade winds.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L07  Air Masses and Fronts  (video)
    ────────────────────────────────────────────── */
    {
    ...
    /* ──────────────────────────────────────────────
       L08  Severe Weather  (interactive)
    ────────────────────────────────────────────── */
    {
      ...
      interactiveActivities: [
        {
          ...
          buckets: ["Thunderstorm / Tornado", "Hurricane / Tropical Cyclone", "Winter Storm"],
          items: [
            { text: "Mesocyclone rotation within a supercell", bucket: "Thunderstorm / Tornado" },
            { text: "Storm surge — dome of ocean water pushed ashore", bucket: "Hurricane / Tropical Cyclone" },
            { text: "Freezing rain creating an ice glaze on surfaces", bucket: "Winter Storm" },
            { text: "Large hail exceeding 1 inch in diameter", bucket: "Thunderstorm / Tornado" },
            { text: "Eye wall with the strongest winds in the system", bucket: "Hurricane / Tropical Cyclone" },
            { text: "Sleet — ice pellets formed by refreezing aloft", bucket: "Winter Storm" },
            { text: "EF Scale rating based on wind damage indicators", bucket: "Thunderstorm / Tornado" },
            { text: "Warm-core low fueled by sea surface temperatures ≥ 26.5 °C", bucket: "Hurricane / Tropical Cyclone" },
          ],
        },
      ],
    },
    ...
    /* ──────────────────────────────────────────────
       L09  Fronts & Severe Weather Checkpoint  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      questions: [
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "mT (maritime tropical)" },
            { id: "b", text: "cP (continental polar)" },
            { id: "c", text: "mP (maritime polar)" },
            { id: "d", text: "cT (continental tropical)" },
          ],
          correctOptionId: "b",
          explanation:
            "Continental polar (cP) air masses form over cold land surfaces (e.g., central Canada) and are cold and dry. Continental means dry (formed over land) and polar means cold.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Stationary front" },
            { id: "b", text: "Dry line" },
            { id: "c", text: "Occluded front" },
            { id: "d", text: "Sea-breeze front" },
          ],
          correctOptionId: "c",
          explanation:
            "An occluded front forms when a faster cold front catches and merges with a warm front, lifting the warm air entirely off the surface. This is typical of mature mid-latitude cyclones.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Any amount of lightning and rain" },
            { id: "b", text: "Winds ≥ 58 mph, hail ≥ 1 inch, or a tornado" },
            { id: "c", text: "Rainfall exceeding 1 inch per hour" },
            { id: "d", text: "Cloud tops extending above 8 km altitude" },
          ],
          correctOptionId: "b",
          explanation:
            "The NWS defines a severe thunderstorm as one producing wind gusts ≥ 58 mph (50 knots), hail ≥ 1 inch in diameter, or a tornado.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Doppler radar" },
            { id: "b", text: "ASOS surface station" },
            { id: "c", text: "Radiosonde" },
            { id: "d", text: "Wind profiler" },
          ],
          correctOptionId: "c",
          explanation:
            "Radiosondes are lightweight instrument packages attached to weather balloons launched at 00Z and 12Z each day from hundreds of stations worldwide. They measure temperature, humidity, pressure, and wind speed/direction as they ascend through the atmosphere.",
        },
      ],
    },

    /* ──────────────────────────────────────────────
       L10  Mastery Quiz: Meteorology Foundations  (quiz)
    ────────────────────────────────────────────── */
    {
      ...
      quizBlueprint: {
        totalQuestions: 4,
        bloomProfile: { understand: 2, apply: 1, analyze: 1 },
      },
      questions: [
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Light winds and clear skies" },
            { id: "b", text: "A strong pressure gradient and high wind speeds" },
            { id: "c", text: "High humidity and fog formation" },
            { id: "d", text: "Temperature inversion with calm air" },
          ],
          correctOptionId: "b",
          explanation:
            "Tightly packed (closely spaced) isobars indicate a steep pressure gradient, which produces strong winds. The closer the isobars, the greater the pressure gradient force and the faster the wind.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Saturated air is denser and resists expansion" },
            { id: "b", text: "Latent heat released during condensation partially offsets the cooling" },
            { id: "c", text: "Clouds reflect incoming solar radiation back into the parcel" },
            { id: "d", text: "The Coriolis effect reduces vertical motion in saturated parcels" },
          ],
          correctOptionId: "b",
          explanation:
            "When a saturated air parcel rises and water vapor condenses, latent heat is released, warming the parcel and reducing the net cooling rate to about 5–6 °C/km compared to the DALR of 9.8 °C/km.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "The Coriolis effect reverses direction over land" },
            { id: "b", text: "Land removes the warm ocean water energy source and increases surface friction" },
            { id: "c", text: "Upper-level jet streams always dissipate hurricanes over land" },
            { id: "d", text: "Atmospheric pressure increases immediately over all land surfaces" },
          ],
          correctOptionId: "b",
          explanation:
            "Hurricanes are fueled by latent heat from warm ocean-water evaporation. Over land, this moisture supply is cut off, and increased surface friction disrupts the storm's circulation, causing rapid weakening.",
        },
        {
          ...
          skillId: "meteorology-101-skill-core",
          options: [
            { id: "a", text: "Increasing surface pressure and suppressing clouds" },
            { id: "b", text: "Removing mass aloft and lowering surface pressure, intensifying the cyclone" },
            { id: "c", text: "Shifting the polar jet stream northward" },
            { id: "d", text: "Causing the warm front to occlude immediately" },
          ],
          correctOptionId: "b",
          explanation:
            "Upper-level divergence removes air mass from the column above the surface low, reducing surface pressure and intensifying (deepening) the cyclone in a process closely linked to the jet-stream dynamics atop the developing wave.",
        },
      ],
    },
  ],
