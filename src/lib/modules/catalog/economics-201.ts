      ...
      "chunks": [
        {
          ...
          "content": "Trade is based on comparative advantage: countries benefit by specializing in goods where they have the lowest opportunity cost, then trading for other goods. Even if one country is better at producing everything (absolute advantage), both countries gain from specializing and trading. This is why the US imports clothing from Bangladesh and exports software — each focuses on its strength."
        },
        {
