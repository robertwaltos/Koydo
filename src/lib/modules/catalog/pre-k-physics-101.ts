      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about motion", correctTargetId: "plan" },
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "I forgot motion" },
              { id: "l2", label: "I am unsure about force and direction" },
              { id: "l3", label: "I need to remember pushes, pulls, and movement" }
            ],
            right: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Say what we will learn about force and direction", correctTargetId: "plan" },
              { id: "d2", label: "Try the activity with a helper", correctTargetId: "play" },
              { id: "d3", label: "Tell someone one thing you learned", correctTargetId: "share" }
            ]
          }
