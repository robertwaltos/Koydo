      ...
      "chunks": [
        {
          ...
          "content": "Counterpoint is the art of combining two or more independent melodic lines that work together harmonically. Unlike harmony (which thinks in vertical chords), counterpoint thinks horizontally — each voice has its own melodic logic. Species counterpoint, codified by Johann Fux in 1725, teaches this art in five graded steps (species). It's the training method used by Bach, Mozart, Beethoven, and modern film composers."
        },
        {
          "id": "music-theory-401-l05-c2",
          "title": "First Species: Note Against Note",
          "content": "In first species, one note in the counterpoint aligns with one note in the cantus firmus (the given melody). Rules: begin and end on a perfect consonance (unison, 5th, or octave). Between start and end, use mostly imperfect consonances (3rds, 6ths) with occasional perfect consonances. Prefer contrary motion (voices move in opposite directions). Never use parallel 5ths or octaves. No voice crossing."
        },
        {
          "id": "music-theory-401-l05-c3",
          "title": "Beyond First Species",
          "content": "Second species adds two notes against each cantus note — introducing passing tones on weak beats. Third species has four notes per cantus note — more rhythmic variety and decorative motion. Fourth species uses suspensions (syncopated notes held across the beat). Fifth species (florid) combines all previous species freely. Each species adds a layer of complexity while maintaining the fundamental voice-leading principles."
        }
      ],
      "interactiveActivities": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Before writing a note, plan: (1) Key and mode — what emotional color? (2) Form — ABA? Through-composed? (3) Instrumentation — what instruments, what roles? (4) Harmonic plan — sketch the Roman numeral progression with cadences. (5) Melodic plan — arc, climax, range. (6) Texture plan — where unison? Where harmonized? Where counterpoint? A good plan saves time and produces a more coherent piece."
        },
        {
