...
export const OperationsManagement201Module: LearningModule = {
  ...
  description:
    "Master the principles that transformed global manufacturing. Learn Total Quality Management, Six Sigma's DMAIC methodology, lean thinking from the Toyota Production System, and the relentless pursuit of waste elimination through kaizen and statistical process control.",
  subject: "Business",
  ...
  lessons: [
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Deming contributed the Plan-Do-Check-Act (PDCA) cycle and his 14 Points for management transformation, emphasizing that 85 percent of quality problems are system problems, not worker problems. Joseph Juran introduced the Pareto principle to quality — the vital few causes account for most defects — and the quality trilogy of planning, control, and improvement. Philip Crosby championed 'zero defects' and argued that 'quality is free' because the cost of preventing defects is always less than the cost of fixing them."
        },
        {
          id: "operations-management-201-l01-c3",
          title: "Core TQM Principles in Practice",
          content:
            "TQM organizations build quality into every process rather than inspecting it at the end. At Motorola, TQM reduced defects by 99.7 percent over a decade. Key practices include cross-functional quality teams, supplier partnerships focused on quality rather than lowest price, employee empowerment to stop production when defects appear, and data-driven decision-making. The Malcolm Baldrige National Quality Award in the United States evaluates companies on leadership, strategy, customer focus, measurement, workforce, operations, and results."
        }
      ],
      flashcards: [
        { id: "operations-management-201-l01-f1", front: "Total Quality Management (TQM)", back: "Company-wide philosophy making quality everyone's responsibility. Three pillars: customer focus, continuous improvement, total participation" },
        { id: "operations-management-201-l01-f2", front: "Deming's key insight", back: "85% of quality problems are system problems, not worker problems. He created the PDCA cycle and 14 Points for management transformation" },
        { id: "operations-management-201-l01-f3", front: "Crosby's 'Quality is Free'", back: "The cost of preventing defects is always less than the cost of finding and fixing them — so investing in quality actually saves money" }
      ]
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Six Sigma uses a belt hierarchy inspired by martial arts. Yellow Belts understand basics and participate in projects. Green Belts lead smaller projects part-time alongside their regular role. Black Belts are full-time project leaders with deep statistical expertise, typically managing 4–6 projects per year. Master Black Belts train and mentor other belts and develop organizational methodology. Champions are senior leaders who select projects, remove obstacles, and ensure strategic alignment. This structure embeds quality improvement into the organizational DNA."
        }
      ],
      flashcards: [
        { id: "operations-management-201-l02-f1", front: "Six Sigma (statistical meaning)", back: "3.4 defects per million opportunities — a measure of near-perfect process performance where variation is so small that customer specs are almost always met" },
        { id: "operations-management-201-l02-f2", front: "DMAIC", back: "Define → Measure → Analyze → Improve → Control — the five-phase Six Sigma problem-solving methodology" },
        { id: "operations-management-201-l02-f3", front: "Six Sigma Black Belt", back: "Full-time project leader with deep statistical expertise, typically managing 4–6 improvement projects per year" }
      ]
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Just-in-time means producing and delivering the right items at the right time in the right quantities. Kanban cards (visual signals) trigger production only when downstream processes consume inventory. This pull system contrasts with traditional push systems that produce based on forecasts. JIT requires reliable suppliers, quick changeover times, preventive maintenance, and multi-skilled workers. When Toyota assembles a Camry, seats arrive from the supplier within hours of installation — not weeks before, sitting in a warehouse consuming space and capital."
        },
        {
          id: "operations-management-201-l03-c3",
          title: "Jidoka: Automation with a Human Touch",
          content:
            "Jidoka means building the ability to detect abnormalities into machines and processes, then stopping to fix problems rather than passing defects downstream. The concept originated with Sakichi Toyoda's automatic loom, which stopped when a thread broke. In modern practice, any worker on Toyota's assembly line can pull the andon cord to halt production when they spot a defect. This seems costly — stopping a line that produces a car every 60 seconds — but it prevents the far greater cost of reworking or recalling defective products."
        }
      ],
      flashcards: [
        { id: "operations-management-201-l03-f1", front: "Two pillars of the Toyota Production System", back: "Just-in-Time (produce only what's needed, when needed) and Jidoka (automation with a human touch — stop and fix problems immediately)" },
        { id: "operations-management-201-l03-f2", front: "Kanban", back: "Visual signaling system (cards, bins, or electronic signals) that triggers production only when downstream processes consume inventory — the mechanism enabling pull-based production" },
        { id: "operations-management-201-l03-f3", front: "Andon cord", back: "A pull cord or button on Toyota's assembly line that any worker can activate to stop production when a defect or abnormality is detected — embodying the jidoka principle" }
      ]
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Gemba walks — where managers physically visit the workplace to observe — are the primary tool for spotting waste. At Virginia Mason Medical Center in Seattle, nurses walked an average of 10,000 steps per shift. Lean analysis revealed that poor supply room placement caused most of this motion waste. Relocating supplies closer to patient rooms cut walking distance by 60 percent, freeing hours for patient care. The 5S method (Sort, Set in order, Shine, Standardize, Sustain) creates visual workplaces where waste becomes immediately visible."
        }
      ],
      flashcards: [
        { id: "operations-management-201-l04-f1", front: "Seven wastes (TIMWOOD)", back: "Transportation, Inventory, Motion, Waiting, Overproduction, Overprocessing, Defects — Overproduction is considered the worst because it triggers all other wastes" },
        { id: "operations-management-201-l04-f2", front: "Type 1 vs. Type 2 muda", back: "Type 1: non-value-adding but currently necessary (minimize it). Type 2: pure waste that can be eliminated immediately" },
        { id: "operations-management-201-l04-f3", front: "Gemba walk", back: "Managers physically visit the workplace to observe actual processes firsthand — the primary method for identifying waste in lean management" }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Zero defects per million" },
            { id: "b", text: "3.4 defects per million opportunities" },
            { id: "c", text: "34 defects per million opportunities" },
            { id: "d", text: "6 defects per thousand opportunities" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Signals the supervisor to speed up the line" },
            { id: "b", text: "Triggers a kanban replenishment order to suppliers" },
            { id: "c", text: "Stops or slows the production line so a quality problem can be addressed" },
            { id: "d", text: "Starts the shift changeover procedure" }
          ],
          correctOptionId: "c",
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Philip Crosby" },
            { id: "b", text: "Joseph Juran" },
            { id: "c", text: "W. Edwards Deming" },
            { id: "d", text: "Kaoru Ishikawa" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Normal common cause variation" },
            { id: "b", text: "The process is performing exceptionally well" },
            { id: "c", text: "Special cause variation requiring investigation" },
            { id: "d", text: "The control limits need to be widened" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "b", text: "Underutilized talent" },
            { id: "c", text: "Waiting" },
            { id: "d", text: "Excess inventory" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "To detect defects automatically in the production line" },
            { id: "b", text: "To level production volume and mix over time to reduce variation" },
            { id: "c", text: "To signal upstream stations to begin production" },
            { id: "d", text: "To organize the workplace using five steps" }
          ],
          correctOptionId: "b",
