    ...
    },
    {
      ...
      "chunks": [
        ...
        },
        {
          ...
          "content": "Once your core beat works, layer additional percussion: shakers, rim shots, tambourine, congas. Keep them subtle — they add texture without competing with the kick-snare-hat foundation. Every 4 or 8 bars, add a fill — a short rhythmic variation that signals a section change. A simple snare roll or a kick pattern break keeps the listener's attention."
        }
      ],
      "interactiveActivities": [
        {
      ...
      "chunks": [
        {
          ...
          "content": "Recording audio follows a simple chain: Sound source (voice, guitar) → Microphone (converts sound to electrical signal) → Audio Interface (converts analog to digital) → DAW (records the digital signal). The audio interface is the bridge between the analog and digital worlds. It has a preamp (amplifies the mic signal), an A/D converter, and connects to your computer via USB or Thunderbolt."
        },
        {
          "id": "music-production-101-l07-c2",
          "title": "Setting Levels",
          "content": "The most important recording skill: setting the right input level. Too quiet = noisy recordings when you boost later. Too loud = clipping (digital distortion that can't be fixed). Aim for peaks around -12 to -6 dBFS on your DAW's meter. Leave headroom — you can always turn it up later, but you can't un-clip a distorted recording. This is called 'gain staging.'"
        },
        {
          "id": "music-production-101-l07-c3",
          "title": "Microphone Types",
          "content": "Dynamic mics (like the Shure SM58) are tough, affordable, and handle loud sources well — great for live vocals, guitar amps, and snare drums. Condenser mics are more sensitive and detailed — great for studio vocals, acoustic instruments, and overhead drum captures, but they need phantom power (48V from the interface). USB mics combine the mic and interface in one device — convenient for beginners."
        }
      ],
      "flashcards": [
        {
