...
export const Coding101Module: LearningModule = {
  ...
  lessons: [
      ...
      chunks: [
        {
          ...
          title: "Algorithms and Sequence Overview",
          content: "In this lesson, we focus on sequence through the lens of coding logic. The goal is to recognize what strong reasoning looks like before solving."
        },
        {
          id: "coding-101-l01-c2",
          title: "Core Concept",
          content: "sequence and conditionals work together. Start by naming the main target, then identify the evidence or steps that support it."
        },
        {
          id: "coding-101-l01-c3",
          title: "Worked Example",
          content: "Walk through one guided example: define the goal, apply a strategy for conditionals, then verify the result with a quick check."
        },
        {
          id: "coding-101-l01-c4",
          title: "Transfer Prompt",
          content: "Apply the same process to a new scenario and explain why your approach is valid in one clear sentence."
        }
      ],
      flashcards: [
        { id: "coding-101-l01-f1", front: "sequence", back: "A central target skill in this module. Name it before solving." },
        { id: "coding-101-l01-f2", front: "conditionals", back: "Use this as the method step after defining the goal." },
        { id: "coding-101-l01-f3", front: "Verification", back: "Check that your result matches the original goal and constraints." },
        { id: "coding-101-l01-f4", front: "Transfer", back: "Use the same strategy on a new item to confirm true mastery." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            ...
            draggables: [
              { id: "d1", label: "Set a goal for sequence", correctTargetId: "plan" },
              { id: "d2", label: "Try one strategy for conditionals", correctTargetId: "execute" },
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "coding-101-l03-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Logic Basics",
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about sequence" },
              { id: "l2", label: "Inconsistent approach to conditionals" },
              { id: "l3", label: "Weak transfer of coding logic under timing" }
            ],
            right: [
      ...
      chunks: [
        {
          ...
          title: "Loops and Repetition Focus",
          content: "This lesson deepens loops using structured reasoning. We move from concept understanding to applied decisions."
        },
        {
          id: "coding-101-l04-c2",
          title: "Method Steps",
          content: "Step 1: identify what is being asked. Step 2: choose a strategy aligned to loops. Step 3: justify with evidence."
        },
        {
        ...
        {
          id: "coding-101-l04-c4",
          title: "Independent Try",
          content: "Solve one similar item and compare your process to the lesson sequence."
        }
      ],
      flashcards: [
        { id: "coding-101-l04-f1", front: "loops", back: "State the target and pick a strategy before solving." },
        { id: "coding-101-l04-f2", front: "Step Sequence", back: "Goal -> Strategy -> Evidence -> Check." },
        { id: "coding-101-l04-f3", front: "Assumption Check", back: "Remove assumptions that are not supported by the prompt." },
        { id: "coding-101-l04-f4", front: "Process Match", back: "Your explanation should match the steps you actually used." }
      ],
      learningAids: [
      ...
      interactiveActivities: [
        {
          ...
          data: {
            buckets: [
              { id: "concept", label: "loops Concept" },
              { id: "process", label: "debugging Process" },
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "coding-101-l06-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Checkpoint: Program Flow",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about loops" },
              { id: "l2", label: "Inconsistent approach to debugging" },
              { id: "l3", label: "Weak transfer of coding logic under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
      ...
      chunks: [
        {
          ...
          title: "Debugging Strategies Setup",
          content: "Use debugging to organize your approach before starting. Planning first improves quality and speed."
        },
        {
        ...
        {
          id: "coding-101-l07-c4",
          title: "Next-Step Plan",
          content: "Write one action to repeat and one action to improve in your next practice round."
        }
      ],
      flashcards: [
        { id: "coding-101-l07-f1", front: "debugging", back: "Use this as your organizing framework before execution." },
        { id: "coding-101-l07-f2", front: "Decision Rule", back: "Choose the option with strongest evidence-to-goal alignment." },
        { id: "coding-101-l07-f3", front: "Quality Control", back: "Accuracy + completeness + objective match." },
        { id: "coding-101-l07-f4", front: "Iteration", back: "Repeat what works; refine one weak step each cycle." }
      ],
      learningAids: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "coding-101-l09-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Review: Coding Concepts",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about conditionals" },
              { id: "l2", label: "Inconsistent approach to debugging" },
              { id: "l3", label: "Weak transfer of coding logic under timing" }
            ],
            right: [
    ...
    },
    {
      ...
      interactiveActivities: [
        {
          id: "coding-101-l10-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Mastery: Coding",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
          ...
          data: {
            left: [
              { id: "l1", label: "Confusion about sequence" },
              { id: "l2", label: "Inconsistent approach to loops" },
              { id: "l3", label: "Weak transfer of coding logic under timing" }
            ],
            right: [
              { id: "r1", label: "Create a one-step concept summary with one worked example" },
    ...
    },
    {
      ...
      metadata: {
        prompts: [
          ...
          "Apply a step-by-step correction using loops.",
          "Document your transfer plan for the next timed check."
        ]
      },
      interactiveActivities: [
        {
          id: "coding-101-l11-ia1",
          type: "sorting_buckets",
          ...
          data: {
            ...
            items: [
              { id: "i1", label: "Tag repeated mistakes in conditionals", correctBucketId: "diagnose" },
              { id: "i2", label: "Rework one missed item with full reasoning", correctBucketId: "fix" },
              { id: "i3", label: "Retest with a timed mini-check on debugging", correctBucketId: "transfer" }
            ]
          }
        }
      ],
      learningAids: [
        { id: "coding-101-l11-a1", type: "practice", title: "Correction Loop Card", content: "Use Diagnose, Fix, Transfer for each difficult problem." }
      ]
    },
    {
      id: "coding-101-l12",
      title: "Coding Mastery Applied Retest",
      type: "quiz",
      duration: 10,
      questions: [
        {
          id: "coding-101-l12-q1",
          text: "Which statement best explains sequence in Coding?",
          skillId: "coding-101-skill-core",
          options: [
            { id: "a", text: "It explains sequence using evidence from the lesson." },
      ...
      interactiveActivities: [
        {
          id: "coding-101-l12-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Coding Mastery Applied Retest",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "coding-101-l12-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    },
    {
      id: "coding-101-l13",
      ...
      chunks: [
        {
          id: "coding-101-l13-c1",
          title: "Scenario Brief",
          content: "This scenario combines sequence, loops, and debugging in one applied challenge."
        },
        {
          id: "coding-101-l13-c2",
          title: "Plan the Approach",
          content: "Break the scenario into smaller decisions, then assign one strategy to each decision point."
        },
        {
          id: "coding-101-l13-c3",
          title: "Execute and Justify",
          content: "Apply the plan and explain each move with evidence, not guesses."
        },
        {
          id: "coding-101-l13-c4",
          title: "Evaluate Outcome",
          content: "Compare your result to the target and identify what to keep versus what to adjust."
        }
      ],
      flashcards: [
        { id: "coding-101-l13-f1", front: "Scenario Planning", back: "Split a complex task into clear decision points." },
        { id: "coding-101-l13-f2", front: "Evidence Link", back: "Each step should connect to evidence in the scenario." },
        { id: "coding-101-l13-f3", front: "Adjustment Loop", back: "Use outcome checks to refine your next attempt." },
        { id: "coding-101-l13-f4", front: "Applied Mastery", back: "Mastery means transferring the process to a new context." }
      ],
      learningAids: [
        { id: "coding-101-l13-a1", type: "image", title: "Scenario Map", content: "A real-world scenario map connecting sequence, loops, and debugging." },
        { id: "coding-101-l13-a2", type: "practice", title: "Mini Case Prompt", content: "Apply one strategy to a new case and explain your reasoning." }
      ]
    },
    {
      id: "coding-101-l14",
      ...
      interactiveActivities: [
        {
          ...
          data: {
            left: [
              { id: "l1", label: "Repeated miss on sequence setup" },
              { id: "l2", label: "Losses due to rushed debugging decisions" },
      ...
      learningAids: [
        { id: "coding-101-l14-a1", type: "mnemonic", title: "Clinic Loop", content: "Diagnose, Correct, Transfer." }
      ]
    },
    {
      id: "coding-101-l15",
      title: "Coding Mastery Mastery Sprint",
      type: "quiz",
      duration: 10,
      questions: [
        {
          id: "coding-101-l15-q1",
          text: "Which statement best explains conditionals in Coding?",
          skillId: "coding-101-skill-core",
          options: [
            { id: "a", text: "It explains conditionals using evidence from the lesson." },
      ...
      interactiveActivities: [
        {
          id: "coding-101-l15-ia1",
          type: "matching_pairs",
          title: "Reasoning Match: Coding Mastery Mastery Sprint",
          description: "Match each error signal to the strongest correction strategy.",
          estimatedMinutes: 7,
          difficultyLevel: "medium",
          instructions: [
      ...
      learningAids: [
        { id: "coding-101-l15-a1", type: "mnemonic", title: "Memory Tip", content: "Use the phrase Plan, Check, Explain for each question." }
      ]
    }
  ],
};
