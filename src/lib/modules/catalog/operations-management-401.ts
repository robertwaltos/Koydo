...
export const OperationsManagement401Module: LearningModule = {
  ...
  description:
    "Align operations with business strategy and prepare for the future of manufacturing and services. Explore Industry 4.0, digital twins, predictive maintenance, service operations, circular economy principles, and the strategic decisions behind global operations and reshoring.",
  subject: "Business",
  ...
  lessons: [
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Operations compete on four dimensions. Cost: producing at the lowest total unit cost (Amazon's relentless efficiency). Quality: delivering products that meet or exceed specifications consistently (Toyota's zero-defect philosophy). Speed: minimizing the time from order to delivery (Domino's 30-minute guarantee). Flexibility: the ability to change volume, product mix, or design quickly (Zara's two-week design-to-shelf cycle). While world-class companies excel at multiple priorities, there are genuine trade-offs: extreme customization typically raises costs and slows delivery."
        },
        {
          id: "operations-management-401-l01-c3",
          title: "Order Winners and Order Qualifiers",
          content:
            "Terry Hill's framework distinguishes order qualifiers from order winners. Order qualifiers are the minimum standards customers require just to consider your product — a car must meet safety regulations, a restaurant must pass health inspections. Meeting qualifiers does not win the sale; failing them loses it. Order winners are the criteria that actually persuade customers to choose you over competitors — the fastest delivery, the lowest price, or the best customization. Operations strategy must first ensure all qualifiers are met, then invest heavily in the capabilities that drive order winners."
        }
      ],
      flashcards: [
        { id: "operations-management-401-l01-f1", front: "Operations strategy", back: "The pattern of long-term decisions that shapes operational capabilities and aligns them with business strategy — bridging strategic intent and daily execution" },
        { id: "operations-management-401-l01-f2", front: "Four competitive priorities", back: "Cost (lowest unit cost), Quality (meeting/exceeding specs), Speed (fastest order-to-delivery), Flexibility (ability to change volume, mix, or design quickly)" },
        { id: "operations-management-401-l01-f3", front: "Order winners vs. order qualifiers", back: "Qualifiers: minimum standards to be considered (failing disqualifies you). Winners: criteria that actually persuade customers to choose you over competitors" }
      ]
    },
    {
    ...
    },
    {
      ...
      chunks: [
        ...
        },
        {
          ...
          content:
            "Heskett, Sasser, and Schlesinger at Harvard developed the service-profit chain linking internal operations to financial results: internal service quality (tools, training, workplace design) drives employee satisfaction, which drives employee retention and productivity, which drives external service value, which drives customer satisfaction and loyalty, which drives revenue and profitability. Southwest Airlines exemplifies this: investing in employee satisfaction produces enthusiastic service, which builds customer loyalty, which generates industry-leading profitability despite low fares."
        },
        {
          id: "operations-management-401-l04-c3",
          title: "Service Blueprinting",
          content:
            "A service blueprint maps the entire service delivery process across five layers. Customer actions show what the customer does (enters the hotel, approaches the desk). Frontstage employee actions show visible interactions (receptionist greets the guest). Backstage employee actions show invisible support (preparing the room key). Support processes show systems and departments that enable delivery (reservation system, housekeeping). Physical evidence shows tangible elements the customer encounters (lobby decor, key card). The line of visibility separates what customers see from what they do not. Blueprinting reveals fail points, waits, and opportunities to enhance the experience."
        }
      ],
      flashcards: [
        { id: "operations-management-401-l04-f1", front: "Four characteristics of services (IHPS)", back: "Intangibility (cannot be stored), Heterogeneity (every encounter varies), Perishability (unused capacity is lost), Simultaneity (production and consumption occur together)" },
        { id: "operations-management-401-l04-f2", front: "Service-profit chain", back: "Internal quality → Employee satisfaction → Retention/productivity → Service value → Customer satisfaction/loyalty → Revenue/profit. Links operational investment to financial outcomes" },
        { id: "operations-management-401-l04-f3", front: "Service blueprint layers", back: "Customer actions, Frontstage employee actions, Backstage employee actions, Support processes, Physical evidence — separated by the line of visibility" }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Intangibility" },
            { id: "b", text: "Heterogeneity" },
            { id: "c", text: "Perishability" },
            { id: "d", text: "Simultaneity" }
          ],
          correctOptionId: "c",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Reactive maintenance" },
            { id: "b", text: "Preventive maintenance" },
            { id: "c", text: "Corrective maintenance" },
            { id: "d", text: "Predictive maintenance" }
          ],
          correctOptionId: "d",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "The criterion that persuades customers to choose you over competitors" },
            { id: "b", text: "The minimum standard that must be met for customers to even consider your product" },
            { id: "c", text: "The most important competitive priority for your industry" },
            { id: "d", text: "A measure of product quality that qualifies for ISO certification" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "It replaces the physical engine entirely" },
            { id: "b", text: "It enables what-if analysis and failure prediction without disrupting real operations" },
            { id: "c", text: "It eliminates the need for maintenance" },
            { id: "d", text: "It reduces the weight of the engine" }
          ],
          correctOptionId: "b",
    ...
    },
    {
      ...
      flashcards: [
        { id: "operations-management-401-l06-f1", front: "Circular economy", back: "An economic model where materials circulate through loops of reuse, repair, remanufacturing, and recycling — replacing the linear take-make-dispose model" },
        { id: "operations-management-401-l06-f2", front: "Caterpillar remanufacturing (Cat Reman)", back: "Takes back used components, restores to original specs, resells at 60% of new price — $2B+ revenue using 85% less energy and 86% less water than new manufacturing" },
        { id: "operations-management-401-l06-f3", front: "Business case for sustainable operations", back: "Lower energy/material costs, price premiums from consumers, regulatory compliance, supply chain resilience, and talent attraction — sustainability drives profitability" }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          options: [
            { id: "a", text: "Cost leadership through high-volume standardized production" },
            { id: "b", text: "Flexibility in product design and production volume" },
            { id: "c", text: "Maximum equipment utilization to minimize unit costs" },
            { id: "d", text: "Large batch sizes to achieve economies of scale" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Linear economy" },
            { id: "b", text: "Planned obsolescence" },
            { id: "c", text: "Circular economy" },
        ...
        },
        {
          ...
          options: [
            { id: "a", text: "Digital twin" },
            { id: "b", text: "Augmented reality" },
            { id: "c", text: "Blockchain" },
            { id: "d", text: "Additive manufacturing" }
          ],
          correctOptionId: "b",
        ...
        },
        {
          ...
          options: [
            ...
            { id: "b", text: "External service value" },
            { id: "c", text: "Internal service quality and employee satisfaction" },
