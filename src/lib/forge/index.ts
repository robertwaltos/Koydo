...
export const FORGE_CAPABILITIES: ForgeCapability[] = [
...

  {
    ...
    cached: true,
    cachePattern: "Supabase Storage: heygen/intros/{moduleId}.mp4",
    freeTierAllowed: true,
...

  {
    ...
    cached: true,
    cachePattern: "Supabase Storage: google-imagen/thumbnails/{moduleId}.png | illustrations/{moduleId}/{lessonId}.png",
    freeTierAllowed: true,
...

  {
    ...
    cached: true,
    cachePattern: "Supabase Storage: google-veo/concept-clips/{moduleId}.mp4",
    freeTierAllowed: true,
