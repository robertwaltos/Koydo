      ...
      <SoftCard as="section" className="p-5">
        ...
        <form onSubmit={handleCreateTicket} className="mt-4 grid gap-3">
          ...
          <select
            ...
            className="ui-focus-ring w-48 rounded-md border border-border bg-surface px-3 py-2 text-sm"
          >
            <option value="normal">Normal</option>
            <option value="low">Low</option>
            <option value="high">High</option>
          </select>
          <button type="submit" className="ui-soft-button ui-focus-ring min-h-11 w-fit rounded-full bg-accent px-4 py-2 text-sm text-white">
            Submit Ticket
          </button>
        </form>
      </SoftCard>
