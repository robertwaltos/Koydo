...
const CORE_COMPONENTS: Record<GameType, (props: CoreGameComponentProps) => React.JSX.Element> = {
  ...
  "shape-safari": ShapeSafari,
};

const LEGACY_COMPONENTS: Record<string, React.ComponentType> = {
  // EdTech (short names)
  neural: lazyGames["NeuralNavigator"],
  fraction: lazyGames["FractionForge"],
  vocabulary: lazyGames["VocabularyVoyager"],
  artistic: lazyGames["ArtisticAlgorithms"],
  ethical: lazyGames["EthicalEngine"],
  synthesis: lazyGames["SynthesisSphere"],
  velocity: lazyGames["VelocityVector"],
  logic: lazyGames["LogicalLink"],
  canvas: lazyGames["CosmicCanvas"],
  chronicle: lazyGames["ChronicleCase"],
  syntax: lazyGames["SyntaxSerpent"],
  genetic: lazyGames["GeneticGarden"],
  quantum: lazyGames["QuantumQuest"],
  market: lazyGames["MarketMaker"],
  orbit: lazyGames["OrbitOperator"],
  cipher: lazyGames["CipherCity"],
  biome: lazyGames["BiomeBuilder"],
  rhythm: lazyGames["RhythmRules"],
  tectonic: lazyGames["TectonicTrek"],
  flora: lazyGames["FloraFusion"],
  bot: lazyGames["BotBuilder"],
  eco: lazyGames["EcoEngineer"],
  aero: lazyGames["AeroArchitect"],
  histo: lazyGames["HistoHunt"],
  nano: lazyGames["NanoNavigator"],
  // EdTech (hyphenated names)
  "quantum-quirk": lazyGames["QuantumQuirk"],
  "star-steer": lazyGames["StarSteer"],
  "logic-labyrinth": lazyGames["LogicLabyrinth"],
  "bio-blast": lazyGames["BioBlast"],
  "ethos-engine": lazyGames["EthosEngine"],
  "echo-expedition": lazyGames["EchosExpedition"],
  "terra-trek": lazyGames["TerrasTrek"],
  "spark-quest": lazyGames["SparksSparkQuest"],
  "pixel-path": lazyGames["PixelsPath"],
  "luna-legend": lazyGames["LunasLegend"],
  "circuit-crusader": lazyGames["CircuitCrusader"],
  "gravity-goliath": lazyGames["GravityGoliath"],
  "protein-painter": lazyGames["ProteinPainter"],
  "linguist-lookout": lazyGames["LinguistLookout"],
  "fusion-founder": lazyGames["FusionFounder"],
  "stellar-state": lazyGames["StellarState"],
  "neural-net": lazyGames["NeuralNet"],
  "climate-commander": lazyGames["ClimateCommander"],
  "history-hacker": lazyGames["HistoryHacker"],
  "nano-nexus": lazyGames["NanoNexus"],
  "mars-colony": lazyGames["MarsColony"],
  "quantum-cascade": lazyGames["QuantumCascade"],
  "synthetic-architect": lazyGames["SyntheticArchitect"],
  "global-harmony": lazyGames["GlobalHarmony"],
  "evolution-prime": lazyGames["EvolutionPrime"],
  "word-woods": lazyGames["WordWoods"],
  "story-smith": lazyGames["StorySmith"],
  "alphabet-airship": lazyGames["AlphabetAirship"],
  "sentence-safari": lazyGames["SentenceSafari"],
  ...
  "arcade-063": lazyGames["Arcade063EchoClaimCascade"],
  "arcade-064": lazyGames["Arcade064LunaSequenceSymphony"],
  "arcade-065": lazyGames["Arcade065TerraEcosystemRescue"],
  "arcade-066": lazyGames["Arcade066SparkThrusterTrial"],
  "arcade-067": lazyGames["Arcade067EchoTruthlineProtocol"],
  "arcade-068": lazyGames["Arcade068TerraWildsRecovery"],
  "arcade-069": lazyGames["Arcade069LunaPulseRally"],
  "arcade-070": lazyGames["Arcade070PixelFirewallFrontier"],
  // Arcade (121-129)
  "arcade-121": lazyGames["Arcade121BreezeTrail"],
  "arcade-122": lazyGames["Arcade122SproutTrail"],
  "arcade-123": lazyGames["Arcade123PebbleTrail"],
  "arcade-124": lazyGames["Arcade124NimbusTrail"],
  "arcade-125": lazyGames["Arcade125FlareTrail"],
  "arcade-126": lazyGames["Arcade126SkyCircuit"],
  "arcade-127": lazyGames["Arcade127RiverCircuit"],
  "arcade-128": lazyGames["Arcade128EchoCircuit"],
  "arcade-129": lazyGames["Arcade129LunaCircuit"],
  // Classic Games (game-*)
  "2048": lazyGames["Game2048"],
  "anagram": lazyGames["GameAnagram"],
  "asteroids": lazyGames["GameAsteroids"],
  "binary-puzzle": lazyGames["GameBinaryPuzzle"],
  "bomberman": lazyGames["GameBomberman"],
  "breakout": lazyGames["GameBreakout"],
  "bubble-shooter": lazyGames["GameBubbleShooter"],
  "checkers": lazyGames["GameCheckers"],
  "chess": lazyGames["GameChess"],
  "color-flood": lazyGames["GameColorFlood"],
  "connect-four": lazyGames["GameConnectFour"],
  "connections": lazyGames["GameConnections"],
  "cookie-clicker": lazyGames["GameCookieClicker"],
  "crossword": lazyGames["GameCrossword"],
  "dot-connect": lazyGames["GameDotConnect"],
  "duck-hunt": lazyGames["GameDuckHunt"],
  "factors": lazyGames["GameFactors"],
  "flappy": lazyGames["GameFlappy"],
  "frogger": lazyGames["GameFrogger"],
  "hangman": lazyGames["GameHangman"],
  "logic-grid": lazyGames["GameLogicGrid"],
  "mahjong": lazyGames["GameMahjong"],
  "make-24": lazyGames["GameMake24"],
  "math-sprint": lazyGames["GameMathSprint"],
  "math-trainer": lazyGames["GameMathTrainer"],
  "memory-game": lazyGames["GameMemoryMatch"],
  "minesweeper": lazyGames["GameMinesweeper"],
  "missile-command": lazyGames["GameMissileCommand"],
  "number-dots": lazyGames["GameNumberDots"],
  "numm-match": lazyGames["GameNummMatch"],
  "pong": lazyGames["GamePong"],
  "reaction-time": lazyGames["GameReactionTime"],
  "reversi": lazyGames["GameReversi"],
  "simon": lazyGames["GameSimon"],
  "sliding-puzzle": lazyGames["GameSlidingPuzzle"],
  "snake": lazyGames["GameSnake"],
  "sokoban": lazyGames["GameSokoban"],
  "solitaire": lazyGames["GameSolitaire"],
  "space-invaders": lazyGames["GameSpaceInvaders"],
  "spider-solitaire": lazyGames["GameSpiderSolitaire"],
  "sudoku": lazyGames["GameSudoku"],
  "tetris": lazyGames["GameTetris"],
  "tic-tac-toe": lazyGames["GameTicTacToe"],
  "tower-stack": lazyGames["GameTowerStack"],
  "trivia-quiz": lazyGames["GameTriviaQuiz"],
  "typing-speed": lazyGames["GameTypingSpeed"],
  "whack-a-mole": lazyGames["GameWhackAMole"],
  "word-pluck": lazyGames["GameWordPluck"],
  "word-rescue": lazyGames["GameWordRescue"],
  "word-scramble": lazyGames["GameWordScramble"],
  "wordle": lazyGames["GameWordle"],
  // Zone Games (041-076)
  "zone-041": lazyGames["Zone041SignalRescue"],
  "zone-042": lazyGames["Zone042MathRailCommander"],
  "zone-043": lazyGames["Zone043EchoStorySignal"],
  "zone-044": lazyGames["Zone044TerraLabSort"],
  "zone-045": lazyGames["Zone045LunaRhythmForge"],
  "zone-046": lazyGames["Zone046PixelCipherSprint"],
  "zone-047": lazyGames["Zone047SparkGridFuse"],
  "zone-048": lazyGames["Zone048EchoEvidenceJudge"],
  "zone-049": lazyGames["Zone049TerraHabitatTriage"],
  "zone-050": lazyGames["Zone050PixelLaneDefender"],
  "zone-051": lazyGames["Zone051LunaChorusCascade"],
  "zone-052": lazyGames["Zone052SparkReactorGrid"],
  "zone-053": lazyGames["Zone053EchoDebateDuel"],
  "zone-054": lazyGames["Zone054TerraWeatherCommand"],
  "zone-055": lazyGames["Zone055PixelDroneIntercept"],
  "zone-056": lazyGames["Zone056SparkOrbitalSurge"],
  "zone-057": lazyGames["Zone057EchoSignalCrossfire"],
  "zone-058": lazyGames["Zone058TerraRiftShelter"],
  "zone-059": lazyGames["Zone059LunaStageStrategy"],
  "zone-060": lazyGames["Zone060PixelCircuitSiege"],
  "zone-061": lazyGames["Zone061SparkFluxGauntlet"],
  "zone-062": lazyGames["Zone062EchoProofRelay"],
  "zone-063": lazyGames["Zone063TerraGreenhouseCommand"],
  "zone-064": lazyGames["Zone064LunaBeatlineRun"],
  "zone-065": lazyGames["Zone065PixelBreachHunter"],
  "zone-066": lazyGames["Zone066SparkThrusterTrial"],
  "zone-067": lazyGames["Zone067EchoTruthlineProtocol"],
  "zone-068": lazyGames["Zone068TerraWildsRecovery"],
  "zone-069": lazyGames["Zone069LunaPulseRally"],
  "zone-070": lazyGames["Zone070PixelFirewallFrontier"],
  "zone-071": lazyGames["Zone071SparkReactorConvoy"],
  "zone-072": lazyGames["Zone072EchoSignalTribunal"],
  "zone-073": lazyGames["Zone073TerraFrontlineWardens"],
  "zone-074": lazyGames["Zone074LunaSkylineSet"],
  "zone-075": lazyGames["Zone075PixelSentinelLattice"],
  "zone-076": lazyGames["Zone076SparkVaultThrust"],
  // Zone Classic Games (077-099)
  "zone-077": lazyGames["Zone077PixelBlockDrop"],
  "zone-078": lazyGames["Zone078SparkBreakoutSurge"],
  "zone-079": lazyGames["Zone079LunaZigzagRun"],
  "zone-080": lazyGames["Zone080EchoWordRescue"],
  "zone-081": lazyGames["Zone081TerraMinefieldMap"],
  "zone-082": lazyGames["Zone082PixelShaftDrop"],
  "zone-083": lazyGames["Zone083LunaSequenceFlash"],
  "zone-084": lazyGames["Zone084EchoAnagramBlast"],
  "zone-085": lazyGames["Zone085SparkIdleForge"],
  "zone-086": lazyGames["Zone086TerraTilePair"],
  "zone-087": lazyGames["Zone087PixelMerge2048"],
  "zone-088": lazyGames["Zone088SparkFlapSurge"],
  "zone-089": lazyGames["Zone089LunaSudokuGrid"],
  "zone-090": lazyGames["Zone090EchoConnectDrop"],
  "zone-091": lazyGames["Zone091TerraWhackSquad"],
  "zone-092": lazyGames["Zone092PixelCardMatch"],
  "zone-093": lazyGames["Zone093SparkSnakeTrail"],
  "zone-094": lazyGames["Zone094LunaWordGrid"],
  "zone-095": lazyGames["Zone095EchoBubbleBurst"],
  "zone-096": lazyGames["Zone096TerraCrossword"],
  "zone-097": lazyGames["Zone097PixelTypeRush"],
  "zone-098": lazyGames["Zone098SparkDiceRoll"],
  "zone-099": lazyGames["Zone099LunaEndlessRun"],
  // Zone Unique Games (101-125)
  "zone-101": lazyGames["Zone101VoxelCraftWorld"],
  "zone-102": lazyGames["Zone102NeonHeistCity"],
  "zone-103": lazyGames["Zone103StormRoyaleArena"],
  "zone-104": lazyGames["Zone104SoulDungeonAscent"],
  "zone-105": lazyGames["Zone105HexQuestSaga"],
  "zone-106": lazyGames["Zone106FrontierTrailRider"],
  "zone-107": lazyGames["Zone107DiceDestinyRpg"],
  "zone-108": lazyGames["Zone108ElderRealmQuest"],
  "zone-109": lazyGames["Zone109GuildRaidLegends"],
  "zone-110": lazyGames["Zone110TacticalOpsStrike"],
  "zone-111": lazyGames["Zone111DropZoneSurvivor"],
  "zone-112": lazyGames["Zone112HarvestBloomFarm"],
  "zone-113": lazyGames["Zone113RuinSurvivorTrek"],
  "zone-114": lazyGames["Zone114InfernoRunAscent"],
  "zone-115": lazyGames["Zone115MindPalaceRpg"],
  "zone-116": lazyGames["Zone116AbyssalKnightDeep"],
  "zone-117": lazyGames["Zone117ImpostorStation"],
  "zone-118": lazyGames["Zone118TurboBallArena"],
  "zone-119": lazyGames["Zone119PrimalTamerIsle"],
  "zone-120": lazyGames["Zone120TerraDigWorld"],
  "zone-121": lazyGames["Zone121SparkHelixLock"],
  "zone-122": lazyGames["Zone122EchoJudgmentCircuit"],
...
export default function GamePlayerPage() {
  ...
  useEffect(() => {
    ...
    const loadRewardRealmStatus = async () => {
      if (!game || game.track !== "Reward Realm") {
  ...
  }, [game?.id, game?.track, selectedProfileId]);
